...
#define _afxMapHDC (AfxGetThreadState()->m_mapHDC)
...
#define _afxMapHGDIOBJ (AfxGetThreadState()->m_mapHGDIOBJ)
...
static const CResourceException simpleResourceException(FALSE);

IMPLEMENT_DYNAMIC(CUserException, CException)
static const CUserException simpleUserException(FALSE);
...
{
	THROW((CResourceException*)&simpleResourceException);
}

// user alert
void AFXAPI AfxThrowUserException()
{
	THROW((CUserException*)&simpleUserException);
}
