...
#define OLEUI_CCHVERBMAX_SIZE       OLEUI_CCHVERBMAX*sizeof(TCHAR)
#define OLEUI_OBJECTMENUMAX         256
#define OLEUI_OBJECTMENUMAX_SIZE    OLEUI_OBJECTMENUMAX*sizeof(TCHAR)
...
typedef struct tagOLEUIINSERTOBJECT
{
	...
	UINT            cchFile;          //Size of lpszFile buffer: MAX_PATH
