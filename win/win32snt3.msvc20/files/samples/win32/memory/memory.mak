...
!MESSAGE 
!MESSAGE NMAKE /f "memory.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/memory.exe $(OUTDIR)/memory.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"memory.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"memory.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"memory.bsc" 
BSC32_SBRS= \
	$(INTDIR)/nmmemcli.sbr \
	$(INTDIR)/memory.sbr \
	$(INTDIR)/nmmemsrv.sbr

$(OUTDIR)/memory.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"memory.pdb" /MACHINE:I386 /OUT:$(OUTDIR)/"memory.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/nmmemcli.obj \
	$(INTDIR)/memory.obj \
...
$(OUTDIR)/memory.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"memory.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"memory.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"memory.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"memory.pdb" /DEBUG /MACHINE:I386 /OUT:$(OUTDIR)/"memory.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/nmmemcli.obj \
	$(INTDIR)/memory.obj \
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"memory.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"memory.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"memory.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"memory.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/nmmemcli.obj \
	$(INTDIR)/memory.obj \
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_AFXDLL" /D\
 "_WINDOWS" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"memory.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"memory.pdb"\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"memory.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/nmmemcli.obj \
...
$(INTDIR)/nmmemcli.obj :  $(SOURCE)  $(INTDIR)
...
$(INTDIR)/nmmemsrv.obj :  $(SOURCE)  $(INTDIR)
...
$(INTDIR)/memory.res :  $(SOURCE)  $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
