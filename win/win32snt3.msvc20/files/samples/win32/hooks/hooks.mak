...
!MESSAGE 
!MESSAGE NMAKE /f "hooks.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/hooks.exe $(OUTDIR)/hooks.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hooks.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"hooktest.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"hooks.bsc" 
BSC32_SBRS= \
	$(INTDIR)/hooktest.sbr

$(OUTDIR)/hooks.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"hooks.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"hooks.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/hooktest.obj \
	$(INTDIR)/hooktest.res

$(OUTDIR)/hooks.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hooks.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"hooks.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"hooktest.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"hooks.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"hooks.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/hooktest.obj \
	$(INTDIR)/hooktest.res
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hooks.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"hooks.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"hooks.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"hooks.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/hooktest.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hooks.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"hooks.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"hooks.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/hooktest.obj \
...
$(INTDIR)/hooktest.obj :  $(SOURCE)  $(DEP_HOOKT) $(INTDIR)
...
$(INTDIR)/hooktest.res :  $(SOURCE)  $(DEP_HOOKTE) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
