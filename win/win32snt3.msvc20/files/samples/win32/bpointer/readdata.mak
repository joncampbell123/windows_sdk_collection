...
!MESSAGE 
!MESSAGE NMAKE /f "readdata.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : .\WinRel\readdata.exe .\WinRel\readdata.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"readdata.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"readdata.bsc" 
BSC32_SBRS= \
	.\WinRel\readdata.sbr

.\WinRel\readdata.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"readdata.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"readdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\readdata.obj

.\WinRel\readdata.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : .\WinDebug\readdata.exe .\WinDebug\readdata.bsc
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"readdata.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"readdata.pdb" /c 
CPP_OBJS=.\WinDebug/
...
BSC32_FLAGS=/nologo /o$(OUTDIR)/"readdata.bsc" 
BSC32_SBRS= \
	.\WinDebug\readdata.sbr

.\WinDebug\readdata.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"readdata.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"readdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\readdata.obj

.\WinDebug\readdata.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"readdata.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"readdata.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"readdata.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"readdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\readdata.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"readdata.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"readdata.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"readdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\readdata.obj
...
.\WinRel\readdata.obj :  $(SOURCE)  $(DEP_READD) $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 (80x86) Debug"

.\WinDebug\readdata.obj :  $(SOURCE)  $(DEP_READD) $(INTDIR)
