...
!MESSAGE 
!MESSAGE NMAKE /f "chgdata.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/chgdata.exe $(OUTDIR)/chgdata.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D "WIN32" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"chgdata.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"chgdata.bsc" 
BSC32_SBRS= \
	$(INTDIR)/chgdata.sbr

$(OUTDIR)/chgdata.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"chgdata.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"chgdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/chgdata.obj

$(OUTDIR)/chgdata.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D "WIN32"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"chgdata.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"chgdata.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"chgdata.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"chgdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/chgdata.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"chgdata.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"chgdata.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"chgdata.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"chgdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/chgdata.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"chgdata.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /SUBSYSTEM:console /MACHINE:MIPS
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /SUBSYSTEM:console\
 /PDB:$(OUTDIR)/"chgdata.pdb" /MACHINE:MIPS /OUT:$(OUTDIR)/"chgdata.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/chgdata.obj
...
$(INTDIR)/chgdata.obj :  $(SOURCE)  $(DEP_CHGDA) $(INTDIR)
