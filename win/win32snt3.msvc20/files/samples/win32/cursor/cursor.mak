...
!MESSAGE 
!MESSAGE NMAKE /f "cursor.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/cursor.exe $(OUTDIR)/cursor.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"cursor.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"cursor.res" /d "NDEBUG" 
BSC32=bscmake.exe
...
$(OUTDIR)/cursor.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"cursor.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"cursor.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/cursor.res \
	$(INTDIR)/cursor.obj
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"cursor.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"cursor.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"cursor.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"cursor.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"cursor.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/cursor.res \
	$(INTDIR)/cursor.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"cursor.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"cursor.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"cursor.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"cursor.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/cursor.res \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"cursor.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"cursor.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"cursor.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/cursor.res \
...
$(INTDIR)/cursor.res :  $(SOURCE)  $(DEP_CURSO) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/cursor.obj :  $(SOURCE)  $(DEP_CURSOR) $(INTDIR)
