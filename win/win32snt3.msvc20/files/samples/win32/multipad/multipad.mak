...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"multipad.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"multipad.pdb" /MACHINE:I386 /OUT:$(OUTDIR)/"multipad.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/multipad.obj \
	$(INTDIR)/mpopen.obj \
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"multipad.pdb" /DEBUG /MACHINE:I386\
