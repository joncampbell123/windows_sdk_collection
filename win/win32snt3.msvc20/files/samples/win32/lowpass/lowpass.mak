...
!MESSAGE 
!MESSAGE NMAKE /f "lowpass.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/lowpass.exe $(OUTDIR)/lowpass.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"lowpass.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"lowpass.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"lowpass.bsc" 
BSC32_SBRS= \
	$(INTDIR)/lowpass.sbr

$(OUTDIR)/lowpass.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"lowpass.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"lowpass.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/lowpass.res \
	$(INTDIR)/lowpass.obj

$(OUTDIR)/lowpass.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"lowpass.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"lowpass.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"lowpass.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"lowpass.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"lowpass.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/lowpass.res \
	$(INTDIR)/lowpass.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"lowpass.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"lowpass.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"lowpass.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"lowpass.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/lowpass.res \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"lowpass.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"lowpass.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"lowpass.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/lowpass.res \
...
$(INTDIR)/lowpass.res :  $(SOURCE)  $(DEP_LOWPA) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/lowpass.obj :  $(SOURCE)  $(DEP_LOWPAS) $(INTDIR)
