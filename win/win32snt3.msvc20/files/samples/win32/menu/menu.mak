...
!MESSAGE 
!MESSAGE NMAKE /f "menu.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/menu.exe $(OUTDIR)/menu.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"menu.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/menu.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"menu.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"menu.pdb" /c 
CPP_OBJS=.\WinDebug/
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"menu.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"menu.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"menu.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"menu.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/menu.res \
	$(INTDIR)/menu.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_AFXDLL" /D\
 "_WINDOWS" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"menu.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"menu.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"menu.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/menu.res \
...
$(INTDIR)/menu.res :  $(SOURCE)  $(DEP_MENU_) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/menu.obj :  $(SOURCE)  $(DEP_MENU_C) $(INTDIR)
