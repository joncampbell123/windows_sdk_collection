...
!MESSAGE 
!MESSAGE NMAKE /f "walk.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/walk.exe $(OUTDIR)/walk.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"walk.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"walk.bsc" 
BSC32_SBRS= \
	$(INTDIR)/walk.sbr

$(OUTDIR)/walk.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"walk.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"walk.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/walk.obj

$(OUTDIR)/walk.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"walk.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"walk.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"walk.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"walk.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/walk.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"walk.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"walk.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"walk.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"walk.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/walk.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"walk.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"walk.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"walk.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/walk.obj
...
$(INTDIR)/walk.obj :  $(SOURCE)  $(DEP_WALK_) $(INTDIR)
