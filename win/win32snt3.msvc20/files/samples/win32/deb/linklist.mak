...
!MESSAGE 
!MESSAGE NMAKE /f "linklist.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/linklist.dll $(OUTDIR)/linklist.bsc
...
CPP_PROJ=/nologo /MD /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"linklist.pch" /Fo$(INTDIR)/ /c\
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:I386 /IMPLIB:"LINKLIST.lib"
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"linklist.pdb" /MACHINE:I386 /DEF:".\linklist.def"\
 /OUT:$(OUTDIR)/"linklist.dll" /IMPLIB:"LINKLIST.lib" 
DEF_FILE=.\linklist.def
LINK32_OBJS= \
	$(INTDIR)/linklist.obj

$(OUTDIR)/linklist.dll : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /MD /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS"\
 /D "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"linklist.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"linklist.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:I386 /IMPLIB:"LINKLIST.lib"
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /INCREMENTAL:yes\
 /PDB:$(OUTDIR)/"linklist.pdb" /DEBUG /MACHINE:I386 /DEF:".\linklist.def"\
 /OUT:$(OUTDIR)/"linklist.dll" /IMPLIB:"LINKLIST.lib" 
DEF_FILE=.\linklist.def
LINK32_OBJS= \
	$(INTDIR)/linklist.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"linklist.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"linklist.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:MIPS /IMPLIB:"linklist.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"linklist.pdb"\
 /DEBUG /MACHINE:MIPS /DEF:".\linklist.def" /OUT:$(OUTDIR)/"linklist.dll"\
 /IMPLIB:"linklist.lib" 
DEF_FILE=.\linklist.def
LINK32_OBJS= \
	$(INTDIR)/linklist.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS"\
 /D "_AFXDLL" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"linklist.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT BASE LINK32 /PDB:none
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:MIPS /IMPLIB:"linklist.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"linklist.pdb"\
 /MACHINE:MIPS /DEF:".\linklist.def" /OUT:$(OUTDIR)/"linklist.dll"\
 /IMPLIB:"linklist.lib" 
DEF_FILE=.\linklist.def
LINK32_OBJS= \
	$(INTDIR)/linklist.obj
...
$(INTDIR)/linklist.obj :  $(SOURCE)  $(DEP_LINKL) $(INTDIR)
