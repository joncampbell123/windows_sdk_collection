...
!MESSAGE 
!MESSAGE NMAKE /f "sharemem.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/sharemem.exe $(OUTDIR)/sharemem.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"sharemem.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"sharemem.res" /d "NDEBUG" 
BSC32=bscmake.exe
...
$(OUTDIR)/sharemem.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"sharemem.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"sharemem.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"sharemem.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"sharemem.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"sharemem.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"sharemem.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"sharemem.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/sharemem.res \
	$(INTDIR)/sharemem.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_AFXDLL" /D\
 "_WINDOWS" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"sharemem.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"sharemem.pdb"\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"sharemem.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/sharemem.res \
...
$(INTDIR)/sharemem.res :  $(SOURCE)  $(DEP_SHARE) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/sharemem.obj :  $(SOURCE)  $(DEP_SHAREM) $(INTDIR)
