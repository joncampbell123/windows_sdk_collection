...
!MESSAGE 
!MESSAGE NMAKE /f "platform.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/platform.exe $(OUTDIR)/platform.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"platform.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"platform.res" /d "NDEBUG" 
BSC32=bscmake.exe
...
$(OUTDIR)/platform.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"platform.pdb" /MACHINE:I386 /OUT:$(OUTDIR)/"platform.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/platform.res \
	$(INTDIR)/platform.obj

$(OUTDIR)/platform.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"platform.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"platform.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"platform.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"platform.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"platform.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/platform.res \
	$(INTDIR)/platform.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"platform.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"platform.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"platform.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"platform.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/platform.res \
	$(INTDIR)/platform.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_AFXDLL" /D\
 "_WINDOWS" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"platform.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"platform.pdb"\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"platform.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/platform.res \
...
$(INTDIR)/platform.res :  $(SOURCE)  $(DEP_PLATF) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/platform.obj :  $(SOURCE)  $(DEP_PLATFO) $(INTDIR)
