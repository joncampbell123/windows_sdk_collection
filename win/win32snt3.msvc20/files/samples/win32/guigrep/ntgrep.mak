...
!MESSAGE 
!MESSAGE NMAKE /f "ntgrep.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/ntgrep.exe $(OUTDIR)/ntgrep.bsc
...
# ADD CPP /nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /FR /c /Tp
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"ntgrep.pch" /Fo$(INTDIR)/ /c /Tp 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"ntgrep.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ntgrep.bsc" 
BSC32_SBRS= \
	$(INTDIR)/ntgrep.sbr

$(OUTDIR)/ntgrep.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"ntgrep.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"ntgrep.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ntgrep.obj \
	$(INTDIR)/ntgrep.res \
...
$(OUTDIR)/ntgrep.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
# ADD CPP /nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /FR /c /Tp
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"ntgrep.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"ntgrep.pdb" /c /Tp 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"ntgrep.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"ntgrep.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"ntgrep.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ntgrep.obj \
	$(INTDIR)/ntgrep.res \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ntgrep.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"ntgrep.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"ntgrep.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ntgrep.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ntgrep.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"ntgrep.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"ntgrep.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"ntgrep.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ntgrep.obj \
...
$(INTDIR)/ntgrep.obj :  $(SOURCE)  $(DEP_NTGRE) $(INTDIR)
...
$(INTDIR)/ntgrep.res :  $(SOURCE)  $(DEP_NTGREP) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
