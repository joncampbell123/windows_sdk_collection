...
!MESSAGE 
!MESSAGE NMAKE /f "messages.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/messages.dll $(OUTDIR)/messages.bsc
...
CPP_PROJ=/nologo /MD /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"messages.pch" /Fo$(INTDIR)/ /c\
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"messages.bsc" 
BSC32_SBRS= \
	$(INTDIR)/messages.sbr

$(OUTDIR)/messages.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:I386
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"messages.pdb" /MACHINE:I386 /OUT:$(OUTDIR)/"messages.dll"\
 /IMPLIB:$(OUTDIR)/"messages.lib" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/messages.obj

$(OUTDIR)/messages.dll : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /MD /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS"\
 /D "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"messages.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"messages.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:I386
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /INCREMENTAL:yes\
 /PDB:$(OUTDIR)/"messages.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"messages.dll" /IMPLIB:$(OUTDIR)/"messages.lib" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/messages.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"messages.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"messages.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:MIPS
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"messages.pdb"\
 /DEBUG /MACHINE:MIPS /OUT:$(OUTDIR)/"messages.dll"\
 /IMPLIB:$(OUTDIR)/"messages.lib" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/messages.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS"\
 /D "_AFXDLL" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"messages.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT BASE LINK32 /PDB:none
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:MIPS
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"messages.pdb"\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"messages.dll" /IMPLIB:$(OUTDIR)/"messages.lib" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/messages.obj
