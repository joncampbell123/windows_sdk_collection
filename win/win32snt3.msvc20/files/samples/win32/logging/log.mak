...
!MESSAGE 
!MESSAGE NMAKE /f "log.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/log.exe $(OUTDIR)/log.bsc
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"log.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"log.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/log.obj

$(OUTDIR)/log.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"log.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"log.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"log.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"log.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/log.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"log.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"log.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"log.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"log.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/log.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"log.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"log.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"log.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/log.obj
