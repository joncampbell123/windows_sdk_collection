...
!MESSAGE 
!MESSAGE NMAKE /f "input.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/input.exe $(OUTDIR)/input.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"input.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/input.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"input.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"input.pdb" /c 
CPP_OBJS=.\WinDebug/
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"input.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"input.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"input.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"input.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/input.res \
	$(INTDIR)/input.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_AFXDLL" /D\
 "_WINDOWS" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"input.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"input.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"input.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/input.res \
	$(INTDIR)/input.obj
...
$(INTDIR)/input.res :  $(SOURCE)  $(DEP_INPUT) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/input.obj :  $(SOURCE)  $(DEP_INPUT_) $(INTDIR)
