...
!MESSAGE 
!MESSAGE NMAKE /f "inherit.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/inherit.exe $(OUTDIR)/inherit.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"inherit.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"inherit.bsc" 
BSC32_SBRS= \
	$(INTDIR)/inherit.sbr

$(OUTDIR)/inherit.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"inherit.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"inherit.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/inherit.obj

$(OUTDIR)/inherit.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"inherit.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"inherit.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"inherit.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"inherit.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/inherit.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"inherit.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"inherit.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"inherit.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"inherit.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/inherit.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"inherit.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"inherit.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"inherit.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/inherit.obj
