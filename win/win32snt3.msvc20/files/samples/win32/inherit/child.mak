...
!MESSAGE 
!MESSAGE NMAKE /f "child.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/child.exe $(OUTDIR)/child.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"child.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/child.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"child.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"child.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"child.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"child.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"child.pdb" /DEBUG /MACHINE:MIPS /OUT:$(OUTDIR)/"child.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/child.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"child.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:console\
 /PDB:$(OUTDIR)/"child.pdb" /MACHINE:MIPS /OUT:$(OUTDIR)/"child.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/child.obj
