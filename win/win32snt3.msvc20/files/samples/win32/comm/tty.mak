...
!MESSAGE 
!MESSAGE NMAKE /f "tty.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : .\WinRel\tty.exe .\WinRel\tty.bsc
...
# ADD CPP /nologo /W3 /GX /YX /O2 /D "WIN32" /FR /c
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"tty.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"tty.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"tty.bsc" 
BSC32_SBRS= \
	.\WinRel\tty.sbr

.\WinRel\tty.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"tty.pdb"\
 /MACHINE:I386 /OUT:$(OUTDIR)/"tty.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\tty.res \
	.\WinRel\tty.obj

.\WinRel\tty.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : .\WinDebug\tty.exe .\WinDebug\tty.bsc
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"tty.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"tty.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"tty.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
.\WinDebug\tty.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"tty.pdb" /DEBUG /MACHINE:I386 /OUT:$(OUTDIR)/"tty.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\tty.res \
	.\WinDebug\tty.obj

.\WinDebug\tty.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"tty.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"tty.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\tty.res \
	.\WinDebug\tty.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS"\
 /D "_AFXDLL" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tty.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"tty.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"tty.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\tty.res \
...
.\WinRel\tty.res :  $(SOURCE)  $(DEP_TTY_R) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 

!ELSEIF  "$(CFG)" == "Win32 (80x86) Debug"

.\WinDebug\tty.res :  $(SOURCE)  $(DEP_TTY_R) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
.\WinRel\tty.obj :  $(SOURCE)  $(DEP_TTY_C) $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 (80x86) Debug"

.\WinDebug\tty.obj :  $(SOURCE)  $(DEP_TTY_C) $(INTDIR)
