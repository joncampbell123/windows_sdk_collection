...
!MESSAGE 
!MESSAGE NMAKE /f "color.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"color.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"color.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"color.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/color.obj
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"color.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"color.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"color.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"color.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/color.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"color.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"color.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"color.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"color.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/color.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"color.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"color.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"color.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/color.obj
...
$(INTDIR)/color.obj :  $(SOURCE)  $(DEP_COLOR) $(INTDIR)
