...
!MESSAGE 
!MESSAGE NMAKE /f "virtmem.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/virtmem.exe $(OUTDIR)/virtmem.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"virtmem.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"virtmem.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"virtmem.bsc" 
BSC32_SBRS= \
	$(INTDIR)/virtmem.sbr

$(OUTDIR)/virtmem.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"virtmem.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"virtmem.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/virtmem.obj \
	$(INTDIR)/virtmem.res

$(OUTDIR)/virtmem.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"virtmem.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"virtmem.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"virtmem.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"virtmem.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"virtmem.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/virtmem.obj \
	$(INTDIR)/virtmem.res
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"virtmem.pch" /Fo$(INTDIR)/ /c\
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"virtmem.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"virtmem.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/virtmem.obj \
...
$(INTDIR)/virtmem.obj :  $(SOURCE)  $(DEP_VIRTM) $(INTDIR)
...
$(INTDIR)/virtmem.res :  $(SOURCE)  $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
