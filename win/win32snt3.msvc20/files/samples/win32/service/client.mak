...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"client.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"client.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"client.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"client.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/client.obj
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"client.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"client.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/client.obj
