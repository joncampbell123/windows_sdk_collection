...
!MESSAGE 
!MESSAGE NMAKE /f "owncombo.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/owncombo.exe $(OUTDIR)/owncombo.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"owncombo.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"owncombo.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"owncombo.bsc" 
BSC32_SBRS= \
	$(INTDIR)/owncombo.sbr

$(OUTDIR)/owncombo.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"owncombo.pdb" /MACHINE:I386 /OUT:$(OUTDIR)/"owncombo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/owncombo.res \
	$(INTDIR)/owncombo.obj

$(OUTDIR)/owncombo.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"owncombo.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"owncombo.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"owncombo.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"owncombo.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"owncombo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/owncombo.res \
	$(INTDIR)/owncombo.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"owncombo.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"owncombo.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"owncombo.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"owncombo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/owncombo.res \
	$(INTDIR)/owncombo.obj
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_AFXDLL" /D\
 "_WINDOWS" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"owncombo.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"owncombo.pdb"\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"owncombo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/owncombo.res \
...
$(INTDIR)/owncombo.res :  $(SOURCE)  $(DEP_OWNCO) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/owncombo.obj :  $(SOURCE)  $(DEP_OWNCOM) $(INTDIR)
