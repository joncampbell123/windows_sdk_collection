...
!MESSAGE 
!MESSAGE NMAKE /f "clock.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : .\WinRel\clock.exe .\WinRel\clock.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"clock.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"clockres.res" /d "NDEBUG" 
BSC32=bscmake.exe
...
.\WinRel\clock.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"clock.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"clock.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\clockres.res \
	.\WinRel\clock.obj

.\WinRel\clock.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : .\WinDebug\clock.exe .\WinDebug\clock.bsc
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"clock.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"clock.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"clockres.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
.\WinDebug\clock.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"clock.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"clock.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\clockres.res \
	.\WinDebug\clock.obj

.\WinDebug\clock.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"clock.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"clock.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"clock.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\clockres.res \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"clock.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"clock.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"clock.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"clock.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\clockres.res \
...
.\WinRel\clockres.res :  $(SOURCE)  $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 

!ELSEIF  "$(CFG)" == "Win32 (80x86) Debug"

.\WinDebug\clockres.res :  $(SOURCE)  $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
.\WinRel\clock.obj :  $(SOURCE)  $(DEP_CLOCK) $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 (80x86) Debug"

.\WinDebug\clock.obj :  $(SOURCE)  $(DEP_CLOCK) $(INTDIR)
