...
!MESSAGE 
!MESSAGE NMAKE /f "ddemo.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : .\WinRel\ddemo.exe .\WinRel\ddemo.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ddemo.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ddemo.bsc" 
BSC32_SBRS= \
	.\WinRel\ddemo.sbr

.\WinRel\ddemo.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"ddemo.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"ddemo.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\ddemo.obj

.\WinRel\ddemo.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : .\WinDebug\ddemo.exe .\WinDebug\ddemo.bsc
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ddemo.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"ddemo.pdb" /c 
CPP_OBJS=.\WinDebug/
...
.\WinDebug\ddemo.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"ddemo.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"ddemo.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\ddemo.obj

.\WinDebug\ddemo.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ddemo.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"ddemo.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"ddemo.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinRel\ddemo.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ddemo.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"ddemo.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"ddemo.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"ddemo.exe" 
DEF_FILE=
LINK32_OBJS= \
	.\WinDebug\ddemo.obj
...
.\WinRel\ddemo.obj :  $(SOURCE)  $(INTDIR)

!ELSEIF  "$(CFG)" == "Win32 (80x86) Debug"

.\WinDebug\ddemo.obj :  $(SOURCE)  $(INTDIR)
