...
!MESSAGE 
!MESSAGE NMAKE /f "maskblt.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/maskblt.exe $(OUTDIR)/maskblt.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"maskblt.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"maskblt.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"maskblt.bsc" 
BSC32_SBRS= \
	$(INTDIR)/maskblt.sbr \
	$(INTDIR)/bitmap.sbr \
	$(INTDIR)/track.sbr

$(OUTDIR)/maskblt.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"maskblt.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"maskblt.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/maskblt.obj \
	$(INTDIR)/bitmap.obj \
...
$(OUTDIR)/maskblt.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"maskblt.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"maskblt.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"maskblt.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"maskblt.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"maskblt.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/maskblt.obj \
	$(INTDIR)/bitmap.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"maskblt.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"maskblt.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"maskblt.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"maskblt.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/maskblt.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"maskblt.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"maskblt.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"maskblt.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/maskblt.obj \
...
$(INTDIR)/maskblt.obj :  $(SOURCE)  $(DEP_MASKB) $(INTDIR)
...
$(INTDIR)/maskblt.res :  $(SOURCE)  $(DEP_MASKBL) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/track.obj :  $(SOURCE)  $(DEP_TRACK) $(INTDIR)
