...
!MESSAGE 
!MESSAGE NMAKE /f "termproc.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/termproc.exe $(OUTDIR)/termproc.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"termproc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"termproc.bsc" 
BSC32_SBRS= \
	$(INTDIR)/termproc.sbr

$(OUTDIR)/termproc.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"termproc.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"termproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/termproc.obj

$(OUTDIR)/termproc.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"termproc.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"termproc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"termproc.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"termproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/termproc.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"termproc.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"termproc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"termproc.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"termproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/termproc.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"termproc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"termproc.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"termproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/termproc.obj
...
$(INTDIR)/termproc.obj :  $(SOURCE)  $(INTDIR)
