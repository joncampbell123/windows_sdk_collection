...
!MESSAGE 
!MESSAGE NMAKE /f "winnet.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/winnet.exe $(OUTDIR)/winnet.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"winnet.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"winnet.bsc" 
BSC32_SBRS= \
	$(INTDIR)/winnet.sbr

$(OUTDIR)/winnet.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
# ADD LINK32 mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:console /MACHINE:I386
LINK32_FLAGS=mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"winnet.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"winnet.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winnet.obj

$(OUTDIR)/winnet.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"winnet.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"winnet.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:console /DEBUG /MACHINE:I386
LINK32_FLAGS=mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"winnet.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"winnet.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winnet.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"winnet.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD LINK32 mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:console /MACHINE:MIPS
LINK32_FLAGS=mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"winnet.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"winnet.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winnet.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D\
 "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"winnet.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"winnet.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:console /DEBUG /MACHINE:MIPS
LINK32_FLAGS=mpr.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"winnet.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"winnet.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winnet.obj
