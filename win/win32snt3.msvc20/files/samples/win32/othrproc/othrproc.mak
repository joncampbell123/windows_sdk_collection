...
!MESSAGE 
!MESSAGE NMAKE /f "othrproc.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/othrproc.exe $(OUTDIR)/othrproc.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"othrproc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"othrproc.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"othrproc.bsc" 
BSC32_SBRS= \
	$(INTDIR)/othrproc.sbr

$(OUTDIR)/othrproc.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"othrproc.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"othrproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/othrproc.obj \
	$(INTDIR)/othrproc.res

$(OUTDIR)/othrproc.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"othrproc.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"othrproc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"othrproc.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"othrproc.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"othrproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/othrproc.obj \
	$(INTDIR)/othrproc.res
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"othrproc.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"othrproc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"othrproc.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"othrproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/othrproc.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"othrproc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"othrproc.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"othrproc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/othrproc.obj \
...
$(INTDIR)/othrproc.obj :  $(SOURCE)  $(DEP_OTHRP) $(INTDIR)
...
$(INTDIR)/othrproc.res :  $(SOURCE)  $(DEP_OTHRPR) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
