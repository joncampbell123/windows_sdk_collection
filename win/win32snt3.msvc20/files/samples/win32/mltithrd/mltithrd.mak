...
!MESSAGE 
!MESSAGE NMAKE /f "mltithrd.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/mltithrd.exe $(OUTDIR)/mltithrd.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"mltithrd.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"mltithrd.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"mltithrd.bsc" 
BSC32_SBRS= \
	$(INTDIR)/mltithrd.sbr

$(OUTDIR)/mltithrd.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"mltithrd.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"mltithrd.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mltithrd.res \
	$(INTDIR)/mltithrd.obj

$(OUTDIR)/mltithrd.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"mltithrd.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"mltithrd.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"mltithrd.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"mltithrd.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"mltithrd.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mltithrd.res \
	$(INTDIR)/mltithrd.obj
...
# ADD CPP /nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /FR /c
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"mltithrd.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"mltithrd.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"mltithrd.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"mltithrd.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mltithrd.res \
...
# ADD CPP /nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /FR /c
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"mltithrd.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"mltithrd.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"mltithrd.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mltithrd.res \
...
$(INTDIR)/mltithrd.res :  $(SOURCE)  $(DEP_MLTIT) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/mltithrd.obj :  $(SOURCE)  $(DEP_MLTITH) $(INTDIR)
