...
!MESSAGE 
!MESSAGE NMAKE /f "fontview.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/fontview.exe $(OUTDIR)/fontview.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"fontview.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"fontview.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"fontview.bsc" 
BSC32_SBRS= \
	$(INTDIR)/display.sbr \
	$(INTDIR)/fontview.sbr \
	$(INTDIR)/tools.sbr \
...
$(OUTDIR)/fontview.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"fontview.pdb" /MACHINE:I386 /OUT:$(OUTDIR)/"fontview.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/display.obj \
	$(INTDIR)/fontview.res \
...
$(OUTDIR)/fontview.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"fontview.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"fontview.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"fontview.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /PDB:$(OUTDIR)/"fontview.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"fontview.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/display.obj \
	$(INTDIR)/fontview.res \
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D\
 ...
 /Fp$(OUTDIR)/"fontview.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"fontview.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"fontview.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"fontview.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/display.obj \
	$(INTDIR)/fontview.res \
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_AFXDLL" /D\
 "_WINDOWS" /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"fontview.pch"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"fontview.pdb"\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"fontview.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/display.obj \
...
$(INTDIR)/fontview.res :  $(SOURCE)  $(DEP_FONTV) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/fontview.obj :  $(SOURCE)  $(DEP_FONTVI) $(INTDIR)
