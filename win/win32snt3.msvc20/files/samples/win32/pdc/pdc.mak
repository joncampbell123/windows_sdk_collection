...
!MESSAGE 
!MESSAGE NMAKE /f "pdc.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/pdc.exe $(OUTDIR)/pdc.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"pdc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"pdc.bsc" 
BSC32_SBRS= \
	$(INTDIR)/pdc.sbr

$(OUTDIR)/pdc.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"pdc.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"pdc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/pdc.obj

$(OUTDIR)/pdc.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"pdc.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"pdc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"pdc.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"pdc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/pdc.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"pdc.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"pdc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"pdc.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"pdc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/pdc.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"pdc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"pdc.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"pdc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/pdc.obj
...
$(INTDIR)/pdc.obj :  $(SOURCE)  $(DEP_PDC_C) $(INTDIR)
