...
!MESSAGE 
!MESSAGE NMAKE /f "xalloc.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/xalloc.exe $(OUTDIR)/xalloc.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"xalloc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"xalloc.bsc" 
BSC32_SBRS= \
	$(INTDIR)/stdexcpt.sbr \
	$(INTDIR)/stdnewh.sbr \
	$(INTDIR)/xalloc.sbr

$(OUTDIR)/xalloc.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<

LINK32=link.exe
# ADD BASE LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:console /MACHINE:I386
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"xalloc.pdb"\
 /MACHINE:I386 /OUT:$(OUTDIR)/"xalloc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/stdexcpt.obj \
	$(INTDIR)/stdnewh.obj \
...
$(OUTDIR)/xalloc.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"xalloc.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"xalloc.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
LINK32=link.exe
# ADD BASE LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:console /DEBUG /MACHINE:I386
# SUBTRACT BASE LINK32 /PDB:none
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib /NOLOGO /SUBSYSTEM:console /DEBUG /MACHINE:I386
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"xalloc.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"xalloc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/stdexcpt.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"xalloc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:console /PDB:$(OUTDIR)/"xalloc.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"xalloc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/stdexcpt.obj \
	$(INTDIR)/stdnewh.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D\
 "_CONSOLE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"xalloc.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"xalloc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:console /PDB:$(OUTDIR)/"xalloc.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"xalloc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/stdexcpt.obj \
...
$(INTDIR)/stdexcpt.obj :  $(SOURCE)  $(DEP_STDEX) $(INTDIR)
...
$(INTDIR)/stdnewh.obj :  $(SOURCE)  $(DEP_STDNE) $(INTDIR)
...
$(INTDIR)/xalloc.obj :  $(SOURCE)  $(DEP_XALLO) $(INTDIR)
