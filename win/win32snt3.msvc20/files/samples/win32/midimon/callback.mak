...
!MESSAGE 
!MESSAGE NMAKE /f "callback.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/callback.dll $(OUTDIR)/callback.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"callback.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"callback.bsc" 
BSC32_SBRS= \
	$(INTDIR)/callback.sbr

$(OUTDIR)/callback.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
# ADD LINK32 winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:I386 /IMPLIB:"callback.lib"
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /DLL /INCREMENTAL:no /PDB:$(OUTDIR)/"callback.pdb"\
 /MACHINE:I386 /DEF:".\callback.def" /OUT:$(OUTDIR)/"callback.dll"\
 /IMPLIB:"callback.lib" 
DEF_FILE=.\callback.def
LINK32_OBJS= \
	$(INTDIR)/callback.obj

$(OUTDIR)/callback.dll : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /MT /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"callback.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"callback.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:I386 /IMPLIB:"callback.lib"
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /DLL /INCREMENTAL:yes /PDB:$(OUTDIR)/"callback.pdb" /DEBUG\
 /MACHINE:I386 /DEF:".\callback.def" /OUT:$(OUTDIR)/"callback.dll"\
 /IMPLIB:"callback.lib" 
DEF_FILE=.\callback.def
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MT /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"callback.pch" /Fo$(INTDIR)/\
 /c 
CPP_OBJS=.\WinRel/
...
# ADD LINK32 winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:MIPS /IMPLIB:"callback.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"callback.pdb" /MACHINE:MIPS\
 /DEF:".\callback.def" /OUT:$(OUTDIR)/"callback.dll" /IMPLIB:"callback.lib" 
DEF_FILE=.\callback.def
LINK32_OBJS= \
	$(INTDIR)/callback.obj
...
CPP_PROJ=/nologo /MT /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG"\
 /D "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"callback.pch"\
 /Fo$(INTDIR)/ /Fd$(OUTDIR)/"callback.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:MIPS /IMPLIB:"callback.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"callback.pdb" /DEBUG /MACHINE:MIPS\
 /DEF:".\callback.def" /OUT:$(OUTDIR)/"callback.dll" /IMPLIB:"callback.lib" 
DEF_FILE=.\callback.def
LINK32_OBJS= \
	$(INTDIR)/callback.obj
