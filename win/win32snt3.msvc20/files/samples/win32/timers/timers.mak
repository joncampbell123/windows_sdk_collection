...
!MESSAGE 
!MESSAGE NMAKE /f "timers.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/timers.exe $(OUTDIR)/timers.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"timers.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"timers.bsc" 
BSC32_SBRS= \
	$(INTDIR)/timers.sbr

$(OUTDIR)/timers.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"timers.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"timers.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/timers.obj

$(OUTDIR)/timers.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"timers.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"timers.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"timers.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"timers.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/timers.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"timers.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"timers.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"timers.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"timers.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/timers.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"timers.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"timers.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"timers.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/timers.obj
...
$(INTDIR)/timers.obj :  $(SOURCE)  $(DEP_TIMER) $(INTDIR)
