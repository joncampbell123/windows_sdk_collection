...
!MESSAGE 
!MESSAGE NMAKE /f "floppy.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/floppy.exe $(OUTDIR)/floppy.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"floppy.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"floppy.bsc" 
BSC32_SBRS= \
	$(INTDIR)/mfmt.sbr

$(OUTDIR)/floppy.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"floppy.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"floppy.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mfmt.obj

$(OUTDIR)/floppy.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"floppy.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"floppy.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"floppy.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"floppy.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mfmt.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"floppy.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"floppy.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"floppy.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"floppy.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mfmt.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"floppy.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"floppy.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"floppy.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/mfmt.obj
