...
!MESSAGE 
!MESSAGE NMAKE /f "takeown.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/takeown.exe $(OUTDIR)/takeown.bsc
...
CPP_PROJ=/nologo /W3 /YX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /FR$(INTDIR)/\
 /Fp$(OUTDIR)/"takeown.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"takeown.bsc" 
BSC32_SBRS= \
	$(INTDIR)/takeown.sbr

$(OUTDIR)/takeown.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"takeown.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"takeown.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/takeown.obj

$(OUTDIR)/takeown.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"takeown.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"takeown.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"takeown.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"takeown.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/takeown.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /Zi /YX /Od /D "_DEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"takeown.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"takeown.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"takeown.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"takeown.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/takeown.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /YX /O2 /D "NDEBUG" /D "_CONSOLE" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"takeown.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:console /PDB:$(OUTDIR)/"takeown.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"takeown.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/takeown.obj
...
$(INTDIR)/takeown.obj :  $(SOURCE)  $(INTDIR)
