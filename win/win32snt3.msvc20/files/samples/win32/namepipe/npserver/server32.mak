...
!MESSAGE 
!MESSAGE NMAKE /f "server32.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/server32.exe $(OUTDIR)/server32.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"server32.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"server32.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"server32.bsc" 
BSC32_SBRS= \
	$(INTDIR)/server32.sbr

$(OUTDIR)/server32.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"server32.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"server32.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/server32.obj \
	$(INTDIR)/server32.res

$(OUTDIR)/server32.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"server32.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"server32.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"server32.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"server32.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"server32.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/server32.obj \
	$(INTDIR)/server32.res
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"server32.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"server32.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"server32.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"server32.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/server32.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"server32.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"server32.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"server32.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/server32.obj \
...
$(INTDIR)/server32.obj :  $(SOURCE)  $(DEP_SERVE) $(INTDIR)
...
$(INTDIR)/server32.res :  $(SOURCE)  $(DEP_SERVER) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
