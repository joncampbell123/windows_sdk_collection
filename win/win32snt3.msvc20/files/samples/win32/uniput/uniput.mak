...
!MESSAGE 
!MESSAGE NMAKE /f "uniput.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/uniput.exe $(OUTDIR)/uniput.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"uniput.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"uniput.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"uniput.bsc" 
BSC32_SBRS= \
	$(INTDIR)/display.sbr \
	$(INTDIR)/uniput.sbr \
	$(INTDIR)/status.sbr

$(OUTDIR)/uniput.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"uniput.pdb"\
 /MACHINE:I386 /OUT:$(OUTDIR)/"uniput.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/uniput.res \
	$(INTDIR)/display.obj \
...
$(OUTDIR)/uniput.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"uniput.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"uniput.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"uniput.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"uniput.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"uniput.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/uniput.res \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"uniput.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"uniput.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"uniput.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/uniput.res \
	$(INTDIR)/display.obj \
...
# ADD CPP /nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /FR /c
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"uniput.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"uniput.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"uniput.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"uniput.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/uniput.res \
...
$(INTDIR)/uniput.res :  $(SOURCE)  $(DEP_UNIPU) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/uniput.obj :  $(SOURCE)  $(DEP_UNIPUT) $(INTDIR)
