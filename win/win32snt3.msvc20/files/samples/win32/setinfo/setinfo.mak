...
!MESSAGE 
!MESSAGE NMAKE /f "setinfo.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/setinfo.exe $(OUTDIR)/setinfo.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"setinfo.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"setinfo.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"setinfo.bsc" 
BSC32_SBRS= \
	$(INTDIR)/setinfo.sbr

$(OUTDIR)/setinfo.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"setinfo.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"setinfo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/setinfo.obj \
	$(INTDIR)/setinfo.res

$(OUTDIR)/setinfo.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"setinfo.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"setinfo.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"setinfo.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"setinfo.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"setinfo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/setinfo.obj \
	$(INTDIR)/setinfo.res
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"setinfo.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"setinfo.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"setinfo.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"setinfo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/setinfo.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"setinfo.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"setinfo.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"setinfo.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/setinfo.obj \
...
$(INTDIR)/setinfo.obj :  $(SOURCE)  $(DEP_SETIN) $(INTDIR)
...
$(INTDIR)/setinfo.res :  $(SOURCE)  $(DEP_SETINF) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
