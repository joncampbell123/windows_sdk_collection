...
ALL : MTL_TLBS $(OUTDIR)/hello.exe $(OUTDIR)/hello.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "INC_OLE2" /D\
 "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hello.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /INCREMENTAL:no /PDB:$(OUTDIR)/"hello.pdb" /MACHINE:I386\
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "INC_OLE2" /D\
 "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hello.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"hello.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"hello.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"hello.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/hellopro.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D\
 "INC_OLE2" /D "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hello.pch" /Fo$(INTDIR)/ /c\
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows\
 /PDB:$(OUTDIR)/"hello.pdb" /MACHINE:MIPS /OUT:$(OUTDIR)/"hello.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/hellopro.obj \
	$(INTDIR)/hello.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D\
 "INC_OLE2" /D "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hello.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"hello.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows\
 /PDB:$(OUTDIR)/"hello.pdb" /DEBUG /MACHINE:MIPS /OUT:$(OUTDIR)/"hello.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/hellopro.obj \
	$(INTDIR)/hello.obj \
...
$(INTDIR)/hellopro.obj :  $(SOURCE)  $(DEP_HELLO) $(INTDIR)
...
$(INTDIR)/hello.obj :  $(SOURCE)  $(DEP_HELLO_) $(INTDIR)
...
$(INTDIR)/hello.res :  $(SOURCE)  $(DEP_HELLO_R) $(INTDIR)
   $(RSC) /l 0x409 /fo$(INTDIR)/"hello.res" /i "$(OUTDIR)" /d "NDEBUG"\
  $(SOURCE) 

!ELSEIF  "$(CFG)" == "Win32 (80x86) Debug"

$(INTDIR)/hello.res :  $(SOURCE)  $(DEP_HELLO_R) $(INTDIR)
   $(RSC) /l 0x409 /fo$(INTDIR)/"hello.res" /i "$(OUTDIR)" /d "_DEBUG"\
  $(SOURCE) 
...
# ADD MTL /tlb "hello.tlb" /h "ihello.h"

.\hello.tlb :  $(SOURCE)  $(OUTDIR)
   $(MTL) /nologo /D "NDEBUG" /D "WIN32" /tlb "hello.tlb" /h "ihello.h" /win32\
   $(SOURCE) 
...
.\hello.tlb :  $(SOURCE)  $(OUTDIR)
   $(MTL) /nologo /D "_DEBUG" /D "WIN32" /tlb "hello.tlb" /h "ihello.h" /win32\
   $(SOURCE) 
...
.\hello.tlb :  $(SOURCE)  $(OUTDIR)
   $(MTL) /nologo /D "NDEBUG" /D "WIN32" /tlb "hello.tlb" /h "ihello.h" /mips\
   $(SOURCE) 
...
.\hello.tlb :  $(SOURCE)  $(OUTDIR)
   $(MTL) /nologo /D "_DEBUG" /D "WIN32" /tlb "hello.tlb" /h "ihello.h" /mips\
   $(SOURCE) 
