...
!MESSAGE 
!MESSAGE NMAKE /f "dispcalc.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/dispcalc.exe $(OUTDIR)/dispcalc.bsc
...
# ADD CPP /nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "UNICODE" /D "INC_OLE2" /FR /c
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "UNICODE" /D\
 "INC_OLE2" /FR$(INTDIR)/ /Fp$(OUTDIR)/"dispcalc.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"dispcalc.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"dispcalc.bsc" 
BSC32_SBRS= \
	$(INTDIR)/dispcalc.sbr \
	$(INTDIR)/clsid.sbr \
	$(INTDIR)/winmain.sbr \
...
$(OUTDIR)/dispcalc.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib /NOLOGO /SUBSYSTEM:windows /MACHINE:I386
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"dispcalc.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"dispcalc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/dispcalc.obj \
	$(INTDIR)/clsid.obj \
...
$(OUTDIR)/dispcalc.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
# ADD CPP /nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "UNICODE" /D "INC_OLE2" /FR /c
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "UNICODE" /D\
 "INC_OLE2" /FR$(INTDIR)/ /Fp$(OUTDIR)/"dispcalc.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"dispcalc.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"dispcalc.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib /NOLOGO /SUBSYSTEM:windows /DEBUG /MACHINE:I386
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"dispcalc.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"dispcalc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/dispcalc.obj \
	$(INTDIR)/clsid.obj \
...
# ADD CPP /nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "UNICODE" /D "INC_OLE2" /FR /c
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D\
 "UNICODE" /D "INC_OLE2" /FR$(INTDIR)/ /Fp$(OUTDIR)/"dispcalc.pch" /Fo$(INTDIR)/\
 /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"dispcalc.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"dispcalc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/dispcalc.obj \
...
# ADD CPP /nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "UNICODE" /D "INC_OLE2" /FR /c
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"dispcalc.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"dispcalc.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/dispcalc.obj \
...
$(INTDIR)/dispcalc.obj :  $(SOURCE)  $(DEP_DISPC) $(INTDIR)
...
$(INTDIR)/idata.obj :  $(SOURCE)  $(DEP_IDATA) $(INTDIR)
...
$(INTDIR)/dispcalc.res :  $(SOURCE)  $(DEP_DISPCA) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
