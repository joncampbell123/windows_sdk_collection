...
!MESSAGE 
!MESSAGE NMAKE /f "spoly.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/spoly.exe $(OUTDIR)/spoly.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "INC_OLE2" /D\
 "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"spoly.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"spoly.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"spoly.bsc" 
BSC32_SBRS= \
	$(INTDIR)/winmain.sbr \
	$(INTDIR)/clsid.sbr \
	$(INTDIR)/statbar.sbr \
...
$(OUTDIR)/spoly.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 ...
 /INCREMENTAL:no /PDB:$(OUTDIR)/"spoly.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"spoly.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winmain.obj \
	$(INTDIR)/spoly.res \
...
$(OUTDIR)/spoly.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "INC_OLE2" /D\
 "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"spoly.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"spoly.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"spoly.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"spoly.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"spoly.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winmain.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D\
 "INC_OLE2" /D "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"spoly.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"spoly.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"spoly.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"spoly.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winmain.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D\
 "INC_OLE2" /D "UNICODE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"spoly.pch" /Fo$(INTDIR)/ /c\
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"spoly.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"spoly.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/winmain.obj \
...
$(INTDIR)/spoly.res :  $(SOURCE)  $(DEP_SPOLY) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
