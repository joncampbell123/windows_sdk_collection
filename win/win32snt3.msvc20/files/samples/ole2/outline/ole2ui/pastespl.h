...
typedef struct tagPASTESPECIAL
{
   ...
   OLECHAR              szUnknownType[PS_UNKNOWNSTRLEN];    // Buffer for 'Unknown Type' string
   OLECHAR              szUnknownSource[PS_UNKNOWNSTRLEN];  // Buffer for 'Unknown Source' string
   OLECHAR              szAppName[OLEUI_CCHKEYMAX]; // Application name of Source. Used in the result text
   ...
   SIZEL                sizelOD;              // sizel transfered in
                                    //  ObjectDescriptor
   LPOLESTR             szFullUserTypeNameOD; // Full User Type Name
   LPOLESTR             szSourceOfDataOD;     // Source of Data
   ...
   SIZEL                sizelLSD;             // sizel transfered in
                                    //  LinkSrcDescriptor
   LPOLESTR             szFullUserTypeNameLSD;// Full User Type Name
   LPOLESTR             szSourceOfDataLSD;    // Source of Data
