...
STDAPI_(HGLOBAL) OleUIMetafilePictFromIconAndLabel(HICON, LPOLESTR, LPOLESTR, UINT);
...
typedef struct tagOLEUICONVERT
   ...
   LPOLESTR        lpszUserType;     //IN-OUT: user type name of original class.
   ...
   LPOLESTR        lpszDefLabel;     //IN-OUT: default label to use for icon.
