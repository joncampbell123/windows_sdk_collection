...
*/
#define wLanguage 0x040C           /* French */
...
/* The first 4 characters of szTranslation must be the same as wLanguage,
   ...
   be capitalized. */
#define szTranslation "040C04E4"   /* French */
...
#define szzCompanyName     "Microsoft Corporation Incorporated\0"
#define szzFileDescription "Microsoft Windows(TM) OLE 2.0 Support interface utilisateur\0"
#define szzLegalCopyright  "Copyright \251 1992-1993 Microsoft Corp.  Tous droits réservés.\0"

#ifdef PUBLISHER
#define szzProductName "Microsoft Publisher pour Windows 2.0\0"
#else
