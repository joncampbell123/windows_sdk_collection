...
*/
#define wLanguage 0x0407           /* German */
...
/* The first 4 characters of szTranslation must be the same as wLanguage,
   ...
   be capitalized. */
#define szTranslation "040704E4"   /* German */
...
#define szzFileDescription "Microsoft Windows(TM) OLE 2.0 Unterstützung der Benutzerschnittstelle\0"
#define szzLegalCopyright  "Copyright \251 1992-1993 Microsoft Corp.  Alle Rechte vorbehalten.\0"

#ifdef PUBLISHER
#define szzProductName "Microsoft Publisher für Windows 2.0\0"
#else
