...
ALL : $(OUTDIR)/tracer.exe $(OUTDIR)/tracer.bsc
...
CPP_PROJ=/nologo /MD /W3 /GX /Ox /D "NDEBUG" /D "_WINDOWS" /D "_X86_" /D\
 "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch" /Yu"stdafx.h"\
 /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"tracer.res" /d "NDEBUG" /d "_AFXDLL" 
BSC32=bscmake.exe
...
LINK32_FLAGS=/NOLOGO /SUBSYSTEM:windows /INCREMENTAL:no\
 /PDB:$(OUTDIR)/"tracer.pdb" /MACHINE:IX86 /OUT:$(OUTDIR)/"tracer.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/tracer.obj \
	$(INTDIR)/tracer.res \
...
$(OUTDIR)/tracer.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"tracer.res" /d "_DEBUG" /d "_AFXDLL" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=/NOLOGO /SUBSYSTEM:windows /INCREMENTAL:yes\
 /PDB:$(OUTDIR)/"tracer.pdb" /DEBUG /MACHINE:IX86 /OUT:$(OUTDIR)/"tracer.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/tracer.obj \
	$(INTDIR)/tracer.res \
...
CPP_PROJ=/nologo /AL /Gt1 /Q68s /Q68m /W3 /GX /Zi /Od /D "_WINDOWS" /D "_MAC"\
 /D "_68K_" /D "_DEBUG" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch" /Yu"stdafx.h"\
 /Fo$(INTDIR)/ /Fd$(OUTDIR)/"tracer.pdb" /c 
CPP_OBJS=.\MacDebug/
...
RSC_PROJ=/r /fo$(INTDIR)/"tracer.rsc" /d "_MAC" /d "_68K_" /d "_DEBUG" 
MRC=mrc.exe
...
# ADD LINK32 swapd.lib sanes.lib wlmd.lib aslmd.lib wlm.rsc commdlg.rsc nafxcmd.lib /NOLOGO /MAC:bundle /MAC:creator="TRAC" /DEBUG /MACHINE:M68K /NODEFAULTLIB:"swap.lib"
LINK32_FLAGS=swapd.lib sanes.lib wlmd.lib aslmd.lib wlm.rsc commdlg.rsc\
 nafxcmd.lib /NOLOGO /MAC:bundle /MAC:type="APPL" /MAC:creator="TRAC"\
 /PDB:$(OUTDIR)/"tracer.pdb" /DEBUG /MACHINE:M68K /NODEFAULTLIB:"swap.lib"\
 /OUT:$(OUTDIR)/"tracer.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/tracer.obj \
	$(INTDIR)/tracer.rsc \
...
CPP_PROJ=/nologo /AL /Gt1 /Q68s /W3 /GX /O2 /D "_WINDOWS" /D "_MAC" /D "_68K_"\
 /D "NDEBUG" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch" /Yu"stdafx.h" /Fo$(INTDIR)/\
 /c 
CPP_OBJS=.\MacRel/
...
RSC_PROJ=/r /fo$(INTDIR)/"tracer.rsc" /d "_MAC" /d "_68K_" /d "NDEBUG" 
MRC=mrc.exe
...
# ADD LINK32 swap.lib sanes.lib wlm.lib aslm.lib wlm.rsc commdlg.rsc nafxcm.lib /NOLOGO /MAC:bundle /MAC:creator="TRAC" /MACHINE:M68K /NODEFAULTLIB:"swapd.lib"
LINK32_FLAGS=swap.lib sanes.lib wlm.lib aslm.lib wlm.rsc commdlg.rsc nafxcm.lib\
 /NOLOGO /MAC:bundle /MAC:type="APPL" /MAC:creator="TRAC"\
 /PDB:$(OUTDIR)/"tracer.pdb" /MACHINE:M68K /NODEFAULTLIB:"swapd.lib"\
 /OUT:$(OUTDIR)/"tracer.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/tracer.obj \
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch"\
...
LINK32_FLAGS=/NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"tracer.pdb"\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"tracer.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/tracer.obj \
	$(INTDIR)/tracer.res \
...
CPP_PROJ=/nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch"\
 /Yu"stdafx.h" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"tracer.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=/NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"tracer.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"tracer.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/tracer.obj \
...
$(INTDIR)/tracer.obj :  $(SOURCE)  $(DEP_TRACE) $(INTDIR) $(INTDIR)/stdafx.obj
...
$(INTDIR)/tracer.obj :  $(SOURCE)  $(DEP_TRACE) $(INTDIR) $(INTDIR)/stdafx.obj
 ...
 "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch" /Yu"stdafx.h"\
 /Fo$(INTDIR)/ /Fd$(OUTDIR)/"tracer.pdb" /c  $(SOURCE) 
...
$(INTDIR)/tracer.obj :  $(SOURCE)  $(DEP_TRACE) $(INTDIR) $(INTDIR)/stdafx.obj
 ...
 "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch"\
 /Yu"stdafx.h" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"tracer.pdb" /c  $(SOURCE) 
...
$(INTDIR)/tracer.res :  $(SOURCE)  $(DEP_TRACER) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/tracer.rsc :  $(SOURCE)  $(DEP_TRACER) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/tracmac.rsc :  $(SOURCE)  $(INTDIR)
   $(MRC) /o$(INTDIR)/"tracmac.rsc" /D "_MAC" /D "_68K_" /D "_DEBUG"  $(SOURCE)\
 

!ELSEIF  "$(CFG)" == "Macintosh Release"

$(INTDIR)/tracmac.rsc :  $(SOURCE)  $(INTDIR)
   $(MRC) /o$(INTDIR)/"tracmac.rsc" /D "_MAC" /D "_68K_" /D "NDEBUG"  $(SOURCE)\
...
$(INTDIR)/stdafx.obj :  $(SOURCE)  $(DEP_STDAF) $(INTDIR)
   $(CPP) /nologo /MD /W3 /GX /Ox /D "NDEBUG" /D "_WINDOWS" /D "_X86_" /D\
 "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch" /Yc"stdafx.h"\
 /Fo$(INTDIR)/ /c  $(SOURCE) 
...
$(INTDIR)/stdafx.obj :  $(SOURCE)  $(DEP_STDAF) $(INTDIR)
   $(CPP) /nologo /AL /Gt1 /Q68s /Q68m /W3 /GX /Zi /Od /D "_WINDOWS" /D "_MAC"\
 /D "_68K_" /D "_DEBUG" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch" /Yc"stdafx.h"\
 /Fo$(INTDIR)/ /Fd$(OUTDIR)/"tracer.pdb" /c  $(SOURCE) 
...
$(INTDIR)/stdafx.obj :  $(SOURCE)  $(DEP_STDAF) $(INTDIR)
   $(CPP) /nologo /AL /Gt1 /Q68s /W3 /GX /O2 /D "_WINDOWS" /D "_MAC" /D "_68K_"\
 /D "NDEBUG" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch" /Yc"stdafx.h" /Fo$(INTDIR)/\
 /c  $(SOURCE) 
...
$(INTDIR)/stdafx.obj :  $(SOURCE)  $(DEP_STDAF) $(INTDIR)
   $(CPP) /nologo /MD /Gt0 /QMOb2000 /W3 /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"tracer.pch"\
 /Yc"stdafx.h" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"tracer.pdb" /c  $(SOURCE) 
