...
templdef /DIS_SERIAL /DIS_RAW_SERIAL "CArray<WORD,WORD> CWordArray" array.ctt temp.h temp.inl array_w.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl

templdef /DIS_SERIAL /DIS_RAW_SERIAL "CArray<DWORD,DWORD> CDWordArray" array.ctt temp.h temp.inl array_d.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl
...
templdef "CList<void*,void*> CPtrList" list.ctt temp.h temp.inl list_p.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl

templdef /DIS_SERIAL "CList<CObject*,CObject*> CObList" list.ctt temp.h temp.inl list_o.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl
...
templdef "CMap<WORD,WORD,void*,void*> CMapWordToPtr" map.ctt temp.h temp.inl map_wp.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl

templdef "CMap<void*,void*,WORD,WORD> CMapPtrToWord" map.ctt temp.h temp.inl map_pw.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl

templdef "CMap<void*,void*,void*,void*> CMapPtrToPtr" map.ctt temp.h temp.inl map_pp.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl

templdef /DIS_SERIAL "CMap<WORD,WORD,CObject*,CObject*> CMapWordToOb" map.ctt temp.h temp.inl map_wo.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl
...
templdef "CMapStringTo<void*,void*> CMapStringToPtr" map_s.ctt temp.h temp.inl map_sp.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl

templdef /DIS_SERIAL "CMapStringTo<CObject*,CObject*> CMapStringToOb" map_s.ctt temp.h temp.inl map_so.cpp
copy newcoll.h+temp.h newcoll.h
copy newcoll.inl+temp.inl newcoll.inl
