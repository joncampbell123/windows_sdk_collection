...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndMainBar.Create(this, WS_CHILD | WS_VISIBLE |
	...
	if (!m_wndResourceBar.Create(this, WS_CHILD | WS_VISIBLE |
	...
	if (!m_wndDebugBar.Create(this, WS_CHILD | WS_VISIBLE |
	...
	if (!m_wndBrowseBar.Create(this, WS_CHILD | WS_VISIBLE |
	...
	if (!m_wndPaletteBar.Create(this, WS_CHILD | WS_VISIBLE |
	...
	m_wndMainBar.EnableDocking(CBRS_ALIGN_ANY | CBRS_FLOAT_MULTI);

	m_wndResourceBar.SetWindowText(_T("Resource"));
	m_wndResourceBar.EnableDocking(CBRS_ALIGN_ANY | CBRS_FLOAT_MULTI);

	m_wndDebugBar.SetWindowText(_T("Debug"));
	m_wndDebugBar.EnableDocking(CBRS_ALIGN_ANY | CBRS_FLOAT_MULTI);
	...
	m_wndBrowseBar.EnableDocking(CBRS_ALIGN_ANY | CBRS_FLOAT_MULTI);

	m_wndPaletteBar.SetWindowText(_T("Palette"));
	m_wndPaletteBar.EnableDocking(CBRS_ALIGN_ANY | CBRS_FLOAT_MULTI);
