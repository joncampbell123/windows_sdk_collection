...
!MESSAGE 
!MESSAGE NMAKE /f "gengl.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/gengl.exe $(OUTDIR)/gengl.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"gengl.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"gengl.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"gengl.bsc" 
BSC32_SBRS= \
	$(INTDIR)/render.sbr \
	$(INTDIR)/gengl.sbr

$(OUTDIR)/gengl.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib opengl32.lib glu32.lib odbc32.lib /NOLOGO /SUBSYSTEM:windows /MACHINE:I386
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib opengl32.lib glu32.lib odbc32.lib\
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"gengl.pdb"\
 /MACHINE:I386 /OUT:$(OUTDIR)/"gengl.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/render.obj \
	$(INTDIR)/gengl.obj \
...
$(OUTDIR)/gengl.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"gengl.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"gengl.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"gengl.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib opengl32.lib glu32.lib odbc32.lib /NOLOGO /SUBSYSTEM:windows /DEBUG /MACHINE:I386
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib opengl32.lib glu32.lib odbc32.lib\
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"gengl.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"gengl.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/render.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"gengl.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD LINK32 opengl32.lib glu32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows /MACHINE:MIPS
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=opengl32.lib glu32.lib kernel32.lib user32.lib gdi32.lib\
 winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib\
 uuid.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"gengl.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"gengl.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/render.obj \
	$(INTDIR)/gengl.obj \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"gengl.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"gengl.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# SUBTRACT BASE LINK32 /PDB:none
# ADD LINK32 opengl32.lib glu32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO /SUBSYSTEM:windows /DEBUG /MACHINE:MIPS
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=opengl32.lib glu32.lib kernel32.lib user32.lib gdi32.lib\
 winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib\
 uuid.lib /NOLOGO /SUBSYSTEM:windows /PDB:$(OUTDIR)/"gengl.pdb" /DEBUG\
 /MACHINE:MIPS /OUT:$(OUTDIR)/"gengl.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/render.obj \
	$(INTDIR)/gengl.obj \
...
$(INTDIR)/gengl.obj :  $(SOURCE)  $(DEP_GENGL) $(INTDIR)
...
$(INTDIR)/gengl.res :  $(SOURCE)  $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
