...
static void InitObjects(long num);
static void Init(void );
static void CALLBACK Reshape(int width,int height);
static void Render(unsigned long mode);
static long DoSelect(long x,long y);
static void RecolorTri(long h);
static void DeleteTri(long h);
static void GrowTri(long h);
static unsigned long CALLBACK Mouse_left(struct _AUX_EVENTREC *event);
static unsigned long CALLBACK Mouse_middle(struct _AUX_EVENTREC *event);
static unsigned long CALLBACK Mouse_right(struct _AUX_EVENTREC *event);
static void CALLBACK Draw(void );
static void DrawZoom(long x,long y);
static void DumpFeedbackVert(long *i,long n);
static void DrawFeedback(long n);
