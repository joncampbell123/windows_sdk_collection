...
!MESSAGE 
!MESSAGE NMAKE /f "hook.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : \samples\sdktools\spy\WinRel\hook.dll\
 \samples\sdktools\spy\WinRel\hook.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hook.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
\samples\sdktools\spy\WinRel\hook.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /INCREMENTAL:yes /MACHINE:I386 /IMPLIB:"WinRel/hook.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /INCREMENTAL:yes\
 /PDB:$(OUTDIR)/"hook.pdb" /MACHINE:I386 /DEF:".\hook.def"\
 /OUT:$(OUTDIR)/"hook.dll" /IMPLIB:"WinRel/hook.lib" 
DEF_FILE=.\hook.def
LINK32_OBJS= \
	.\WinRel\hook.obj

\samples\sdktools\spy\WinRel\hook.dll : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : \samples\sdktools\spy\WinDebug\hook.dll\
 \samples\sdktools\spy\WinDebug\hook.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS"\
 /D "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hook.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"hook.pdb" /c 
CPP_OBJS=.\WinDebug/
...
\samples\sdktools\spy\WinDebug\hook.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:I386 /IMPLIB:"WinDebug/hook.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /INCREMENTAL:yes\
 /PDB:$(OUTDIR)/"hook.pdb" /DEBUG /MACHINE:I386 /DEF:".\hook.def"\
 /OUT:$(OUTDIR)/"hook.dll" /IMPLIB:"WinDebug/hook.lib" 
DEF_FILE=.\hook.def
LINK32_OBJS= \
	.\WinDebug\hook.obj

\samples\sdktools\spy\WinDebug\hook.dll : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
CPP_PROJ=/nologo /MT /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hook.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:MIPS /IMPLIB:"WinRel/hook.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"hook.pdb"\
 /MACHINE:MIPS /DEF:".\hook.def" /OUT:$(OUTDIR)/"hook.dll"\
 /IMPLIB:"WinRel/hook.lib" 
DEF_FILE=.\hook.def
LINK32_OBJS= \
	.\WinRel\hook.obj
...
CPP_PROJ=/nologo /MT /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG"\
 /D "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"hook.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"hook.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:MIPS /IMPLIB:"WinDebug/hook.lib"
# SUBTRACT LINK32 /PDB:none
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib /NOLOGO /SUBSYSTEM:windows /DLL /PDB:$(OUTDIR)/"hook.pdb" /DEBUG\
 /MACHINE:MIPS /DEF:".\hook.def" /OUT:$(OUTDIR)/"hook.dll"\
 /IMPLIB:"WinDebug/hook.lib" 
DEF_FILE=.\hook.def
LINK32_OBJS= \
	.\WinDebug\hook.obj
