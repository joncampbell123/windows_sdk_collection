...
!MESSAGE 
!MESSAGE NMAKE /f "zoomin.mak" CFG="Win32 (80x86) Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/zoomin.exe $(OUTDIR)/zoomin.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"zoomin.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"zoomin.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"zoomin.bsc" 
BSC32_SBRS= \
	$(INTDIR)/zoomin.sbr

$(OUTDIR)/zoomin.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"zoomin.pdb"\
 /MACHINE:I386 /OUT:$(OUTDIR)/"zoomin.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/zoomin.res \
	$(INTDIR)/zoomin.obj

$(OUTDIR)/zoomin.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"zoomin.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"zoomin.pdb" /c 
CPP_OBJS=.\WinDebug/
...
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"zoomin.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 /NOLOGO /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"zoomin.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"zoomin.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/zoomin.res \
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"zoomin.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"zoomin.pdb" /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"zoomin.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/zoomin.res \
	$(INTDIR)/zoomin.obj
...
CPP_PROJ=/nologo /Gt0 /QMOb2000 /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /D "_MBCS" /FR$(INTDIR)/ /Fp$(OUTDIR)/"zoomin.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"zoomin.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /PDB:$(OUTDIR)/"zoomin.pdb" /DEBUG /MACHINE:MIPS\
 /OUT:$(OUTDIR)/"zoomin.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/zoomin.res \
...
$(INTDIR)/zoomin.res :  $(SOURCE)  $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/zoomin.obj :  $(SOURCE)  $(DEP_ZOOMI) $(INTDIR)
