...
//  NOTE:  if you delete this comment and the #define below, remove it
// from prpage.c as well
///  do not use USERELEASEFUN use USECALLBACK instead
...
typedef struct _PROPSHEETPAGE {
        ...
        LPFNPSPCALLBACK pfnCallback;        // PSP_USERELEASEFUNC: function will be called before HPROPSHEETPAGE is destroyed
