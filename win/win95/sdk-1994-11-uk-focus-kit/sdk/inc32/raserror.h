...
#define ERROR_INVALID_SMM                    (RASBASE+144)
#define ERROR_SMM_UNINITIALIZED              (RASBASE+145)
#define ERROR_NO_MAC_FOR_PORT                (RASBASE+146)
#define ERROR_SMM_TIMEOUT                    (RASBASE+147)
#define ERROR_BAD_PHONE_NUMBER               (RASBASE+148)

#define ERROR_WRONG_MODULE                   (RASBASE+149)

#define RASBASEEND			     (RASBASE+149)

#else   /* WINVER >= 0x400 */

#define RASBASEEND			     (RASBASE+143)
