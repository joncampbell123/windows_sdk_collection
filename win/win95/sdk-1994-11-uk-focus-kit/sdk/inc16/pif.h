...
#define PRG_NOMSDOSWARNING      0x0400      // see also: PfW386Flags & fNoMSDOSWarning
...
#define TSK_EXCLUSIVE           0x0004      // PfW386Flags & fExclusive
...
#define VID_DEFAULT             (VID_TEXTEMULATE | VID_AUTOCONVERTFS)
...
#define VID_AUTOCONVERTFS       0x0200      //!(PfW386Flags & fNoAutoConvert)
...
typedef struct PROPENV {                    /* env */
    ...
    WORD    wUnused1;                       // Unused Field #1
    WORD    wUnused2;                       // Unused Field #2
} PROPENV;
...
#define MAX_AUTOEXEC_SIZE   2048

#define CONFIGFILE      "\\CONFIG.APP"
#define AUTOEXECFILE    "\\AUTOEXEC.APP"
...
#define fNoAutoConvert  0x00400000          //  New for 4.00
#define fNoAutoConvertBit           22      //  New for 4.00
...
#define fNoMSDOSWarning 0x04000000          //  New for 4.00
#define fNoMSDOSWarningBit          26      //  New for 4.00
