...
#ifdef _WIN32
WINMMAPI MMRESULT WINAPI midiConnect(HMIDIIN hmi, HMIDIOUT hmo, LPVOID pReserved);
WINMMAPI MMRESULT WINAPI midiDisconnect(HMIDIIN hmi, HMIDIOUT hmo, LPVOID pReserved);
#endif
#endif
...
#define JOY_RETURNPOV		0x00000008l
#define JOY_RETURNBUTTONS	0x00000010l
#define JOY_RETURNRAWDATA	0x00000020l
#define JOY_RETURNPOVCTS	0x00000040l
#define JOY_RETURNRUDDER	0x00000080l
#define JOY_RETURNCENTERED	0x00000100l
#define JOY_RETURNALL		(JOY_RETURNX | JOY_RETURNY | JOY_RETURNZ | \
				 JOY_RETURNRUDDER | JOY_RETURNPOV | JOY_RETURNBUTTONS)
#define JOY_CAL_READALWAYS	0x00010000l
#define JOY_CAL_READXYONLY	0x00020000l
#define JOY_CAL_READXYZ		0x00040000l
#define JOY_CAL_READXYZR	0x00080000l
...
/* point of view capabilites */
#define JOY_POVCAP_HASPOV	0x00000001l
#define JOY_POVCAP_4DIR		0x00000002l
#define JOY_POVCAP_CTS		0x00000004l
...
typedef struct tagJOYCAPSA {
    ...
    UINT    wPOVcaps;	 	 /* point of view capabilites */
