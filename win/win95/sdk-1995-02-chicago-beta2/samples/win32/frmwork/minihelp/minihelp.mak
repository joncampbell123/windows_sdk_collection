...
!MESSAGE 
!MESSAGE NMAKE /f "minihelp.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/minihelp.exe $(OUTDIR)/minihelp.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"minihelp.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"MINIHELP.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"minihelp.bsc" 
BSC32_SBRS= \
	$(INTDIR)/MISC.SBR \
	$(INTDIR)/DISPATCH.SBR \
	$(INTDIR)/MINIHELP.SBR \
...
$(OUTDIR)/minihelp.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /INCREMENTAL:no /PDB:$(OUTDIR)/"minihelp.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"minihelp.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/MISC.OBJ \
	$(INTDIR)/DISPATCH.OBJ \
...
$(OUTDIR)/minihelp.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"minihelp.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"minihelp.pdb" /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"MINIHELP.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"minihelp.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib version.lib /NOLOGO\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"minihelp.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"minihelp.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/MISC.OBJ \
...
$(INTDIR)/MINIHELP.OBJ :  $(SOURCE)  $(DEP_MINIH) $(INTDIR)
...
$(INTDIR)/MINIHELP.res :  $(SOURCE)  $(DEP_MINIHE) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
