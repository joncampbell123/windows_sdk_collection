...
!MESSAGE 
!MESSAGE NMAKE /f "ANALOG.MAK" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/ANALOG.exe $(OUTDIR)/ANALOG.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ANALOG.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"ANALOG.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ANALOG.bsc" 
BSC32_SBRS= \
	$(INTDIR)/MISC.SBR \
	$(INTDIR)/ABOUT.SBR \
	$(INTDIR)/DISPATCH.SBR \
...
$(OUTDIR)/ANALOG.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 version.lib /NOLOGO /INCREMENTAL:no /PDB:$(OUTDIR)/"ANALOG.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"ANALOG.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ANALOG.res \
	$(INTDIR)/MISC.OBJ \
...
$(OUTDIR)/ANALOG.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ANALOG.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"ANALOG.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"ANALOG.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ANALOG.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib\
 version.lib /NOLOGO /INCREMENTAL:yes /PDB:$(OUTDIR)/"ANALOG.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"ANALOG.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ANALOG.res \
	$(INTDIR)/MISC.OBJ \
...
$(INTDIR)/ANALOG.res :  $(SOURCE)  $(DEP_ANALO) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/ANALOG.OBJ :  $(SOURCE)  $(DEP_ANALOG) $(INTDIR)
...
$(INTDIR)/COPIER.OBJ :  $(SOURCE)  $(DEP_COPIE) $(INTDIR)
