...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
  ...
  /* Save the instance handle in static variable, which will be used in many
     subsequence calls from this application to Windows.                    */
  hInst = hInstance;
  ...
  return (TRUE);                        /* value from PostQuitMessage       */
}
...
{
  DLGPROC lpDialog;                     /* pointer to the "About" function  */
  ...
  switch (message)
  {
    case WM_COMMAND:                    /* message: command from app. menu  */
      ...
      {
        case IDM_ABOUT:
          lpDialog = (DLGPROC)MakeProcInstance((FARPROC)About, hInst);
          DialogBox(hInst,              /* current instance                 */
            MAKEINTRESOURCE(DLG_ABOUT), /* resource to use                  */
            hWnd,                       /* parent window handle             */
            lpDialog);                  /* About() instance address         */
          FreeProcInstance((FARPROC)lpDialog);
          break;

        default:                        /* lets Windows process the message */
