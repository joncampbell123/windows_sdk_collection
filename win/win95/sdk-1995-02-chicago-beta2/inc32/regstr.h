...
// Values for internatinal startup disk
...
#ifdef BILINGUAL
#define DOSOPTF_MULTIPLE    0x00000080L // Load multiple configuration
#endif
...
//
#define SUF_FIRSTTIME   0x00000001L // First boot into Chicago.
...
#define	REGSTR_VAL_COMPRESSIONMETHOD		"CompressionMethod"
...
//
#define	REGSTR_VAL_PCI_VIDEO_WANT_IRQ	"PCIVideoWantIRQ"	// Video needs IRQ
#define	REGSTR_PCI_OPTIONS		"Options"	// Possible PCI options
#define	REGSTR_PCI_DUAL_IDE		"PCIDualIDE"	// Dual IDE flag
#define	REGSTR_PCI_NO_CONFIG_REG	"NoConfigReg"	// Device has no config regs
