...
#define MS_ValidateParameters(pobj, eMethod)        \
        OBJ_ValidateParameters(pobj, eMethod, sizeof(IMS), &vtblIMS)
    ...
    LPMAPIERROR * lppMapiError)
{
    ...
    ValidateParameters(IMAPIProp_GetLastError, &pobj);                          \
...
STDMETHODIMP IMS_SaveChanges(PIMS pims, ULONG ulFlags)
{
    ...
    ValidateParameters(IMAPIProp_SaveChanges, &pims);
    #endif
    ...
    ULONG *pcval, LPSPropValue *ppval)
{
    ...
    MS_ValidateParameters(pims, IMAPIProp_GetProps);
...
STDMETHODIMP IMS_GetPropList(PIMS pims, ULONG ulFlags, LPSPropTagArray * pptaga)
{
    ...
    MS_ValidateParameters(pims, IMAPIProp_GetPropList);
    ...
    ULONG ulInterfaceOptions, ULONG ulFlags, LPUNKNOWN * lppUnk)
{
    ...
    MS_ValidateParameters(pims, IMAPIProp_OpenProperty);
    ...
    LPSPropProblemArray * lppProblems)
{
    ...
    MS_ValidateParameters(pims, IMAPIProp_SetProps);
    ...
    LPSPropProblemArray *pprba)
{
    ...
    MS_ValidateParameters(pims, IMAPIProp_DeleteProps);
    ...
    LPSPropProblemArray *pprba)
{
    ...
    MS_ValidateParameters(pims, IMAPIProp_CopyTo);
    ...
    LPSPropProblemArray *pprba)
{
    ...
    MS_ValidateParameters(pims, IMAPIProp_CopyProps);
    ...
    LPGUID lpguid, ULONG ulFlags, ULONG * pcNames, LPMAPINAMEID ** pppNames)
{
    ...
    ValidateParameters(IMAPIProp_GetNamesFromIDs, &pobj);
    #endif
 ...
 *
 *  Errors:
 *      MAPI_E_NO_SUPPORT   This method is not yet supported by the sample ms.
 */
    ...
    LPMAPINAMEID * ppNames, ULONG ulFlags, LPSPropTagArray * pptaga)
{
    ...
    ValidateParameters(IMAPIProp_GetIDsFromNames, &pobj);
    #endif
    ...
    switch(pobj->wType)
    {
        case OT_MSGSTORE:
        {
            ...
            hr = HrOpenIMSPropsFileRetry(pims->pmsgsess, pims->szProps,
                &pims->lmr, pims->psup, !!(ulFlags & MAPI_CREATE),
                (LPMESSAGE *) &pmp);
            if (hr != hrSuccess)
                goto exit;
        ...
        case OT_FOLDER:
        {
            ...
            hr = HrOpenPropertyMessageRetry(pifld->peid, pifld->pims,
                !!(ulFlags & MAPI_CREATE), (LPMESSAGE *) &pmp);
            if (hr != hrSuccess)
                goto exit;
    ...
    if (fSaveReleasePMP)
        hr = pmp->lpVtbl->SaveChanges(pmp, 0);
    ...
    ULONG *lpulConnection)
{
    ...
    ValidateParameters(IMsgStore_Advise, &pobj);
    #endif
...
STDMETHODIMP IMS_Unadvise(PIMS pobj, ULONG ulConnection)
{
    ...
    ValidateParameters(IMsgStore_Unadvise, &pobj);
    #endif
    ...
    ULONG *lpulResult)
{
    ...
    ValidateParameters(IMsgStore_CompareEntryIDs, &pobj);
    #endif
    ...
    LPCIID piid, ULONG ulFlags, ULONG *lpulObjType, LPUNKNOWN *lppUnk)
{
    ...
    ValidateParameters(IMAPIContainer_OpenEntry, &pobj);
    #endif
    ...
    ULONG ulFlags, ULONG cbEntryID, LPENTRYID lpEntryID)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_SetReceiveFolder);
    ...
    if (cbEntryID)
    {
        ...
        rfn.szClass = szMessageClass;
        rfn.szName = peid->szPath;

        hr = GetRFN(pims->prfs, szMessageClass, &prfnExisting);
        if (hr != hrSuccess)
        {
        ...
        else
        {
            ...
            if (!lstrcmp(szMessageClass, prfnExisting->szClass))
                hr = DeleteRFN(pims->prfs, szMessageClass);
    ...
    LPTSTR *pszExplicitClass)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_GetReceiveFolder);
    ...
    *lppEntryID = NULL;
    ...
    hr = GetRFN(pims->prfs, szMessageClass, &prfn);
    if (hr != hrSuccess)
        goto exit;
...
{
    MS_ValidateParameters(pims, IMsgStore_GetReceiveFolderTable);
...
STDMETHODIMP IMS_StoreLogoff(PIMS pims, ULONG * pulFlags)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_StoreLogoff);
    ...
    ULONG ulFlags)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_AbortSubmit);
    ...
    LPMAPITABLE *lppTable)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_GetOutgoingQueue);
...
STDMETHODIMP IMS_SetLockState(PIMS pims, LPMESSAGE lpMessage, ULONG ulFlags)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_SetLockState);
    ...
    LPENTRYID lpEntryID)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_FinishedMsg);
...
STDMETHODIMP IMS_NotifyNewMail(PIMS pims, LPNOTIFICATION pntf)
{
    ...
    MS_ValidateParameters(pims, IMsgStore_NotifyNewMail);
