...
#define MSL_CheckParameters(pobj, eMethod)      \
        OBJ_CheckParameters(pobj, eMethod, sizeof(MSL), &vtblMSL)
#define MSP_CheckParameters(pobj, eMethod)      \
        OBJ_CheckParameters(pobj, eMethod, sizeof(MSP), &vtblMSP)
    ...
    LPMAPIERROR * lppMapiError, LPMSLOGON * ppmslogon, LPMDB * ppmdb)
{
    ...
    MSP_CheckParameters(pmsp, IMSProvider_Logon);
    ...
    LPMSLOGON * ppmslogon, LPMDB * ppmdb)
{
    ...
    MSP_CheckParameters(pmsp, IMSProvider_SpoolerLogon);
...
{
    MSL_CheckParameters(pmsl, IMSLogon_Logoff);
...
{
    MSL_CheckParameters(pmsl, IMSLogon_OpenStatusEntry);
