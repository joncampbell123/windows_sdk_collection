...
void CMainWindow::OnLogon()
{
    ...
    LogonDlg.m_CurrentOperation= "MAPILogonEx(MAPI_LOGON_UI)";
    ...
    LogonDlg.m_FlagText6       = "MAPI_UNICODE";
    ...
    if( LogonDlg.DoModal() == IDOK )
    {
        ...
        hResultSession = MAPILogonEx(   ulUIParam,
                                NULL,
                                NULL,
                                ulFlags,
        ...
        {
            MessageBox( E.SzError("MAPILogonEx", hResultSession), "Client", MBS_ERROR );
