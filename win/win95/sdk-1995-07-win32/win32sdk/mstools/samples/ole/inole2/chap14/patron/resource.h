...
#define IDM_EDITLINKS               (IDM_CUSTOMEDITMIN+4)
//CHAPTER14MOD
#define IDM_EDITCONVERT             (IDM_CUSTOMEDITMIN+5)
//End CHAPTER14MOD
...
#define IDS_DOCUMENTMAX             (IDS_CUSTOMDOCMIN+13)
...
#define IDS_ITEMMESSAGEEDITLINKS            (IDS_CUSTOMSTATMESSAGEMIN+13)
#define IDS_ITEMMESSAGEPAGESHOWOBJECTS      (IDS_CUSTOMSTATMESSAGEMIN+14)
//CHAPTER14MOD
#define IDS_ITEMMESSAGEEDITCONVERT          (IDS_CUSTOMSTATMESSAGEMIN+15)
