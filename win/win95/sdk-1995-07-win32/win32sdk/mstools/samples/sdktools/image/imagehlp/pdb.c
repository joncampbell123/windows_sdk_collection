...
#define GetFunc(fn) \
            { \
                if (!_##fn) { \
                    ...
                    (PVOID)_##fn = (PVOID)GetProcAddress( hPdbLib, #fn ); \
                    if (!_##fn) { \
                        return FALSE; \
                    } \
                } \
    ...
    )
{
    ...
    hPdbLib = LoadLibrary( "mspdb30.dll" );
    if (!hPdbLib) {
...
{
    GetFunc( PDBExportValidateInterface );
...
{
    GetFunc( PDBQueryInterfaceVersion );
...
{
    GetFunc( PDBQueryImplementationVersion );
...
{
    GetFunc( DBIQueryInterfaceVersion );
...
{
    GetFunc( DBIQueryImplementationVersion );
...
{
    GetFunc( ModQueryInterfaceVersion );
...
{
    GetFunc( ModQueryImplementationVersion );
...
{
    GetFunc( TypesQueryInterfaceVersion );
...
{
    GetFunc( TypesQueryImplementationVersion );
...
{
    GetFunc( TypesQueryTiForCVRecord );
...
{
    GetFunc( TypesQueryCVRecordForTi );
...
{
    GetFunc( TypesQueryPbCVRecordForTi );
