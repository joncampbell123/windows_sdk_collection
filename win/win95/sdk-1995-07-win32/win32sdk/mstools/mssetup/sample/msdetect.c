...
// *************************************************************************
DWORDLONG GetTotalSpaceForDrive(LPSTR szDrive)
{
	DWORDLONG totalspc;
#ifdef DEBUG
	if (FValidDrive(szDrive) == 0)
...
// *************************************************************************
DWORDLONG GetFreeSpaceForDrive(LPSTR szDrive)
{
	CHAR ch;
	DWORDLONG freespc;
...
// *************************************************************************
BOOL DoesFileExist(LPSTR szFileName, INT mode)
{
...
// *************************************************************************
DWORD GetSizeOfFile(LPSTR szFile)
{
#ifdef DEBUG
	if (FValidPath(szFile) == 0)
...
INT GetProcessorType(void)
{
	...
	if (FGetProcessorType("", 0, szResult, cb)) {
		...
		return(400) ;
	    if (lstrcmpi(szResult, "PPC620") == 0)
		return(620) ;
	    if (lstrcmpi(szResult, "PPC604") == 0)
		return(604) ;
	    if (lstrcmpi(szResult, "PPC603") == 0)
		return(603) ;
	    if (lstrcmpi(szResult, "PPC601") == 0)
		return(601) ;
	    if (lstrcmpi(szResult, "AXP21164") == 0)
		return(21164) ;
	    if (lstrcmpi(szResult, "AXP21066") == 0)
		return(21066) ;
		...
		return(2000) ;
	    if (lstrcmpi(szResult, "PENTIUM") == 0)
		return(5) ;
