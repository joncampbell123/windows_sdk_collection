#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Broadcast, Receive Promiscuous & Resend Directed" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.3.1.11.5 Send Broadcast, Receive Promiscuous & Resend
