#	-SECTION_START-( 7.00 ) -SECTION_DESC-( "Send Functional, Receive Mac Frames" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 1.3.1.5.7 Send Functional, Receive Mac Frames (1M/2C/1O)
##
...
## set to receive MACFRAME packets.  Packets of size 40 bytes,
