#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Multicast, Receive None" )
##
## TITLE: 1.3.1.4.6 Send Multicast, Receive None (1M/2C/1O)
##
...
## set to receive No packets.  Packets of size 40 bytes,
...
# Then stop the sends and dum the statistics.
