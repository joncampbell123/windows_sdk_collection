#	-SECTION_START-( 7.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Source Routing & Resend Directed" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.3.1.14.11 Send Directed, Receive Directed & Source Routing
