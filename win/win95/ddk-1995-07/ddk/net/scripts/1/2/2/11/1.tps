#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Resend Directed" )
##
## TITLE: 1.2.2.11.1 Send Broadcast, Receive Broadcast & Resend
...
## set to receive BROADCAST packets.  Each packet will contain a
