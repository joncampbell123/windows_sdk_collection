#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Multicast, Receive Multicast & Resend Directed" )
##
## TITLE: 1.2.2.12.1 Send Multicast, Receive Multicast & Resend
...
## set to receive MULTICAST packets.  Each packet will contain a
