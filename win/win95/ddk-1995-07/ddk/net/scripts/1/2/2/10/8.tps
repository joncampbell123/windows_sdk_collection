#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Directed, Receive Promiscuous & Resend Functional" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.10.8 Send Directed, Receive Promiscuous & Resend
