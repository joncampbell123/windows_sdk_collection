#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Directed, Receive Promiscuous & Resend Multicast" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.10.7 Send Directed, Receive Promiscuous & Resend
