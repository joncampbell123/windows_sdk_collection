#	-SECTION_START-( 7.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Source Routing & Resend Directed" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.2.2.17.7 Send Functional, Receive Functional & Source Routing
