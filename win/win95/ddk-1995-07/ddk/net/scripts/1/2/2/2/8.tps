#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Directed, Receive Source Routing" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.2.2.2.8 Send Directed, Receive Source Routing (1M/1C/2O)
##
