...
##
## TITLE: 1.2.1.1212_FD Query Information Tests (1M/1C/20)
##
...
#	-SECTION_START-( 1.29 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=1                              +
    OID=OID_FDDI_SHORT_MULTICAST_LIST                # 0x03010107
#	-SECTION_END-( 1.29 )

#	-SECTION_START-( 1.30 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=1                              +
...
#	-SECTION_START-( 1.33 ) -TOKEN_MATCH-( 4,0 )
QueryInformation                                +
    OpenInstance=1                              +
    OID=OID_GEN_SUPPORTED_LIST                   # 0x00010101
#	-SECTION_END-( 1.33 )

#	-SECTION_START-( 1.34 ) -TOKEN_MATCH-( 4,0 )
QueryInformation                                +
    OpenInstance=2                              +
    OID=OID_GEN_SUPPORTED_LIST                   # 0x00010101
#	-SECTION_END-( 1.34 )
...
#	-SECTION_START-( 1.71 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=1                              +
    OID=OID_FDDI_SHORT_PERMANENT_ADDR                # 0x03010105
#	-SECTION_END-( 1.71 )

#	-SECTION_START-( 1.72 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=2                              +
    OID=OID_FDDI_SHORT_PERMANENT_ADDR                # 0x03010105
#	-SECTION_END-( 1.72 )

#	-SECTION_START-( 1.73 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=1                              +
    OID=OID_FDDI_SHORT_CURRENT_ADDR                  # 0x03010106
#	-SECTION_END-( 1.73 )

#	-SECTION_START-( 1.74 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=2                              +
    OID=OID_FDDI_SHORT_CURRENT_ADDR                  # 0x03010106
#	-SECTION_END-( 1.74 )

#	-SECTION_START-( 1.75 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=1                              +
    OID=OID_FDDI_SHORT_MULTICAST_LIST                # 0x03010107
#	-SECTION_END-( 1.75 )

#	-SECTION_START-( 1.76 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=2                              +
    OID=OID_FDDI_SHORT_MULTICAST_LIST                # 0x03010107
#	-SECTION_END-( 1.76 )

#	-SECTION_START-( 1.77 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=1                              +
    OID=OID_FDDI_SHORT_MAX_LIST_SIZE                 # 0x03010108
#	-SECTION_END-( 1.77 )

#	-SECTION_START-( 1.78 ) -OPTIONALS-()
QueryInformation                                +
    OpenInstance=2                              +
    OID=OID_FDDI_SHORT_MAX_LIST_SIZE                 # 0x03010108
#	-SECTION_END-( 1.78 )
