#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Directed, Receive Promiscuous & Resend Directed" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.10.5 Send Directed, Receive Promiscuous & Resend
