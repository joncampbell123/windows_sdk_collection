#   -SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Multicast, Receive Promiscuous & Resend Broadcast" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.12.5 Send Multicast, Receive Promiscuous & Resend
