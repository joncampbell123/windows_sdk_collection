#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Broadcast, Receive All Functional" ) -OPTIONALS-( ALLFUNCTIONAL )
##
## TITLE: 1.2.2.3.7 Send Broadcast, Receive All Functional (1M/1C/2O)
##
