#	-SECTION_START-( 9.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Source Routing & Resend Functional" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.2.2.17.9 Send Functional, Receive Functional & Source Routing
