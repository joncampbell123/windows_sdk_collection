#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast, Receive Source Routing" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.2.2.3.8 Send Broadcast, Receive Source Routing (1M/1C/2O)
##
