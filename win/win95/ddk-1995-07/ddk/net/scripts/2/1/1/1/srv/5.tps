#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Directed, Receive All Multicast-server-side" ) -OPTIONALS-( ALLMULTICAST )
##
## TITLE: 2.1.1.1.5 Send Directed, Receive All Multicast (2M/1C/1O)
## TITLE:           server-side
##
