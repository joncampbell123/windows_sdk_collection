#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Multicast Receive Promiscuous & Resend Broadcast-client-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.11.5 Send Multicast Receive Promiscuous & Resend
