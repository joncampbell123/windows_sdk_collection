#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Functional & Resend Directed-client-side" )
##
## TITLE: 2.1.1.13.8 Send Directed, Receive Directed & Functional &
