#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Broadcast, Resend Multicast-client-side" )
##
## TITLE: 2.1.1.13.3 Send Directed, Receive Directed & Broadcast
