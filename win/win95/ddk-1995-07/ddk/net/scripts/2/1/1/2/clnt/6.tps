#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Broadcast, Receive Functional-client-side" )
##
## TITLE: 2.1.1.2.6 Send Broadcast, Receive Functional (2M/1C/1O) client-side
##
