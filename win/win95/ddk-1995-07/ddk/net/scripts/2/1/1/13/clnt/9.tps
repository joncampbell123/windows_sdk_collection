#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Functional & Resend Broadcast-client-side" )
##
## TITLE: 2.1.1.13.9 Send Directed, Receive Directed & Functional &
