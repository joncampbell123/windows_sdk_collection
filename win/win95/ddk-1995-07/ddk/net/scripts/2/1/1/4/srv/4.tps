#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Functional, Receive Functional-server-side" )
##
## TITLE: 2.1.1.4.4 Send Functional, Receive Functional (2M/1C/1O) server-side
##
...
## have its packetfilter set to receive FUNCTIONAL packets.  Packets
