#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Functional & Resend Functional-client-side" )
##
## TITLE: 2.1.1.14.10 Send Broadcast, Receive Broadcast & Functional &
