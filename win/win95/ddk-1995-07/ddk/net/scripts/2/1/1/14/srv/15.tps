#	-SECTION_START-( 8.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Mac Frame & Resend Broadcast-server-side" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 2.1.1.14.15 Send Broadcast, Receive Broadcast & Mac Frame &
...
## have its packetfilter set to receive BROADCAST & MAC FRAME packets.
