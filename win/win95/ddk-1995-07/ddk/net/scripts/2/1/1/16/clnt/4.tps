#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Broadcast & Resend Directed-client-side" )
##
## TITLE: 2.1.1.16.4 Send Functional, Receive Functional & Broadcast &
