#   -SECTION_START-( 1.0 ) -SECTION_DESC-( "Send Broadcast, Receive Directed Broadcast & Functional" )
##
## TITLE: 1.1.2.7.2 Send Broadcast, Receive Directed, Broadcast & Functional (1M/1C/1O)
##
