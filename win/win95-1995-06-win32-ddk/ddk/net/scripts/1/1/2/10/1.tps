#   -SECTION_START-( 1.0 ) -SECTION_DESC-( "Send Directed,Receive Directed,Resend Directed" )
##
## TITLE: 1.1.2.10.1 Send Directed, Receive Directed & Resend
## TITLE:            Directed (1M/1C/1O)
##
