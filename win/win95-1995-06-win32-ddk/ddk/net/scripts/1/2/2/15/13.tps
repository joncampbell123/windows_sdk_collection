#	-SECTION_START-( 9.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Source Routing & Resend Functional" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.2.2.15.13 Send Broadcast, Receive Broadcast & Source Routing
