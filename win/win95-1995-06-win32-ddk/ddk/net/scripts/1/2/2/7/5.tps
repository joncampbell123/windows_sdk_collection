#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Broadcast, Receive Directed & Mac Frame" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 1.2.2.7.5 Send Broadcast, Receive Directed & Mac Frame (1M/1C/2O)
##
...
## set to receive DIRECTED and MACFRAME packets.  Packets of size
