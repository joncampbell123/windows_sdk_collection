#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Directed, Receive All Multicast" ) -OPTIONALS-( ALLMULTICAST )
##
## TITLE: 1.2.2.2.5 Send Directed, Receive All Multicast (1M/1C/2O)
##
