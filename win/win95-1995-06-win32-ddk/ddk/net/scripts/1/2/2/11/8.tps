#   -SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast, Receive Promiscuous & Resend Functional" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.11.8 Send Broadcast, Receive Promiscuous & Resend
