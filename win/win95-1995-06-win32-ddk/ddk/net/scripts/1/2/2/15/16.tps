#	-SECTION_START-( 12.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Mac Frame & Resend Functional" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 1.2.2.15.16 Send Broadcast, Receive Broadcast & Mac Frame
...
## set to receive BROADCAST & MACFRAME packets.  Each packet will contain
