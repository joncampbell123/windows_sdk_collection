#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Multicast, Receive All Multicast" ) -OPTIONALS-( ALLMULTICAST )
##
## TITLE: 1.3.1.4.5 Send Multicast, Receive All Multicast (1M/2C/1O)
##
...
## set to receive ALLMULTICAST packets.  Packets of size 40 bytes,
