#	-SECTION_START-( 2.00 ) -SECTION_DESC-( "Send Broadcast, Receive Directed & Multicast" )
##
## TITLE: 1.3.1.7.2 Send Broadcast, Receive Directed & Multicast (1M/2C/1O)
##
...
## set to receive DIRECTED and MULTICAST packets.  Packets of size
