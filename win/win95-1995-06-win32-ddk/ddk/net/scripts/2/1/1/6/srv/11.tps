#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast, Receive Directed & Broadcast & Functional-server-side" )
##
## TITLE: 2.1.1.6.11 Send Broadcast, Receive Directed & Broadcast &
