#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Multicast & Resend Multicast-server-side" )
##
## TITLE: 2.1.1.14.7 Send Broadcast, Receive Broadcast & Multicast & Resend
