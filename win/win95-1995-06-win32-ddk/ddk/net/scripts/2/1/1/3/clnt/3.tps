#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Multicast, Receive Promiscuous-client-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.3.3 Send Multicast, Receive Promiscuous (2M/1C/1O) client-side
##
