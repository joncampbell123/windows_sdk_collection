#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Multicast, Receive Multicast & Resend Directed-server-side" )
##
## TITLE: 2.1.1.11.1 Send Multicast, Receive Multicast & Resend
...
## have its packetfilter set to receive MULTICAST packets.  Each packet
...
# Then and receive and dump the statistics.
