#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Functional, Receive Promiscuous-server-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.4.3 Send Functional, Receive Promiscuous (2M/1C/1O) server-side
##
