#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Multicast, Receive Broadcast & Multicast & Resend Directed-client-side" )
##
## TITLE: 2.1.1.15.4 Send Multicast, Receive Broadcast & Multicast & Resend
