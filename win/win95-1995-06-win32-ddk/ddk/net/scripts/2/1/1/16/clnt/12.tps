#	-SECTION_START-( 9.00 ) -SECTION_DESC-( "Send Functional, Receive & Functional & Mac Frames & Resend Functional-client-side" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 2.1.1.16.12 Send Functional, Receive & Functional & Mac Frames
