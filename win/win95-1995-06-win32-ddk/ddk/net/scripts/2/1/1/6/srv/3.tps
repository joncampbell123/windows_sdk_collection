#	-SECTION_START-( 2.00 ) -SECTION_DESC-( "Send Broadcast, Receive Directed & Functional-server-side" )
##
## TITLE: 2.1.1.6.3 Send Broadcast, Receive Directed & Functional
