#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Broadcast, Receive All Multicast-server-side" ) -OPTIONALS-( ALLMULTICAST )
##
## TITLE: 2.1.1.2.5 Send Broadcast, Receive All Multicast (2M/1C/1O)
## TITLE:           server-side
##
