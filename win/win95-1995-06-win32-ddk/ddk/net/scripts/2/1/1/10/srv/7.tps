#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast Receive Promiscuous & Resend Multicast-server-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.10.7 Send Broadcast Receive Promiscuous & Resend
