#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Broadcast & Resend Broadcast-client-side" )
##
## TITLE: 2.1.1.16.5 Send Functional, Receive Functional & Broadcast &
