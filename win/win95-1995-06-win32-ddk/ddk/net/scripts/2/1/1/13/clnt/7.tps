#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Multicast & Resend Multicast-client-side" )
##
## TITLE: 2.1.1.13.7 Send Directed, Receive Directed & Multicast &
