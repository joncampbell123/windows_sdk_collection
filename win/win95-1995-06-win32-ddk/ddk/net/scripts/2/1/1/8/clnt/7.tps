#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Functional, Receive Broadcast & Mac Frame-client-side" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 2.1.1.8.7 Send Functional, Receive Broadcast & Mac Frame
