#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Directed, Receive Promiscuous-client-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.1.3 Send Directed, Receive Promiscuous (2M/1C/1O) client-side
##
