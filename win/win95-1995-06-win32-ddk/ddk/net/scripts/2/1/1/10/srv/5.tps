#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Broadcast Receive Promiscuous & Resend Directed-server-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.10.5 Send Broadcast Receive Promiscuous & Resend
