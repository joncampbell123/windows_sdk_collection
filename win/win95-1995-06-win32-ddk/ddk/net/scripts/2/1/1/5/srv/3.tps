#	-SECTION_START-( 2.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Functional-server-side" )
##
## TITLE: 2.1.1.5.3 Send Directed, Receive Directed & Functional
