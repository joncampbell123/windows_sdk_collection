...
function HideMenu() { if( PPTSld.document.all.item("ctxtmenu") && PPTSld.ctxtmenu.style.display!="none" ) { PPTSld.ctxtmenu.style.display='none'; return true } return false }
...
var g_supportsPPTHTML = SupportsPPTHTML(), g_scaleInFrame = true, gId="", g_bgSound="",
    g_scaleHyperlinks = false, g_allowAdvOnClick = false, g_showInBrowser = true;
...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=23, SCRIPT_HREF="pp2000_script.js", FULLSCR_HREF="pp2000_fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("pp2000_slide0352.htm", 1, 1),
   new hrefList("pp2000_slide0353.htm", 1, 2),
   new hrefList("pp2000_slide0373.htm", 1, 3),
   new hrefList("pp2000_slide0367.htm", 1, 4),
   new hrefList("pp2000_slide0372.htm", 1, 5),
   new hrefList("pp2000_slide0355.htm", 1, 6),
   new hrefList("pp2000_slide0356.htm", 1, 7),
   new hrefList("pp2000_slide0357.htm", 1, 8),
   new hrefList("pp2000_slide0358.htm", 1, 9),
   new hrefList("pp2000_slide0359.htm", 1, 10),
   new hrefList("pp2000_slide0360.htm", 1, 11),
   new hrefList("pp2000_slide0361.htm", 1, 12),
   new hrefList("pp2000_slide0368.htm", 1, 13),
   new hrefList("pp2000_slide0362.htm", 1, 14),
   new hrefList("pp2000_slide0363.htm", 1, 15),
   new hrefList("pp2000_slide0364.htm", 1, 16),
   new hrefList("pp2000_slide0370.htm", 1, 17),
   new hrefList("pp2000_slide0365.htm", 1, 18),
   new hrefList("pp2000_slide0366.htm", 1, 19),
   new hrefList("pp2000_slide0369.htm", 1, 20),
   new hrefList("pp2000_slide0371.htm", 1, 21),
   new hrefList("pp2000_slide0374.htm", 1, 22),
   new hrefList("pp2000_slide0354.htm", 1, 23)
);
...
}curSeqID = 0, mClicks = 0, syncThread = -1;

function SyncUp( syncTo )
{
if( syncTo > mClicks )
{
if( g_animManager && g_animManager.Next() )
mClicks++;
}
else
{
window.clearInterval( syncThread );
syncThread = -1;
}
}

function DocumentOnBuildCmd( buildStep, seqID )
{
buildStep = parseInt(buildStep);
seqID = parseInt(seqID);
if( buildStep > mClicks  &&  seqID > curSeqID ) {
curSeqID = seqID;
if( syncThread < 0 )
syncThread = window.setInterval( "SyncUp(" + buildStep + ")", 1000 );
}
else if( buildStep < 0 && g_animManager )
g_animManager.ShowShapes();
}

function UnloadSlide() { parent.slideLoaded = false; }