...
var gDocTable = new Array(
   new hrefList("slide0352.htm", 1, 1),
   new hrefList("slide0353.htm", 1, 2),
   new hrefList("slide0373.htm", 1, 3),
   new hrefList("slide0367.htm", 1, 4),
   new hrefList("slide0372.htm", 1, 5),
   new hrefList("slide0355.htm", 1, 6),
   new hrefList("slide0356.htm", 1, 7),
   new hrefList("slide0357.htm", 1, 8),
   new hrefList("slide0358.htm", 1, 9),
   new hrefList("slide0359.htm", 1, 10),
   new hrefList("slide0360.htm", 1, 11),
   new hrefList("slide0361.htm", 1, 12),
   new hrefList("slide0368.htm", 1, 13),
   new hrefList("slide0362.htm", 1, 14),
   new hrefList("slide0363.htm", 1, 15),
   new hrefList("slide0364.htm", 1, 16),
   new hrefList("slide0370.htm", 1, 17),
   new hrefList("slide0365.htm", 1, 18),
   new hrefList("slide0366.htm", 1, 19),
   new hrefList("slide0369.htm", 1, 20),
   new hrefList("slide0371.htm", 1, 21),
   new hrefList("slide0374.htm", 1, 22),
   new hrefList("slide0354.htm", 1, 23)
);
