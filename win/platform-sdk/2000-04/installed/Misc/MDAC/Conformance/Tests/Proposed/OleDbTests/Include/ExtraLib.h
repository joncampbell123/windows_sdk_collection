...
#define THREAD_ARG1 ((THREADARG*)pv)->pArg1
#define THREAD_ARG2 ((THREADARG*)pv)->pArg2
#define THREAD_ARG4 ((THREADARG*)pv)->pArg4
#define THREAD_ARG3 ((THREADARG*)pv)->pArg3
#define THREAD_ARG5 ((THREADARG*)pv)->pArg5
...
HRESULT GetStorageData(DBCOUNTITEM cBindings, DBBINDING* rgBindings, void* pData, void* pBuffer, DBLENGTH* pcBytes = NULL, REFIID riid = IID_IUnknown, IUnknown** ppIUnknown = NULL);
HRESULT GetStorageData(REFIID riid, IUnknown* pIUnknown, void* pBuffer, DBLENGTH* pcBytes = NULL);
...
BOOL FindValue(ULONG ulValue, ULONG cElements, ULONG* rgElements);
...
public:
	...
	virtual HRESULT GetStorageData(HROW hRow, HACCESSOR hAccessor, void* pBuffer = NULL, DBLENGTH* pcBytes = NULL, REFIID riid = IID_IUnknown, IUnknown** ppIUnknown = NULL);
...
public:
	...
	virtual HRESULT GetOrgStorageData(HROW hRow, HACCESSOR hAccessor, void* pBuffer = NULL, DBLENGTH* pcBytes = NULL, REFIID riid = IID_IUnknown, IUnknown** ppIUnknown = NULL);	
