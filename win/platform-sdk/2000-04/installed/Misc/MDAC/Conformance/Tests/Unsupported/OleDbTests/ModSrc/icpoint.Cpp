...
{	
	...
	if(bResult == TRUE)
	{
		...
		TEST_PROVIDER
			(
				SupportedInterface(IID_IRowsetNotify, ROWSET_INTERFACE) ||
...
public:
	//Constructors
	CRowsetSource(WCHAR* pwszTestCaseName = INVALID(WCHAR*));
...
CRowsetSource::CRowsetSource(WCHAR* pwszTestCaseName) 
	: CRowset((LPWSTR)pwszTestCaseName), CSource(IID_IRowsetNotify, ROWSET_INTERFACE)
{
}
...
ULONG CTestNotify::Thread_AdviseListener(LPVOID pv)
{
	...
	CListener* pCListener = new CListener(IID_IRowsetNotify);
	TESTC(pCListener!=NULL);
	pCListener->AddRef();
	...
	TESTC_(pICPC->FindConnectionPoint(IID_IRowsetNotify,&pICP),S_OK);
...
BOOL CTestNotify::VerifyConnectionPoints(ULONG cConnectionPoints, IConnectionPoint** rgpIConnectionPoints)
{
	...
	for(i=0; i<cConnectionPoints; i++)
	{
		...
		if(VerifyEqualInterface(rgpIConnectionPoints[i], pCSource(0)->GetCP(i)))
		{
			...
			if(iid != IID_IRowsetNotify && iid != IID_IDBAsynchNotify)
			{
...
BEG_TEST_CASE(TCFindConnectionPoint, CTestNotify, L"Test IConnectionPointInterface::FindConnectionPoint")
	TEST_VARIATION(1, 		L"General - verify reference count")
	TEST_VARIATION(2, 		L"General - verify correct IID returned")
...
//TCRowset
COPY_TEST_CASE(TCRowset_Advise,							TCAdvise)
COPY_TEST_CASE(TCRowset_Unadvise,						TCUnadvise)
COPY_TEST_CASE(TCRowset_GetConnectionInterface,			TCGetConnectionInterface)
COPY_TEST_CASE(TCRowset_GetConnectionPointContainer,	TCGetConnectionPointContainer)
COPY_TEST_CASE(TCRowset_EnumConnections,				TCEnumConnections)
COPY_TEST_CASE(TCRowset_EnumConnectionPoints,			TCEnumConnectionPoints)
COPY_TEST_CASE(TCRowset_FindConnectionPoint,			TCFindConnectionPoint)
COPY_TEST_CASE(TCRowset_NotReEntrant,					TCNotReEntrant)
COPY_TEST_CASE(TCRowset_Zombie,							TCZombie)
COPY_TEST_CASE(TCRowset_Properties,						TCProperties)
COPY_TEST_CASE(TCRowset_NotifyCanceled,					TCNotifyCanceled)
COPY_TEST_CASE(TCRowset_NotifyFailure,					TCNotifyFailure)
...
COPY_TEST_CASE(TCDataSource_NotReEntrant,				TCNotReEntrant)
COPY_TEST_CASE(TCDataSource_Zombie,						TCZombie)
COPY_TEST_CASE(TCDataSource_Properties,					TCProperties)
COPY_TEST_CASE(TCDataSource_NotifyCanceled,				TCNotifyCanceled)
COPY_TEST_CASE(TCDataSource_NotifyFailure,				TCNotifyFailure)
...
COPY_TEST_CASE(TCRow_NotReEntrant,						TCNotReEntrant)
COPY_TEST_CASE(TCRow_Zombie,							TCZombie)
COPY_TEST_CASE(TCRow_Properties,						TCProperties)
COPY_TEST_CASE(TCRow_NotifyCanceled,					TCNotifyCanceled)
COPY_TEST_CASE(TCRow_NotifyFailure,						TCNotifyFailure)
...
COPY_TEST_CASE(TCStream_NotReEntrant,					TCNotReEntrant)
COPY_TEST_CASE(TCStream_Zombie,							TCZombie)
COPY_TEST_CASE(TCStream_Properties,						TCProperties)
COPY_TEST_CASE(TCStream_NotifyCanceled,					TCNotifyCanceled)
COPY_TEST_CASE(TCStream_NotifyFailure,					TCNotifyFailure)
...
TEST_MODULE(48, ThisModule, gwszModuleDescrip)
	...
	TEST_CASE_WITH_PARAM(1,		TCRowset_Advise,							ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(2,		TCRowset_Unadvise,							ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(3,		TCRowset_GetConnectionInterface,			ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(4,		TCRowset_GetConnectionPointContainer,		ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(5,		TCRowset_EnumConnections,					ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(6,		TCRowset_EnumConnectionPoints,				ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(7,		TCRowset_FindConnectionPoint,				ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(8,		TCRowset_NotReEntrant,						ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(9,		TCRowset_Zombie,							ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(10,	TCRowset_Properties,						ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(11,	TCRowset_NotifyCanceled,					ROWSET_INTERFACE)
	TEST_CASE_WITH_PARAM(12,	TCRowset_NotifyFailure,						ROWSET_INTERFACE)

	//DataSource - IConnectionPoint
	TEST_CASE_WITH_PARAM(13,	TCDataSource_Advise,						DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(14,	TCDataSource_Unadvise,						DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(15,	TCDataSource_GetConnectionInterface,		DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(16,	TCDataSource_GetConnectionPointContainer,	DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(17,	TCDataSource_EnumConnections,				DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(18,	TCDataSource_EnumConnectionPoints,			DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(19,	TCDataSource_FindConnectionPoint,			DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(20,	TCDataSource_NotReEntrant,					DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(21,	TCDataSource_Zombie,						DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(22,	TCDataSource_Properties,					DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(23,	TCDataSource_NotifyCanceled,				DATASOURCE_INTERFACE)
	TEST_CASE_WITH_PARAM(24,	TCDataSource_NotifyFailure,					DATASOURCE_INTERFACE)

	//Row - IConnectionPoint
	TEST_CASE_WITH_PARAM(25,	TCRow_Advise,								ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(26,	TCRow_Unadvise,								ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(27,	TCRow_GetConnectionInterface,				ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(28,	TCRow_GetConnectionPointContainer,			ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(29,	TCRow_EnumConnections,						ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(30,	TCRow_EnumConnectionPoints,					ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(31,	TCRow_FindConnectionPoint,					ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(32,	TCRow_NotReEntrant,							ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(33,	TCRow_Zombie,								ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(34,	TCRow_Properties,							ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(35,	TCRow_NotifyCanceled,						ROW_INTERFACE)
	TEST_CASE_WITH_PARAM(36,	TCRow_NotifyFailure,						ROW_INTERFACE)

	//Stream - IConnectionPoint
	TEST_CASE_WITH_PARAM(37,	TCStream_Advise,							STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(38,	TCStream_Unadvise,							STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(39,	TCStream_GetConnectionInterface,			STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(40,	TCStream_GetConnectionPointContainer,		STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(41,	TCStream_EnumConnections,					STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(42,	TCStream_EnumConnectionPoints,				STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(43,	TCStream_FindConnectionPoint,				STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(44,	TCStream_NotReEntrant,						STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(45,	TCStream_Zombie,							STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(46,	TCStream_Properties,						STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(47,	TCStream_NotifyCanceled,					STREAM_INTERFACE)
	TEST_CASE_WITH_PARAM(48,	TCStream_NotifyFailure,						STREAM_INTERFACE)
END_TEST_MODULE()
#endif
...
int TCAdvise::Variation_5()
{
	...
	//Note: We do thie for loops in reverse order so we end up with interleaved advise's
...
int TCAdvise::Variation_10()
{
	...
	THREADARG T1Arg         = { pCSource(0)->pICPC() };
...
int TCAdvise::Variation_11()
{
	...
	//Setup Thread Arguments
	THREADARG T1Arg         = { pCSource(0)->pICPC() };
	THREADARG T2Arg         = { pCSource(1)->pICPC() };
	THREADARG T3Arg         = { pCSource(2)->pICPC() };
...
int TCAdvise::Variation_18()
{
	...
	//Create a new Rowset
	CRowsetSource* pSource = new CRowsetSource;
	TESTC_PROVIDER(pSource != NULL && pSource->CreateSource());
	
	//Create a new Listener (passing our created rowset)
	pCListener = new CListener(IID_IRowsetNotify);
	TESTC(pCListener!=NULL);
	pCListener->AddRef();

	//Now advise the Listener
	TESTC_(pCListener->Advise(&dwCookie, pSource->pIRowset(), IID_IRowsetNotify),S_OK);
	TESTC(dwCookie != 0);

	//Now Release the Rowset
	SAFE_DELETE(pSource);

	//Should have received ROWSET_RELEASE notification since the Rowset went away...
...
int TCGetConnectionInterface::Variation_3()
{
	...
	for(i=0; i<3; i++) 
	{
		...
		//Test returned pICP with our CP, (which is a IRowsetNotifyCP)
...
// {{ TCW_VAR_PROTOTYPE(2)
//*-----------------------------------------------------------------------
// @mfunc General - verify correct IID returned
//
// @rdesc TEST_PASS or TEST_FAIL
//
...
int TCFindConnectionPoint::Variation_6()
{
	...
	const IID* ValidCP[]	= { &pCSource(0)->GetIID(), 
								NULL };

	const IID* InValidCP[]	= { &IID_IConnectionPoint, 
	...
	//TEST_ valid IID's
	for(ULONG i=0; ValidCP[i]; i++)
	{
		//verify valid IID
		TESTC_(pCSource(0)->pICPC()->FindConnectionPoint(*ValidCP[i],&pICP),S_OK);
	...
	//TEST_ Invalid IID's
	for(i=0; InValidCP[i]; i++)
	{
		//verify Invalid IID
		TESTC_(pCSource(0)->pICPC()->FindConnectionPoint(*InValidCP[i],&pICP),CONNECT_E_NOCONNECTION);
		TESTC(pICP == NULL);
	}	
