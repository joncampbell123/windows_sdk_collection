...
int TCGetOriginalRows::Variation_1()
{
	...
	ReadOnlyRowset.SetProperty(DBPROP_CANHOLDROWS);
...
int TCGetOriginalRows::Variation_27()
{
	...
	if(hr == S_OK)
	{
		...
		TESTC_(RowsetA.pIRowset()->GetData(hRow,RowsetA.m_hAccessor,pData),S_OK);
...
int TCGetOriginalRows::Variation_41()
{
	...
	TESTC_(GetAccessorAndBindings(RowsetA.pICommand(),DBACCESSOR_PARAMETERDATA,&hAccessor,
		NULL,NULL,NULL,DBPART_ALL,ALL_COLS_BOUND,FORWARD,
		NO_COLS_BY_REF,NULL,NULL,NULL,DBTYPE_EMPTY,0,NULL,NULL,
		NO_COLS_OWNED_BY_PROV, DBPARAMIO_INPUT), S_OK);
...
{
	ULONG cRowsUndone  = 1;  //should be 0 on error
...
int TCUpdate::Variation_19()
{
	...
	ULONG     cRowSize = 0;
	ULONG     cAllBindings = 0;
	ULONG     cUpdBindings = 0;
	HRESULT   hr = S_OK;
...
int TCUpdate::Variation_54()
{
	...
	ULONG ulMaxPendingRows = 0;
	ULONG i, ulMaxOpenRows = 0;
