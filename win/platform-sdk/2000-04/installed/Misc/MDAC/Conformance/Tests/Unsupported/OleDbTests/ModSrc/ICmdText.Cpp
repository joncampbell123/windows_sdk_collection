...
BOOL CCmdText::GetICommandText()
{
	...
	// Make surethe pointer is not NULL
...
int GetCmdText::Variation_1()
{
	...
	COMPARE(m_GetguidDialect, m_DBGUID_DEFAULT);
...
int GetCmdText::Variation_6()
{
	...
	LONG			cRowsAffected		= 0;	// count of rowsets
...
int GetCmdText::Variation_7()
{
	...
	{
		// Get Command Text
		TESTC_(m_pTable->CreateSQLStmt(grgSQLStmt[index], 
					pCTable2->GetTableName(), &m_pSQLSet, NULL, NULL), S_OK);
		TESTC(GetICommandText());
...
int GetCmdText::Variation_10()
{
	...
	// Create a SQL Stmt and Set the Command
	TESTC_(m_pTable->Insert(0,PRIMARY,FALSE, &m_pSQLSet),S_OK);
	TESTC(GetICommandText());
...
int GetCmdText::Variation_16()
{
	...
	// Create a SQL Stmt and Set the Command
	TESTC_(m_pTable->CreateSQLStmt(SELECT_LEFTOUTERJOIN,pCTable2->GetTableName(), &m_pSQLSet, NULL, NULL), S_OK);
