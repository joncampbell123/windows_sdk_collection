...
#ifdef INTERNAL_ONLY 
#include "PoolingHooks.h"	//Pooling Hooks
#endif //INTERNAL_ONLY
...
public:
	...
	virtual BOOL  GetStringKeywordValue(WCHAR* pwszString, WCHAR* pwszKeyword, WCHAR** ppwszValue);
	...
	virtual WCHAR* FindStringValue(WCHAR* pwszString, WCHAR* pwszKeyword);
