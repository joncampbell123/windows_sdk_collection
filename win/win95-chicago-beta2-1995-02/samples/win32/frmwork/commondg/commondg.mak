...
!MESSAGE 
!MESSAGE NMAKE /f "COMMONDG.MAK" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/COMMONDG.exe $(OUTDIR)/COMMONDG.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"COMMONDG.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"COMMONDG.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"COMMONDG.bsc" 
BSC32_SBRS= \
	$(INTDIR)/COMMONDG.SBR \
	$(INTDIR)/MISC.SBR \
	$(INTDIR)/FINDDLG.SBR \
...
$(OUTDIR)/COMMONDG.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /INCREMENTAL:no /PDB:$(OUTDIR)/"COMMONDG.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"COMMONDG.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/COMMONDG.OBJ \
	$(INTDIR)/MISC.OBJ \
...
$(OUTDIR)/COMMONDG.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"COMMONDG.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"COMMONDG.pdb" /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"COMMONDG.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"COMMONDG.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib version.lib /NOLOGO\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"COMMONDG.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"COMMONDG.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/COMMONDG.OBJ \
...
$(INTDIR)/COMMONDG.OBJ :  $(SOURCE)  $(DEP_COMMO) $(INTDIR)
...
$(INTDIR)/COMMONDG.res :  $(SOURCE)  $(DEP_COMMON) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/PRINTDLG.OBJ :  $(SOURCE)  $(DEP_PRINT) $(INTDIR)
...
$(INTDIR)/OPTDLG.OBJ :  $(SOURCE)  $(DEP_OPTDL) $(INTDIR)
