...
#define MAX_QUALITY 999999999
#define MIN_QUALITY 3
...
int BoardInBook(BOARD b, int t, int p1, int p2, int k1, int k2);
void WriteBookFile(int x);
void ReadBookFile(int x);
