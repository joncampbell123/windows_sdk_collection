...
!ifndef LIBNAME
!error LIBNAME is not defined. LIBNAME=MFC40 builds the prebuilt DLL.
!endif
...
TARG_STATIC=MFCS40$(PF)$(TARGTYPE)
...
!ifndef MACOS
LFLAGS=$(LFLAGS) /version:4.1 /base:0x5F800000
LIBS=$(CRTDLL) kernel32.lib gdi32.lib user32.lib uuid.lib uuid2.lib $(PROFLIB)
!else
!if "$(BASE)" == "M68K"
