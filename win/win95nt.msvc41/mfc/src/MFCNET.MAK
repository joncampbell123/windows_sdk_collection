...
!ifndef LIBNAME
!error LIBNAME is not defined. LIBNAME=MFCN40 builds the prebuilt DLL.
!endif
...
LFLAGS=$(LFLAGS) /dll /version:4.1 /base:0x5FB00000
