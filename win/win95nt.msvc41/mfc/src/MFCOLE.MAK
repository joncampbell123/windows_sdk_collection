...
!ifndef LIBNAME
!error LIBNAME is not defined. LIBNAME=MFCO40 builds the prebuilt DLL.
!endif
...
!ifndef MACOS
LFLAGS=$(LFLAGS) /version:4.1 /base:0x5FA00000
LIBS=$(MFCDLL) $(CRTDLL) kernel32.lib gdi32.lib user32.lib uuid.lib uuid2.lib
!else
...
$D\$(TARG).rsc: mfcdll.r
!if "$(DEBUG)" == "0"
	mrc /DARCHITECTURE=$(MACOS_ARCH) /DLIBNAME=\"MicrosoftMFCO40Lib\" \
		/DCURRENTVER=0x04008000 /DOLDDEFVER=0x04008000 \
		/DJDATE=$(JULIAN) -DJDATESTR=\"$(JULIAN)\" /o $D\$(TARG).rsc mfcdll.r
!else
	mrc /DARCHITECTURE=$(MACOS_ARCH) /DLIBNAME=\"MicrosoftMFCO40DLib\" \
		/DCURRENTVER=0x04008000 /DOLDDEFVER=0x04008000 \
		/DJDATE=$(JULIAN) -DJDATESTR=\"$(JULIAN)\" /o $D\$(TARG).rsc mfcdll.r
!endif
