...
:install
        ...
        xcopy prodline                  %_tgt%\hct\prodline\ /S

        xcopy doc                       %_tgt%\hct\doc\ /S

        xcopy tests\disk\%_cpu%         %_tgt%\hct\tests\disk\ /S 
	...
	xcopy tests\disk\288		%_tgt%\hct\tests\disk\288\ /S
        ...
        xcopy tests\kbd\%_cpu%          %_tgt%\hct\tests\kbd\ /S 
        copy tests\kbd\*.*              %_tgt%\hct\tests\kbd

        xcopy tests\memory\%_cpu%       %_tgt%\hct\tests\memory\ /S
        copy tests\memory\*.*           %_tgt%\hct\tests\memory

        xcopy tests\mm\%_cpu%           %_tgt%\hct\tests\mm\ /S 
        copy tests\mm\*.*               %_tgt%\hct\tests\mm

        xcopy tests\mouse\%_cpu%        %_tgt%\hct\tests\mouse\ /S
        copy tests\mouse\*.*            %_tgt%\hct\tests\mouse

        xcopy tests\mvdm                %_tgt%\hct\tests\mvdm\ /S
...
rem copy tests\net\*.*              %_tgt%\hct\tests\net
        ...
        xcopy tests\ports\%_cpu%        %_tgt%\hct\tests\ports\ /S
        copy tests\ports\*.*            %_tgt%\hct\tests\ports

        xcopy tests\sound\%_cpu%        %_tgt%\hct\tests\sound\ /S
        copy tests\sound\*.*            %_tgt%\hct\tests\sound

        xcopy tests\stress\%_cpu%       %_tgt%\hct\tests\stress\ /S
        copy tests\stress\*.*           %_tgt%\hct\tests\stress

rem        xcopy tests\tape\%_cpu%         %_tgt%\hct\tests\tape\ /S
...
:storage
	...
	xcopy tests\disk\288		%_tgt%\hct\tests\disk\288\ /S
        ...
        xcopy tests\cdrom\%_cpu%        %_tgt%\hct\tests\cdrom\%_cpu%\ /S
        copy tests\cdrom\*.*            %_tgt%\hct\tests\cdrom
	...
	copy tests\scanner\*.*		%_tgt%\hct\tests\scanner
        ...
        xcopy tests\tape\%_cpu%         %_tgt%\hct\tests\tape\ /S
...
:usage
	...
	echo                tr      (Token Ring Media)
        ...
        echo.
        echo       By default, all tests except NDIS, Printer, ARCTest 
        echo       and Tape tests are installed.
        echo.
        echo.
        echo Requirements:
        echo.
