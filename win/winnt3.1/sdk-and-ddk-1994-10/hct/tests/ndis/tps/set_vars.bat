...
rem
rem example: set TP_TEST_CARD=TestCard02
rem
set TP_TEST_CARD=
...
rem
rem example: set TP_TRUSTED_CARD=TrustedCard01
rem
set TP_TRUSTED_CARD=DRIVER_NAME
...
rem
set TP_MULTICAST_ADDRESS=
set TP_MULTICAST_ADDRESS2=
...
rem
set TP_FUNCTIONAL_ADDRESS=
set TP_FUNCTIONAL_ADDRESS2=
...
rem
set TP_RANDOM_ADDRESS=02-02-04-04-06-06
