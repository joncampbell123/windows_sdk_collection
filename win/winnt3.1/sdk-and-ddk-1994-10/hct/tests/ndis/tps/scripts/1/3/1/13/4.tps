#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Functional, Receive Promiscuous & Resend Directed" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.3.1.13.4 Send Functional, Receive Promiscuous & Resend
