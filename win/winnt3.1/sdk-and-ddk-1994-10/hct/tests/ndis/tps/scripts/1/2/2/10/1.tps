#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Resend Directed" )
##
## TITLE: 1.2.2.10.1 Send Directed, Receive Directed & Resend
...
## set to receive DIRECTED packets.  Each packet will contain a
## resend packet the test card will resend.  Packets of size
...
# Now set the two instances of the test cards to receive packets.
