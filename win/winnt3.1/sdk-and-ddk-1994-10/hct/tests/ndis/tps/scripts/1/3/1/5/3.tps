#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Functional, Receive Promiscuous" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.3.1.5.3 Send Functional, Receive Promiscuous (1M/2C/1O)
##
...
## set to receive PROMISCUOUS packets.  Packets of size 40 bytes,
