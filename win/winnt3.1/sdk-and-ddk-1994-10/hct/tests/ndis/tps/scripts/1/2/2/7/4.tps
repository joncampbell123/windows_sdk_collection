#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Broadcast, Receive Directed & Source Routing" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.2.2.6.4 Send Broadcast, Receive Directed & Source Routing (1M/1C/2O)
##
