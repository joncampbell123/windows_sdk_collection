#	-SECTION_START-( 7.00 ) -SECTION_DESC-( "Send Multicast, Receive Multicast & Directed & Broadcast & Resend Directed" )
##
## TITLE: 1.3.1.16.7 Send Multicast, Receive Multicast & Directed &
