#   -SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Functional, Receive Promiscuous & Resend Broadcast" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.13.5 Send Functional, Receive Promiscuous & Resend
