#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Multicast-server-side" )
##
## TITLE: 2.1.1.6.6 Send Broadcast, Receive Broadcast & Multicast
