#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Multicast, Receive Broadcast & Multicast & Resend Multicast-server-side" )
##
## TITLE: 2.1.1.15.6 Send Multicast, Receive Broadcast & Multicast & Resend
