#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Functional, Receive Directed & Functional & Resend Directed-client-side" )
##
## TITLE: 2.1.1.16.1 Send Functional, Receive Directed & Functional & Resend
