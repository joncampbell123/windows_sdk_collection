#	-SECTION_START-( 2.00 ) -SECTION_DESC-( "Send Functional, Receive Broadcast-server-side" )
##
## TITLE: 2.1.1.4.2 Send Functional, Receive Broadcast (2M/1C/1O) server-side
##
