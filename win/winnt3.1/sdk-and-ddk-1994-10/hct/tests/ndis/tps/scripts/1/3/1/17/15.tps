#	-SECTION_START-( 15.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Directed & Broadcast & Resend Functional" )
##
## TITLE: 1.3.1.17.15 Send Functional, Receive Functional & Directed &
## TITLE:             Broadcast & Resend Functional (1M/2C/1O)
##
...
## set to receive FUNCTIONAL & DIRECTED & BROADCAST packets.  Each
...
SetPacketFilter                                 +
    OpenInstance=2                              +
    PacketFilter=FUNCTIONAL|DIRECTED|BROADCAST
#	-SECTION_END-( 15.07 )
