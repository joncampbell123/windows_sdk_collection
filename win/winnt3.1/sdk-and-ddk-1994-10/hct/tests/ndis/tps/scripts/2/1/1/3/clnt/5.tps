#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Multicast, Receive All Multicast-client-side" ) -OPTIONALS-( ALLMULTICAST )
##
## TITLE: 2.1.1.3.5 Send Multicast, Receive All Multicast (2M/1C/1O)
## TITLE:           client-side
##
...
## have its packetfilter set to receive ALLMULTICAST packets.  Packets
