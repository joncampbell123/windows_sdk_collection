#   -SECTION_START-( 12.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Mac Frame & Resend Functional" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 1.2.2.14.16 Send Directed, Receive Directed & Mac Frame
...
## set to receive DIRECTED MACFRAME packets.  Each packet will contain
