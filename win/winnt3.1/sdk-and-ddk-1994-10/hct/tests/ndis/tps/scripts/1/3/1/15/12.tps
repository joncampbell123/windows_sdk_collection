#	-SECTION_START-( 8.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Source Routing & Resend Broadcast" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.3.1.15.12 Send Broadcast, Receive Broadcast & Source Routing
