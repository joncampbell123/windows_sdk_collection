#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Directed, Receive All Functional-server-side" ) -OPTIONALS-( ALLFUNCTIONAL )
##
## TITLE: 2.1.1.1.7 Send Directed, Receive All Functional (2M/1C/1O)
## TITLE:           server-side
##
