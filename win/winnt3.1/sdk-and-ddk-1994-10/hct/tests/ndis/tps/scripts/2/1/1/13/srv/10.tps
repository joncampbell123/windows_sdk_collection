#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Functional & Resend Functional-server-side" )
##
## TITLE: 2.1.1.13.10 Send Directed, Receive Directed & Functional & Resend
