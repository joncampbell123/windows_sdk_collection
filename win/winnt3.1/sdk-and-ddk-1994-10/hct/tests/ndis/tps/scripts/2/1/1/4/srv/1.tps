#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Functional, Receive Directed-server-side" )
##
## TITLE: 2.1.1.4.1 Send Functional, Receive Directed (2M/1C/1O) server-side
##
...
## have its packetfilter set to receive DIRECTED packets.  Packets
