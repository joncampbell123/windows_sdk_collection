#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Multicast, Receive Broadcast & Multicast & Resend Broadcast-server-side" )
##
## TITLE: 2.1.1.15.5 Send Multicast, Receive Broadcast & Multicast & Resend
