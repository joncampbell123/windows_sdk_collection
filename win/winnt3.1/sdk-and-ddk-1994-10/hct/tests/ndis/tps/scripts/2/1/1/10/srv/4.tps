#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Resend Functional-server-side" )
##
## TITLE: 2.1.1.10.4 Send Broadcast, Receive Broadcast & Resend
