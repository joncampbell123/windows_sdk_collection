#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Functional & Resend Directed" )
##
## TITLE: 1.3.1.15.8 Send Broadcast, Receive Broadcast & Functional
