#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Resend Directed-server-side" )
##
## TITLE: 2.1.1.12.1 Send Functional, Receive Functional & Resend
