#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Functional & Resend Functional-server-side"  )
##
## TITLE: 2.1.1.13.4 Send Directed, Receive Directed & Broadcast & Resend
