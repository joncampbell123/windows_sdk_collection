#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Broadcast, Receive All Functional-server-side" ) -OPTIONALS-( ALLFUNCTIONAL )
##
## TITLE: 2.1.1.2.7 Send Broadcast, Receive All Functional (2M/1C/1O)
## TITLE:           server-side
##
