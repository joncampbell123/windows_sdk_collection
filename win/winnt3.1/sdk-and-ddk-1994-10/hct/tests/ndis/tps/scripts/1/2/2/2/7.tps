#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Directed, Receive All Functional" ) -OPTIONALS-( ALLFUNCTIONAL )
##
## TITLE: 1.2.2.2.7 Send Directed, Receive All Functional (1M/1C/2O)
##
