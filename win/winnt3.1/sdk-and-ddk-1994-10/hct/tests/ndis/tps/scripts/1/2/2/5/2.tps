#	-SECTION_START-( 2.00 ) -SECTION_DESC-( "Send Functional, Receive Broadcast" )
##
## TITLE: 1.2.2.5.2 Send Functional, Receive Broadcast (1M/1C/2O)
##
...
## set to receive BROADCAST packets.  Packets of size 40 bytes,
