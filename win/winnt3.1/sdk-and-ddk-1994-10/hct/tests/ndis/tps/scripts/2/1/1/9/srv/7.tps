#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Directed, Receive Promiscuous & Resend Multicast-server-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.9.7 Send Directed, Receive Promiscuous & Resend
