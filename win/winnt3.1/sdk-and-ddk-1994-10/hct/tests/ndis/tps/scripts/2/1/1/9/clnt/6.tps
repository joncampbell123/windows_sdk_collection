#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Directed, Receive Promiscuous & Resend Broadcast-client-side" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 2.1.1.9.6 Send Directed, Receive Promiscuous & Resend
