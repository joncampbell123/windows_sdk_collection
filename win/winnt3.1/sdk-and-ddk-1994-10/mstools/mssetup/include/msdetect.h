...
extern LONG  APIENTRY LcbTotalDrive(int nDrive);
extern LONG  APIENTRY LcbFreeDrive(int nDrive);
extern LONG  APIENTRY LcbGetSizeOfFile(LPSTR szFile);
...
extern LONG  GetTotalSpaceForDrive(LPSTR szDrive);
extern LONG  GetFreeSpaceForDrive(LPSTR szDrive);
extern BOOL  DoesFileExist(LPSTR szFile, int mode);
extern LONG  GetSizeOfFile(LPSTR szFile);
