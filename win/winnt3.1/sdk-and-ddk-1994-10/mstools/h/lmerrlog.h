...
#define NELOG_NetlogonPasswdSetFailed (ERRLOG_BASE + 124)
    /*
    * An error occurred while changing this computer's password.
    */
...
#define NELOG_NetlogonSSIInitError              (ERRLOG2_BASE + 0)
     ...
     * structures successfully. The service is terminated.
     */
...
#define NELOG_NetlogonFailedToRegisterSC        (ERRLOG2_BASE + 4)
     ...
     * service controller. The service is terminated.
     */
...
#define NELOG_NetlogonFaliedToCreateShare       (ERRLOG2_BASE + 6)
    /*
     * The Netlogon service could not create server share %1.
     */
...
#define NELOG_NetlogonFullSyncCallFailed        (ERRLOG2_BASE + 14)
    /*
     * The full synchronization request from the server %1 failed.
     */
...
#define NELOG_NetlogonAuthNoDomainController    (ERRLOG2_BASE + 19)
    /*
     *  No Windows NT Advanced Server for the domain %1 is available.
     */
