...
void static TLDrawBeginEnd (HDC hDC,
   ...
   SystemTimeTimeString (&(pTLine->SystemTimeBegin), szTime) ;
   ...
   SystemTimeTimeString (&(pTLine->SystemTimeEnd), szTime) ;
...
*/
   ...
   SystemTimeTimeString (&SystemTimeStart, szTime) ;
   ...
   SystemTimeTimeString (&SystemTimeStop, szTime) ;
