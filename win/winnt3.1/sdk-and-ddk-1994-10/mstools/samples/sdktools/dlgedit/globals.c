...
static SUBLANGTABLE aslSerboCroatian[] = {
    { SUBLANG_NEUTRAL,      IDS_SUBLANG_NEUTRAL,        IDS_SL_NEUTRAL      },
    { SUBLANG_SERBO_CROATIAN_CYRILLIC, IDS_SUBLANG_SERBO_CROATIAN_CYRILLIC, IDS_SL_SERBO_CROATIAN_CYRILLIC },
    { SUBLANG_SERBO_CROATIAN_LATIN, IDS_SUBLANG_SERBO_CROATIAN_LATIN, IDS_SL_SERBO_CROATIAN_LATIN }
};
...
LANGTABLE gaLangTable[] = {
    ...
    { LANG_ALBANIAN,        IDS_LANG_ALBANIAN,          IDS_L_ALBANIAN,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_ARABIC,          IDS_LANG_ARABIC,            IDS_L_ARABIC,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_BAHASA,          IDS_LANG_BAHASA,            IDS_L_BAHASA,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_BULGARIAN,       IDS_LANG_BULGARIAN,         IDS_L_BULGARIAN,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_CATALAN,         IDS_LANG_CATALAN,           IDS_L_CATALAN,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    ...
    { LANG_GREEK,           IDS_LANG_GREEK,             IDS_L_GREEK,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_HEBREW,          IDS_LANG_HEBREW,            IDS_L_HEBREW,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    ...
    { LANG_RHAETO_ROMAN,    IDS_LANG_RHAETO_ROMAN,      IDS_L_RHAETO_ROMAN,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_ROMANIAN,        IDS_LANG_ROMANIAN,          IDS_L_ROMANIAN,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_RUSSIAN,         IDS_LANG_RUSSIAN,           IDS_L_RUSSIAN,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_SERBO_CROATIAN,  IDS_LANG_SERBO_CROATIAN,    IDS_L_SERBO_CROATIAN,
        sizeof(aslSerboCroatian) / sizeof(SUBLANGTABLE), aslSerboCroatian },
    ...
    { LANG_SWEDISH,         IDS_LANG_SWEDISH,           IDS_L_SWEDISH,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_THAI,            IDS_LANG_THAI,              IDS_L_THAI,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_TURKISH,         IDS_LANG_TURKISH,           IDS_L_TURKISH,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral },
    { LANG_URDU,            IDS_LANG_URDU,              IDS_L_URDU,
        sizeof(aslNeutral) / sizeof(SUBLANGTABLE), aslNeutral }
};
