...
\******************************************************************************/
 ...
 typedef struct GLOBAL_STRUCT {
   ...
   HICON     hIconCurrent;       // handle to the current animated icon
   UINT      idIconTimer;        // timer id for animated icons
   HWND      hDlgAbout;          // handle to the About dialog box
   BOOL      fAboutBox;          // boolean indicating if the About box is
                                 //  active
