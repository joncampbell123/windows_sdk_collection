...
{{ MAKELANGID (LANG_NEUTRAL       , SUBLANG_NEUTRAL)                , TEXT("NEUTRAL                ")},
 { MAKELANGID (LANG_ALBANIAN      , SUBLANG_NEUTRAL)                , TEXT("ALBANIAN               ")},
 { MAKELANGID (LANG_ARABIC        , SUBLANG_NEUTRAL)                , TEXT("ARABIC                 ")},
 { MAKELANGID (LANG_BAHASA        , SUBLANG_NEUTRAL)                , TEXT("BAHASA                 ")},
 { MAKELANGID (LANG_BULGARIAN     , SUBLANG_NEUTRAL)                , TEXT("BULGARIAN              ")},
 { MAKELANGID (LANG_CATALAN       , SUBLANG_NEUTRAL)                , TEXT("CATALAN                ")},
 ...
 { MAKELANGID (LANG_HEBREW        , SUBLANG_NEUTRAL)                , TEXT("HEBREW                 ")},
 ...
 { MAKELANGID (LANG_RHAETO_ROMAN  , SUBLANG_NEUTRAL)                , TEXT("RHAETO_ROMAN           ")},
 { MAKELANGID (LANG_ROMANIAN      , SUBLANG_NEUTRAL)                , TEXT("ROMANIAN               ")},
 { MAKELANGID (LANG_RUSSIAN       , SUBLANG_NEUTRAL)                , TEXT("RUSSIAN                ")},
 { MAKELANGID (LANG_SERBO_CROATIAN, SUBLANG_SERBO_CROATIAN_CYRILLIC), TEXT("SERBO_CROATIAN,CYRILLIC")},
 { MAKELANGID (LANG_SERBO_CROATIAN, SUBLANG_SERBO_CROATIAN_LATIN   ), TEXT("SERBO_CROATIAN,LATIN   ")},
 ...
 { MAKELANGID (LANG_THAI          , SUBLANG_NEUTRAL)                , TEXT("THAI                   ")},
 { MAKELANGID (LANG_TURKISH       , SUBLANG_NEUTRAL)                , TEXT("TURKISH                ")},
 { MAKELANGID (LANG_URDU          , SUBLANG_NEUTRAL)                , TEXT("URDU                   ")}};
