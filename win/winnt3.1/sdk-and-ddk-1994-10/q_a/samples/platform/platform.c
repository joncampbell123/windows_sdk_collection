    ...
    switch (message) {
        ...
        case WM_COMMAND:           /* message: command from application menu */
            if (LOWORD(wParam) == IDM_ABOUT) {
                ...
                version = GetVersion();
                wsprintf( buf, "The version of Windows you're running is %d.%d",
...
BOOL FAR PASCAL About(HWND hDlg,       /* window handle of the dialog box */
                      UINT message,    /* type of message                 */
