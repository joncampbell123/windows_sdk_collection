...
//
#define STATUS_WAS_LOCKED                ((NTSTATUS)0x80000008L)
...
//
#define STATUS_WAS_UNLOCKED              ((NTSTATUS)0x80000009L)
...
//
// MessageId: STATUS_HANDLE_NOT_WAITABLE
//
// MessageText:
//
//  NtWait??? called with a handle to an object that was not a waitable
//  object (i.e. the Object Type Descriptor does not specify a dispatcher
//  object offset).
//
#define STATUS_HANDLE_NOT_WAITABLE       ((NTSTATUS)0xC0000036L)
...
// MessageText:
//
//  The SAM database on a Windows NT Advanced Server is
...
// MessageText:
//
//  A Windows NT Advance Server has incorrect configuration.
//
...
//  with a status of 0x%08x.  The system has been shutdown.
//
