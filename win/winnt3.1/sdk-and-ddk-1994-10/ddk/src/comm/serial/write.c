...

{
    ...
    do {
        ...
        if (Extension->CurrentXoffIrp) {
            ...
            InsertHeadList(
                &Extension->WriteQueue,
                &Extension->CurrentWriteIrp->Tail.Overlay.ListEntry
                );
            ...
            if (SERIAL_REFERENCE_COUNT(Extension->CurrentXoffIrp)) {
                ...
                SERIAL_INC_REFERENCE(Extension->CurrentXoffIrp);
        ...
        if (Extension->CurrentWriteIrp->Cancel) {
            ...
            SERIAL_INC_REFERENCE(Extension->CurrentWriteIrp);
...

{
    ...
    if (Extension->WriteLength) {
        ...
        SERIAL_DEC_REFERENCE(Extension->CurrentWriteIrp);
...

{
    ...
    if (Extension->CountSinceXoff) {
        ...
        SERIAL_DEC_REFERENCE(Extension->CurrentXoffIrp);
