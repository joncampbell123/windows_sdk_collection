...
//
// Defines for HITATCHI 1750s
//

#define HITATCHI_READ_TOC_CODE              0xE8
#define HITATCHI_EJECT_CODE                 0xE4
#define HITATCHI_PLAY_AUDIO_MSF_CODE        0xE0
#define HITATCHI_PAUSE_AUDIO_CODE           0xE1
#define HITATCHI_READ_SUB_Q_CHANNEL_CODE    0xE5

//
// 12 byte cdbs for Hitatchi
//
