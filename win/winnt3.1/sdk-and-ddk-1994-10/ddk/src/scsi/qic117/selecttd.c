...
Return Value:
    ...
    NoErr, any Driver error except BadBlk, <EndOfVol>, RdncUnsc (because
    the bad block map is skipped over.
...

{
    ...
    if (Context->tapedir) {
        ...
        Context->CurrentOperation.SegmentPointer = Context->tapedir->Data;
