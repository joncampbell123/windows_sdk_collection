...
Language=English
Format of tape is unknown.  You must format this tape before it can be used.
From device: %1
.

MessageId=0x007d Facility=Q117 Severity=Error SymbolicName=QIC117_CMDFLT
Language=English
Command read-after-write error.
From device: %1
.
...
Language=English
QIC40 formatted tape is detected in an Eagle.
From device: %1
.

MessageId=0x008f Facility=Q117 Severity=Informational SymbolicName=QIC117_QIC80INEAGLE
Language=English
QIC80 formatted tape is detected in an Eagle.
From device: %1
.
...
MessageId=0x0094 Facility=Q117 Severity=Error SymbolicName=QIC117_BOGUS       
Language=English
Bogus error value returned from device %1
.
