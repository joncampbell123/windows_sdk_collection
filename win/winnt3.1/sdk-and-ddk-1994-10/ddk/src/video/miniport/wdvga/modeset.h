...
Abstract:
    ...
    This module contains all the global data used by the Western Digital
    90Cxx driver.
...
#define NUM_VIDEO_MODES 18	//should be changed to support 256-color drivers
#else
#define NUM_VIDEO_MODES 10
#endif
...

{
  ...
  0, 0,              // set to 0 frequency, non-interlaced mode.
...

{
  ...
  640, 480, 80, 0x10000, 0, 0, NoBanking, MemMap_VGA,
  FALSE,
#ifdef INT10_MODE_SET
  0xFF, 0x00,
  0x12,
...
{ VIDEO_MODE_COLOR+VIDEO_MODE_GRAPHICS, 1, 8, 80, 30,
  640, 480, 1024, 0x80000, 0, 0, NormalBanking, MemMap_VGA,
  FALSE,
  0xFF, 0x00,
  0x5f,
