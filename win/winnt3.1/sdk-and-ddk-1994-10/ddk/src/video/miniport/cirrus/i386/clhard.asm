...
;---------------------------------------------------------------------------
; two versions of banking code are given here, one for 1RW 64k bank, and
; one for 2 32K RW banks. We will check out both implementations and see
