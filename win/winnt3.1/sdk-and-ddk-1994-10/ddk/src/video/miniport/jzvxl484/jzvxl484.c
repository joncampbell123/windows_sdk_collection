...

{
    ...
    PJAZZ_Vxl_CONFIGURATION_DATA VxlConfigData = ConfigurationData;
    ...
    case VpControllerData:
        ...
        VxlConfigData = (PJAZZ_Vxl_CONFIGURATION_DATA)(((PUCHAR)VxlConfigData) + 8);
...

{
    ...
    case IOCTL_VIDEO_SET_CURRENT_MODE:
        ...
        if (*(ULONG *)(RequestPacket->InputBuffer) >= JAG_MAX_MODE) {
...

{
    ...
    case 24:
        ...
        ((PBT484_COMMAND1)(&CmdReg1))->TrueColorBypass = 0;
        break;
