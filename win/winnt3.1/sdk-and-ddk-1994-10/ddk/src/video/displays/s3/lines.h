...
VOID vssSolidHorizontal(PPDEV ppdev, STRIP *pStrip, LINESTATE *pLineState);
VOID vrlSolidHorizontal(PPDEV ppdev, STRIP *pStrip, LINESTATE *pLineState);

VOID vssSolidVertical(PPDEV ppdev, STRIP *pStrip, LINESTATE *pLineState);
VOID vrlSolidVertical(PPDEV ppdev, STRIP *pStrip, LINESTATE *pLineState);

VOID vssSolidDiagonalHorizontal(PPDEV ppdev, STRIP *pStrip, LINESTATE *pLineState);
VOID vrlSolidDiagonalHorizontal(PPDEV ppdev, STRIP *pStrip, LINESTATE *pLineState);

VOID vssSolidDiagonalVertical(PPDEV ppdev, STRIP *pStrip, LINESTATE *pLineState);
...
#ifdef __CPLUSPLUS
extern "C"
BOOL bLines(PPDEV, POINTFIX*, POINTFIX*, RUN* prun, ULONG,
...
VOID vFastLine(PPDEV, PATHOBJ*, RECTL*, PFNSTRIP*, LONG);
