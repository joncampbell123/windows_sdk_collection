...
\***********************************************************************/
        ...
        // No overflow since large integer math is used
            ...
            ASSERTS3((LONG) y0 >= 0, "y0 weird: Goofed up end pel calc?");
        }
...
\***********************************************************************/
        ...
        // top edges:
            ...
            ASSERTS3(x0 <= x1, "Improper rectangle clip");
        }
#endif // SIMPLE_CLIP
...
#endif // MASKSTYLED
                {
                    ASSERTS3(fl & FL_ARBITRARYSTYLED, "Oops");
    ...
    // go in the very first strip:

        {
            ...
            else
            {
                ...
                ASSERTS3(dI > 0, "Weird dI");
            }

            ASSERTS3(i > 0 && i <= 0x7fffffff, "Weird initial strip length");
            ASSERTS3(cPels > 0, "Zero pel line");
