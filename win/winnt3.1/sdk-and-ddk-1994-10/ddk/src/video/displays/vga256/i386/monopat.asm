...
; Variables used in block drawers:
        ...
        local cUnrolledLoops:      dword ;number of unrolled loops to do
        local pfnUnroll:           ptr   ;points to start point in unroll table
...
;
; For brush alignment, we would want to rotate 01234567 right by 'cl'.
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,ecx,pfnMonoWide11,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide11,W11,LOOP_UNROLL_COUNT

MONO_WIDE_11_W_M macro ENTRY_LABEL,ENTRY_INDEX
...
;  ESP = pointer to start of pattern
        ...
        align   4
dual_wide_11_w_loop:
        UNROLL_LOOP     MONO_WIDE_11_W_M,W11,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,ecx,pfnMonoWide10,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide10,W10,LOOP_UNROLL_COUNT

MONO_WIDE_10_W_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  ESP = pointer to start of pattern
        ...
        align   4
dual_wide_10_w_loop:
        UNROLL_LOOP     MONO_WIDE_10_W_M,W10,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,ecx,pfnMonoWide01,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide01,W01,LOOP_UNROLL_COUNT

MONO_WIDE_01_W_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  ESP = pointer to start of pattern
        ...
        align   4
dual_wide_01_w_loop:
        UNROLL_LOOP     MONO_WIDE_01_W_M,W01,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,ecx,pfnMonoWide00,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide00,W00,LOOP_UNROLL_COUNT

MONO_WIDE_00_W_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  ESP = pointer to start of pattern
        ...
        align   4
dual_wide_00_w_loop:
        UNROLL_LOOP     MONO_WIDE_00_W_M,W00,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoLeft1,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoLeft1,LEFT_W1,LOOP_UNROLL_COUNT

MONO_LEFT_1_W_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  EDI = target address to which to write
        ...
        align   4
dual_left_1_w_loop:
        UNROLL_LOOP     MONO_LEFT_1_W_M,LEFT_W1,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoLeft0,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoLeft0,LEFT_W0,LOOP_UNROLL_COUNT

MONO_LEFT_0_W_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  EDI = target address to which to write
        ...
        align   4
dual_left_0_w_loop:
        UNROLL_LOOP     MONO_LEFT_0_W_M,LEFT_W0,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoRight1,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoRight1,RIGHT_W1,LOOP_UNROLL_COUNT

MONO_RIGHT_1_W_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  EDI = target address to which to write
        ...
        align   4
dual_right_1_w_loop:
        UNROLL_LOOP     MONO_RIGHT_1_W_M,RIGHT_W1,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoRight0,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoRight0,RIGHT_W0,LOOP_UNROLL_COUNT

MONO_RIGHT_0_W_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  EDI = target address to which to write
        ...
        align   4
dual_right_0_w_loop:
        UNROLL_LOOP     MONO_RIGHT_0_W_M,RIGHT_W0,LOOP_UNROLL_COUNT
        dec     ebx
...
;-----------------------------------------------------------------------;
        ...
        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide_rw_11,RW11,LOOP_UNROLL_COUNT
...
; We only have to reset which planes are enabled if we do edges too:
        ...
        SET_UP_UNROLL_VARS ebx,ecx,ebx,pfnMonoWide_rw_11,LOOP_UNROLL_SHIFT

        mov     pfnUnroll,ecx
        mov     cUnrolledLoops,ebx

        jmp     ecx

MONO_RWIDE_11_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
        and     [edi],ah
        and     [edi+1],al
...
dual_wide_11_rw_loop:
        UNROLL_LOOP     MONO_RWIDE_11_RW_M,RW11,LOOP_UNROLL_COUNT
        dec     ebx
...
;-----------------------------------------------------------------------;
        ...
        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide_rw_10,RW10,LOOP_UNROLL_COUNT
...
; We only have to reset which planes are enabled if we do edges too:
        ...
        SET_UP_UNROLL_VARS ebx,ecx,ebx,pfnMonoWide_rw_10,LOOP_UNROLL_SHIFT
...
dual_wide_10_rw_only_one_byte:
        mov     pfnUnroll,offset dual_wide_10_rw_odd_byte
        jmp     short dual_wide_10_rw_odd_byte

MONO_RWIDE_10_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
        and     [edi],ah
        and     [edi+1],al
        add     edi,2                           ;the write will overlap this
...
dual_wide_10_rw_loop:
        UNROLL_LOOP     MONO_RWIDE_10_RW_M,RW10,LOOP_UNROLL_COUNT
        dec     ebx
...
;-----------------------------------------------------------------------;
        ...
        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide_rw_01,RW01,LOOP_UNROLL_COUNT
...
; We only have to reset which planes are enabled if we do edges too:
        ...
        SET_UP_UNROLL_VARS ebx,ecx,ebx,pfnMonoWide_rw_01,LOOP_UNROLL_SHIFT
...
dual_wide_01_rw_only_one_byte:
        mov     pfnUnroll,offset dual_wide_01_rw_odd_byte
        jmp     short dual_wide_01_rw_odd_byte

MONO_RWIDE_01_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
        and     [edi],al
        and     [edi+1],ah
        add     edi,2                           ;the write will overlap this
...
dual_wide_01_rw_loop:
        UNROLL_LOOP     MONO_RWIDE_01_RW_M,RW01,LOOP_UNROLL_COUNT
        dec     ebx
...
;-----------------------------------------------------------------------;
        ...
        UNROLL_LOOP_ENTRY_TABLE pfnMonoWide_rw_00,RW00,LOOP_UNROLL_COUNT
...
; We only have to reset which planes are enabled if we do edges too:
        ...
        SET_UP_UNROLL_VARS ebx,ecx,ebx,pfnMonoWide_rw_00,LOOP_UNROLL_SHIFT
...
MONO_RWIDE_00_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
        and     [edi],al
        and     [edi+1],ah
        add     edi,2                           ;the write will overlap this
...
dual_wide_00_rw_loop:
        UNROLL_LOOP     MONO_RWIDE_00_RW_M,RW00,LOOP_UNROLL_COUNT
        dec     ebx
        jnz     short dual_wide_00_rw_loop

        add     edi,lMiddleDelta
        dec     edx
        jz      short dual_wide_00_rw_done
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoLeft_rw_1,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoLeft_rw_1,LEFT_RW1,LOOP_UNROLL_COUNT

MONO_LEFT_1_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  EDI = target address to which to write
        ...
        align   4
dual_left_1_rw_loop:
        UNROLL_LOOP     MONO_LEFT_1_RW_M,LEFT_RW1,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoLeft_rw_0,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoLeft_rw_0,LEFT_RW0,LOOP_UNROLL_COUNT

MONO_LEFT_0_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
;  EDI = target address to which to write
        ...
        align   4
dual_left_0_rw_loop:
        UNROLL_LOOP     MONO_LEFT_0_RW_M,LEFT_RW0,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoRight_rw_1,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoRight_rw_1,RIGHT_RW1,LOOP_UNROLL_COUNT

MONO_RIGHT_1_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
dual_right_1_rw_loop:
        UNROLL_LOOP     MONO_RIGHT_1_RW_M,RIGHT_RW1,LOOP_UNROLL_COUNT
        dec     ebx
...
; Calculate full start addresses:
        ...
        SET_UP_UNROLL_AND_BRANCH ebx,eax,pfnMonoRight_rw_0,LOOP_UNROLL_SHIFT

        UNROLL_LOOP_ENTRY_TABLE pfnMonoRight_rw_0,RIGHT_RW0,LOOP_UNROLL_COUNT

MONO_RIGHT_0_RW_M macro ENTRY_LABEL,ENTRY_INDEX
&ENTRY_LABEL&ENTRY_INDEX&:
...
dual_right_0_rw_loop:
        UNROLL_LOOP     MONO_RIGHT_0_RW_M,RIGHT_RW0,LOOP_UNROLL_COUNT
        dec     ebx
