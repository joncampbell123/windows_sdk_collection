...
GDIINFO gaulCap = {
     ...
     0x1000,                // ulVersion (our driver is version 1.000)
...
DEVINFO devinfoVGA =
{
    (GCAPS_OPAQUERECT | GCAPS_HORIZSTRIKE | GCAPS_ALTERNATEFILL | GCAPS_MONO_DITHER | GCAPS_COLOR_DITHER |
     GCAPS_WINDINGFILL | GCAPS_TRAPPAINT),       // Graphics capabilities
...
BYTE gaajRealizedPat[HS_DDI_MAX][32] = {
