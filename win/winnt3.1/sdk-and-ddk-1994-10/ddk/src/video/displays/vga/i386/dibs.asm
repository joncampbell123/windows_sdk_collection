...
aulDefBitMapping equ    this dword
...
apfn4bppConvert equ this dword
...
apfn4bppConvertRHS  equ this dword
...
apfn8bppConvert equ this dword
...
; guaranteed to be positive and < 16 bits !!!
        ...
        mov     edx,eax
        xchg    ax,fr.SrcxOrg           ;D31:16 is zero for both
