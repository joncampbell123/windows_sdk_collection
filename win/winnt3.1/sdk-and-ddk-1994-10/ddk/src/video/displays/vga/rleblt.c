...
//    ASSERT((psoTrg->dhsurf != (DHSURF)0),"bRleBlt: invalid dhsurf\n");
...
//    ASSERT(pxlo != NULL,"RleBlt with invalid pxlo\n");
    rleInfo.pulXlate = pxlo->pulXlate;
//    ASSERT(rleInfo.pulXlate != (PULONG)NULL,
//           "RleBlt GetTranslateVecotr failed\n");
