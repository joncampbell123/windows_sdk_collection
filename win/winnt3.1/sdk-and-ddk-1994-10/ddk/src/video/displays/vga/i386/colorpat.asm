...
pfnWideWholeRepClr label   dword
        dd      pfnDrawWide00Color
        dd      pfnDrawWide01Color
        dd      pfnDrawWide10Color
        dd      pfnDrawWide11Color
...
pfnWholeBytesMod0Color  label   dword
        ...
        dd      pfnDraw1WideEvenColor
        dd      pfnDraw2WideEvenColor
        dd      pfnDraw3WideEvenColor
        dd      pfnDraw4WideEvenColor
        dd      pfnDraw5WideEvenColor
        dd      pfnDraw6WideEvenColor
        dd      pfnDraw7WideEvenColor
        dd      pfnDraw8WideEvenColor
...
pfnWholeBytesMod1Color  label   dword
        dd      0                       ;we never get a 0-wide case
        dd      pfnDraw1WideOddColor
        dd      pfnDraw2WideOddColor
        dd      pfnDraw3WideOddColor
        dd      pfnDraw4WideOddColor
        dd      pfnDraw5WideOddColor
        dd      pfnDraw6WideOddColor
        dd      pfnDraw7WideOddColor
        dd      pfnDraw8WideOddColor
...
ifdef FAST_PLANE
        local   RotatedMask[64]:byte    ;Plane mask buffer
endif
...
copy_masks:
ifdef FAST_PLANE
        lea     edi,RotatedMask                 ;Pattern Dest
        mov     esi,pBrush                      ;point to the brush
        add     esi,oem_brush_planes            ;Pattern Src

        ; Expand our plane masks to be double tall.
INDEX=0
DSTINDEX=0
        rept    4
        mov     eax,[esi+INDEX]
...
ifdef FAST_PLANE
        mov     al,[esi-MASKOFFSET]     ;we always do plane 0
else
...
ifdef FAST_PLANE
        mov     ah,[esi-MASKOFFSET]     ;we always do plane 0
        or      ah,ah
        jz      do_next_plane
        xchg    ah,al
endif
...
ifdef FAST_PLANE
        mov     al,[esi+48-MASKOFFSET]
        or      al,al
        jz      short finished_one_pass
else
        mov     al,MM_C3
endif
        mov     edx,VGA_BASE + SEQ_DATA
...
; Tables of entry points into unrolled wide write-only loops.
        UNROLL_LOOP_ENTRY_TABLE pfnDrawWide00Color,W00,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDrawWide01Color,W01,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDrawWide10Color,W10,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDrawWide11Color,W11,LOOP_UNROLL_COUNT
...
; code for different alignments.
        ...
        UNROLL_LOOP_ENTRY_TABLE pfnDraw1WideEvenColor,W1_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw1WideOddColor,W1_ODD,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw2WideEvenColor,W2_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw2WideOddColor,W2_ODD,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw3WideEvenColor,W3_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw3WideOddColor,W3_ODD,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw4WideEvenColor,W4_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw4WideOddColor,W4_ODD,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw5WideEvenColor,W5_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw5WideOddColor,W5_ODD,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw6WideEvenColor,W6_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw6WideOddColor,W6_ODD,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw7WideEvenColor,W7_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw7WideOddColor,W7_ODD,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw8WideEvenColor,W8_EVEN,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw8WideOddColor,W8_ODD,LOOP_UNROLL_COUNT
...
; read before write loops.
        ...
        UNROLL_LOOP_ENTRY_TABLE pfnDraw1RWColor,RWW1,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw2RWColor,RWW2,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw3RWColor,RWW3,LOOP_UNROLL_COUNT
        UNROLL_LOOP_ENTRY_TABLE pfnDraw4RWColor,RWW4,LOOP_UNROLL_COUNT
...
;masm386 -Mx -I..\..\inc -I..\..\..\inc -Id:\nt\public\sdk\inc -Di386=1 -DNT_INST=0 -DNT_UP=1 -DSTD_CALL -DDBG=1 -DDEVL=1 i386\colorpat.asm,obj\i386\colorpat.obj,x.lst;
