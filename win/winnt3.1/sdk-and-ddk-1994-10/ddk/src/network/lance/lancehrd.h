...
#define LANCE_DEPCA_RAP_ADDRESS     ((ULONG)(0x206))
#define LANCE_DEPCA_RDP_ADDRESS     ((ULONG)(0x204))
#define LANCE_DEPCA_EPROM_ADDRESS   ((ULONG)(0x20c))
#define LANCE_DEPCA_LAN_CFG_ADDRESS ((ULONG)(0x800))
...
#define LANCE_DE201_PRI_RAP_ADDRESS     ((ULONG)(0x306))
#define LANCE_DE201_PRI_RDP_ADDRESS     ((ULONG)(0x304))
#define LANCE_DE201_PRI_NETWORK_ADDRESS ((ULONG)(0x30C))

#define LANCE_DE201_SEC_NICSR_ADDRESS   ((ULONG)(0x200))
#define LANCE_DE201_SEC_RAP_ADDRESS     ((ULONG)(0x206))
#define LANCE_DE201_SEC_RDP_ADDRESS     ((ULONG)(0x204))
#define LANCE_DE201_SEC_NETWORK_ADDRESS ((ULONG)(0x20C))

#define LANCE_DE422_NICSR_ADDRESS        ((ULONG)(0xC00))
#define LANCE_DE422_RAP_ADDRESS          ((ULONG)(0xC06))
#define LANCE_DE422_RDP_ADDRESS          ((ULONG)(0xC04))
#define LANCE_DE422_NETWORK_ADDRESS      ((ULONG)(0xC0C))
#define LANCE_DE422_EISA_CONFIGURATION   ((ULONG)(0xC0C))
#define LANCE_DE422_EXTENDED_MEMORY_BASE_ADDRESS ((ULONG)(0xC08))
#define LANCE_DE422_EISA_IDENTIFICATION ((ULONG)(0xC80))
#define LANCE_DE422_EISA_CONTROL         ((ULONG)(0xC84))
...
#define LANCE_ISR_WRITE_RAP(A,C)  NdisWritePortUshort((A)->NdisAdapterHandle,(ULONG)((A)->RAP),C)
#define LANCE_ISR_READ_RDP(A,C)   NdisReadPortUshort((A)->NdisAdapterHandle,(ULONG)((A)->RDP),C)
#define LANCE_ISR_WRITE_RDP(A,C)  NdisWritePortUshort((A)->NdisAdapterHandle,(ULONG)((A)->RDP),C)
#define LANCE_ISR_WRITE_NICSR(A,C) NdisWritePortUshort((A)->NdisAdapterHandle,(ULONG)((A)->Nicsr),C)


#else


#define LANCE_ISR_WRITE_RAP(A,C)\
   NdisWritePortUshort((A)->NdisAdapterHandle,(ULONG)((A)->RAP),C);

#define LANCE_ISR_READ_RDP(A,C)\
   NdisReadPortUshort((A)->NdisAdapterHandle,(ULONG)((A)->RDP),C);

#define LANCE_ISR_WRITE_RDP(A,C)\
   NdisWritePortUshort((A)->NdisAdapterHandle,(ULONG)((A)->RDP),C);
