...
#define IF_LOG(A) {IbmtokLog[IbmtokLogPlace++ % 256] = (A); IbmtokLog[IbmtokLogPlace+2 % 256] = '.';}
...
if (IbmtokDbg) DbgPrint("IBMTOK: RESET done\n");
            ...
            NdisWriteRegisterUshort(&(OpenSrb->OpenOptions), OPEN_CONTENDER);
...
--*/
{
    ...
    NdisWriteRegisterUchar(&(StatsSrb->StationId), USHORT_TO_IBMSHORT(0x00));
    NdisWriteRegisterUchar(&(StatsSrb->ReturnCode), 0x80);                      // Resets counters
