/* resource.h : Defines the constants for resources of ShowFont.
//
...
//
// This header file, containing only #define lines, is suitable for
// including in the resource script.
*/
