...
/***    Disclaimer
 *
 *    	Information in this header file is subject to change without notice
 *	and does not represent a commitment on the part of Microsoft Corporation
 *	to support or maintain this information in future versions of the 
 *	software.
 *
 *	These contents may become obsolete in the future.
 *
 */
