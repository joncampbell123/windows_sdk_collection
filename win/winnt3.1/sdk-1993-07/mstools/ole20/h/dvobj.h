...
#else
    STDMETHOD(Advise) (THIS_ FORMATETC FAR* pFormatetc, DWORD advf,
                    LPADVISESINK pAdvSink, DWORD FAR* pdwConnection) PURE;
...
#ifndef OLE2SHIP
#define ADVSINK_E_NOT_OLE1_MONIKER  (ADVSINK_E_FIRST + 0)
        // OnRename called with a moniker that is not OLE 1.0 compatible,
        // i.e., not a file moniker or a file/item composite moniker.
#endif
