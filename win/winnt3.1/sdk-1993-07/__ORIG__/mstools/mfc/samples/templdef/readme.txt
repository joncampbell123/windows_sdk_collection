...
proposed syntax for "templates" in C++.  This application is
a DOS utility that requires the MFC library MAFXCR.LIB or the
debug variant MAFXCRD.LIB.
...
AFXCOLL.HTT is the header file stub that prefixes the collection
definitions.
...
may change in the future.  It is provided as a sample application
only.
