...
*/
   ...
   xLogBitmapWidth = BitmapWidth (hBitmapLogStatus) ;
   yLogBitmapHeight = BitmapHeight (hBitmapLogStatus) ;
   xAlertBitmapWidth = BitmapWidth (hBitmapAlertStatus) ;
   yAlertBitmapHeight = BitmapHeight (hBitmapAlertStatus) ;
