...
#define RefString(id)       apszResources[id]
...
PSTR DisectWord(UINT type, UINT data, DDEML_MSG_HOOK_DATA *pdmhd, PSTR pstr);
PSTR pdf(UINT fmt);
...
INT FAR DoDialog(LPSTR lpTemplateName, DLGPROC lpDlgProc, UINT param,
