...
#define STDMETHODCALLTYPE       EXPORT __cdecl
#define STDAPICALLTYPE          EXPORT __stdcall

#else
#define EXPORT __export

#define STDMETHODCALLTYPE       EXPORT FAR CDECL
#define STDAPICALLTYPE          EXPORT FAR PASCAL
...
#define CO_E_CLASSNOTREG            (CO_E_FIRST + 0x2)
// clsid given is not registered (the extact missing piece depends upon the api)
...
#else
#define RPC_E_SERVER_DIED               (RPC_E_FIRST + 0x3)
#endif
...
#ifndef GUID_DEFINED
#define GUID_DEFINED
typedef struct FARSTRUCT _GUID
{
    DWORD Data1;
    WORD  Data2;
    WORD  Data3;
...
struct FARSTRUCT _COGUID: _GUID
{
    BOOL operator==(const _COGUID FAR& guidOther) const
#ifdef WIN32
        { return !memcmp(&Data1,&guidOther.Data1,sizeof(_COGUID)); }
#else        
        { return !_fmemcmp(&Data1,&guidOther.Data1,sizeof(_COGUID)); }
#endif

    BOOL operator!=(const _COGUID FAR& guidOther) const
        { return !((*this) == guidOther); }

    _COGUID() {}
    _COGUID(const GUID guidOther) { *this = *((_COGUID FAR*) &guidOther); }
};

inline BOOL operator==(const GUID FAR& guid, const _COGUID FAR& guidOther)
    { return (*((_COGUID FAR*) &guid) == guidOther); }

inline BOOL operator!=(const GUID FAR& guid, const _COGUID FAR& guidOther)
    { return (*((_COGUID FAR*) &guid) != guidOther); }

#else
typedef GUID _COGUID;
#endif
...
#define DEFINE_GUID(name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) \
    EXTERN_C const _COGUID CDECL FAR name
...
#define REFGUID             const _COGUID FAR&
#define REFIID              const _COGUID FAR&
#define REFCLSID            const _COGUID FAR&
#else
#define REFGUID             const _COGUID FAR*
#define REFIID              const _COGUID FAR*
#define REFCLSID            const _COGUID FAR*
...
#else
    STDMETHOD_(DWORD, RetryRejectedMessage) (THIS_
#endif
...
STDAPI_(LPSTR) CoBuildVersionEx( VOID );
...
#define CO_E_READREGDB              (CO_E_FIRST + 0x5)
#define CO_E_WRITEREGDB             (CO_E_FIRST + 0x6)
