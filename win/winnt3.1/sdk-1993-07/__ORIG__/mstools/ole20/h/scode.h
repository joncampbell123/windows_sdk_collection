...
#define ADVSINK_E_FIRST MAKE_SCODE(SEVERITY_ERROR,   FACILITY_ITF, 0x0150)
#define ADVSINK_E_LAST  MAKE_SCODE(SEVERITY_ERROR,   FACILITY_ITF, 0x015F)
#define ADVSINK_S_FIRST MAKE_SCODE(SEVERITY_SUCCESS, FACILITY_ITF, 0x0150)
#define ADVSINK_S_LAST  MAKE_SCODE(SEVERITY_SUCCESS, FACILITY_ITF, 0x015F)
#define ADVHOLDER_E_FIRST   MAKE_SCODE(SEVERITY_ERROR,   FACILITY_ITF, 0x0160)
#define ADVHOLDER_E_LAST    MAKE_SCODE(SEVERITY_ERROR,   FACILITY_ITF, 0x016F)
#define ADVHOLDER_S_FIRST   MAKE_SCODE(SEVERITY_SUCCESS, FACILITY_ITF, 0x0160)
#define ADVHOLDER_S_LAST    MAKE_SCODE(SEVERITY_SUCCESS, FACILITY_ITF, 0x016F)
#endif
