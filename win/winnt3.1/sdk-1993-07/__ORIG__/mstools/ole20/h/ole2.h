...
#ifndef OLE2SHIP
// these are derived from the std definitions in stdobj.h
// WARNING: these will be removed before we ship!!!
...
#else
#define CONVERT10_E_OLESTREAM_BITMAP_TO_DIB (CONVERT10_E_FIRST + 4)
#define CONVERT10_E_STG_FMT             (CONVERT10_E_FIRST + 5)
#define CONVERT10_E_STG_NO_STD_STREAM   (CONVERT10_E_FIRST + 6)
#define CONVERT10_E_STG_DIB_TO_BITMAP   (CONVERT10_E_FIRST + 7)
#define CONVERT10_S_NO_PRESENTATION     (CONVERT10_S_FIRST + 1)
#endif
...
#ifdef MAC_REVIEW
    // add these , ericoe
    //STDMETHOD(LoadFsp) (THIS_ FSSpec *pSpec) PURE;
    //STDMETHOD(SaveFsp) (THIS_ FSSpec *pSpec, BOOL fRemember) PURE;
    //STDMETHOD(GetCurFsp) (THIS_ FSSpec *pSpec) PURE;
#endif
};
...
STDAPI_(LPSTR) OleBuildVersionEx( VOID );
...
#ifdef _MAC
STDAPI  OleCreateFromFsp(REFCLSID rclsid, REFIID riid,
                LPOLECLIENTSITE pClientSite, DWORD renderopt,
                CLIPFORMAT cfFormat, FSSpec *pSpec, LPSTORAGE pStg,
                LPVOID FAR* ppvObj);
#endif
...
#else
STDAPI_(void)       OleDestroyMenuDescriptor (HOLEMENU holemenu);
#endif
...
// OLESTREAM contains a static object
#define CONVERT10_E_OLESTREAM_STATIC    (CONVERT10_E_FIRST + 3)

// Returned by either API, this scode indicates that the original object
//  Like CONVERT10_S_NOT_OLE1_MONIKER, but there was no presentation stream.
#define CONVERT10_E_NOT_OLE1_MONIKER    (CONVERT10_E_FIRST + 8)


// The OLE stream of the IStorage contains a moniker that is not compatible
//  with OLE 1.0, i.e., not a file moniker or a file/item composite moniker.
//  The object was converted to a 1.0 static object.
#define CONVERT10_S_NOT_OLE1_MONIKER    (CONVERT10_S_FIRST + 0)
...
// Obsolete; will be removed before ship
#define OLEVERB_PRIMARY     OLEIVERB_PRIMARY
#define OLEVERB_SHOW        OLEIVERB_SHOW

#define OLEOBJ_S_CANNOT_DOVERB_NOW      (OLEOBJ_S_FIRST + 1)
#define E_UNKNOWNVERB       OLE_E_VERB  // remove later
#define OLEOBJ_E_NOVERBS    (OLEOBJ_E_FIRST + 0)
#endif
