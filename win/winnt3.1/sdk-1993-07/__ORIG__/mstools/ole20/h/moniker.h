...
#else
#define MK_S_MONIKERALREADYREGISTERED (MK_S_FIRST + 6)
#endif
...
#ifndef OLE2SHIP
    STDMETHOD(Advise) (THIS_ IAdviseSink FAR * pAdvSink, DWORD FAR * pdwConnection ) PURE;
    STDMETHOD(Unadvise) (THIS_ DWORD dwConnection ) PURE;
    STDMETHOD(EnumAdvise) (THIS_ IEnumSTATDATA FAR * ppenumAdvise) PURE;
#endif
};
typedef         IRunningObjectTable FAR* LPRUNNINGOBJECTTABLE;
...
#define MK_E_INTERMEDIATE_INTERFACE_NOT_SUPPORTED MK_E_INTERMEDIATEINTERFACENONOT_SUPPORTED
#define MK_E_NOT_BINDABLE           MK_E_NOTBINDABLE
#define S_TRUE                      S_OK
#define MK_S_NOT_RUNNING        MK_S_FIRST
#define MK_S_NO_STORAGE         (MK_S_FIRST + 1)
#define MK_S_NOPREFIX           (MK_S_FIRST + 3)
