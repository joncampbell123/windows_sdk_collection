...
#ifdef UNICODE
#define ReqQueryMultipleValues  ReqQueryMultipleValuesW
#else
#define ReqQueryMultipleValues  ReqQueryMultipleValuesA
#endif // !UNICODE
#endif /* WINVER >= 0x0400 */
