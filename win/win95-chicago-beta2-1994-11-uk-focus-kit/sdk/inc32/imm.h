...
DWORD WINAPI ImmGetCandidateListA(HIMC, DWORD deIndex, DWORD dwBufLen, LPCANDIDATELIST);
DWORD WINAPI ImmGetCandidateListW(HIMC, DWORD deIndex, DWORD dwBufLen, LPCANDIDATELIST);
#ifdef UNICODE
...
UINT    WINAPI ImmGetConversionListA(HKL, HIMC, LPCSTR, LPCANDIDATELIST, UINT uBufLen, UINT uFlag);
UINT    WINAPI ImmGetConversionListW(HKL, HIMC, LPCWSTR, LPCANDIDATELIST, UINT uBufLen, UINT uFlag);
#ifdef UNICODE
