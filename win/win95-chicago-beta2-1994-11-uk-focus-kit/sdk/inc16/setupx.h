...
#define VNLP_IFEXISTS       0x0010  // This file must left as a temp name
...
*       @flag DI_FLAGSEX_NOLOGCONFIGS     | Set if DiInstallDevice shouldn't install 
*       a device's LogConfigs.
...
#define DI_FLAGSEX_NOLOGCONFIGS     0x00000008L  // DiInstallDevice shouldn't install LogConfigs
