...
Begin VB.Form frmImages 
   ...
   Begin VB.Label lblEnter 
      Caption         =   "Click on an image and see what happens"
      Height          =   615
      Left            =   720
      TabIndex        =   2
      Top             =   2280
...
Attribute VB_Base = "0{B94D9DCA-DBE8-11CF-84BA-00AA00C007F0}"
...
Private Sub imgDiamond_Click()
    ...
    picStatus.Cls
    picStatus.Print "Selected: Diamond"
End Sub
...
Private Sub imgHeart_Click()
    ...
    picStatus.Cls
    picStatus.Print "Selected: Heart"
End Sub
...
Private Sub imgSpade_Click()
    ...
    picStatus.Cls
    picStatus.Print "Selected: Spade"
End Sub
