...
# ADD LINK32 uuid.lib /NOLOGO /SUBSYSTEM:windows /DLL /MACHINE:I386
...
# ADD LINK32 uuid.lib /NOLOGO /SUBSYSTEM:windows /DLL /DEBUG /MACHINE:I386
...
SOURCE=\CPPtoCOM\DBCOMMul\Interface\guids.cpp
DEP_GUIDS=\
	..\Interface\DBSRV.H
...
.\WinDebug\guids.obj :  $(SOURCE)  $(DEP_GUIDS) $(INTDIR)
 ...
 "_AFXDLL" /D "_MBCS" /FR$(INTDIR)/ /Fo$(INTDIR)/ /Fd$(OUTDIR)/"DB.pdb" /c\
  $(SOURCE) 
...
.\WinDebUn\guids.obj :  $(SOURCE)  $(DEP_GUIDS) $(INTDIR)
 ...
 "_AFXDLL" /D "_MBCS" /D "_UNICODE" /FR$(INTDIR)/ /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"DB.pdb" /c  $(SOURCE) 
...
.\WinRelUn\guids.obj :  $(SOURCE)  $(DEP_GUIDS) $(INTDIR)
 ...
 "_AFXDLL" /D "_MBCS" /D "_UNICODE" /FR$(INTDIR)/ /Fo$(INTDIR)/ /c  $(SOURCE) 
