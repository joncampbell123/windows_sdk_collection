...
/*
    ...
    receiving the execute command has no global execute function
...
/*
    ...
    @api BOOL | InitializeDDE | Initialize all the DDE lists for
        this server and initialize the DDEML DLL.
...
/*
    ...
    @api void | UninitializeDDE | Terminate use of the DDEML DLL.

    @rdesc There is no return value.

    @comm Any resources used by eralier calls are freed.
...
/*
    ...
    @parm PDDEEXECFN | pfnExec | Pointer to an optional execute command
        processiong function.  This argument may be NULL in which case
...
/*
    ...
    @parm LPWORD | pFormatList | Pointer to a list of valid formats.
...
/*
    ...
    @comm If the topic does not exist it will be created. If the
        comamnd already exists, the information will be updated.
                              ...
                              UINT uiMaxArgs)
{
    ...
    if (pCmd) {
        ...
        // add teh 'Result' command too.  This supports the
...
/*
    ...
    @rdesc The return value is a pointer to the return string.
...
/*
    ...
    @parm LPSTR * | ppStr | Pointer tot he current scan pointer.
...
/*
    ...
    @rdesc The return value is a pointer tot he string or NULL if
        an error occurs.

    @comm The scna pointer is updated to point past the string.  The
