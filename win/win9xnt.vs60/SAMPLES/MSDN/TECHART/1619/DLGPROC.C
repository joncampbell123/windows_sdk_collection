...
BOOL CALLBACK WMFRecDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
  int i;
  ...
  case WM_INITDIALOG:
	  ...
	  if (bEnhMeta)
	  {
        ...
        LoadParameterLB(hDlg, (emfMetaRec.nSize - sizeof(emfMetaRec.nSize) - 
                        sizeof(emfMetaRec.iType))/sizeof(DWORD), IDB_HEX);
	  }
	  else
	  {
...
BOOL CALLBACK EnumRangeDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    BOOL lpTranslated;
    RECT rect;
...
BOOL CALLBACK EnhMetaHeaderDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    char szBuf[30];
...
BOOL CALLBACK HeaderDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    char szBuf[30];
...
BOOL CALLBACK AldusHeaderDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    char szBuf[30];
...
BOOL CALLBACK ClpHeaderDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    char szBuf[30];
...
BOOL CALLBACK ListDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message) {
        case WM_INITDIALOG:
			...
			//
		    GetMetaFileAndEnum(hDC, ENUMMFLIST);
