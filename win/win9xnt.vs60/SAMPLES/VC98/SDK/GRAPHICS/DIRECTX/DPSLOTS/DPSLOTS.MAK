...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib ole32.lib uuid.lib advapi32.lib winmm.lib /nologo /subsystem:windows /machine:I386
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib ole32.lib uuid.lib advapi32.lib\
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib ole32.lib uuid.lib advapi32.lib winmm.lib /nologo /subsystem:windows /debug /machine:I386
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib ole32.lib uuid.lib advapi32.lib\
...
"$(INTDIR)\dpslots.res" : $(SOURCE) $(DEP_RSC_DPSLO) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
...
"$(INTDIR)\dpslots.obj" : $(SOURCE) $(DEP_CPP_DPSLOT) "$(INTDIR)"
