...
OBJECT\OHELLO    Object sample illustrating a custom interface.
...
You will first need to install the Microsoft Visual C/C++ version 1.5
...
Please add the proper path to your INCLUDE environment variable.
