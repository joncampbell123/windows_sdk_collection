...
The DispCalc sample is a simple accumulator-based calculator. Its user 
...
The ProgID for DispCalc's only object is "DispCalc.Application". An instance
...
DispCalc uses INTERFACEDATA and CreateStdDispatch to implement the 
IDispatch interface.
