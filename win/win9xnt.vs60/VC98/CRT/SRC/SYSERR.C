...
char *_sys_errlist[] =
{
    ...
    /* 10 ECHILD    */  "No children", /* uniforum differs */
    /* 11 EAGAIN    */  "No more processes",
    /* 12 ENOMEM    */  "Not enough memory", /* uniforum differs */
    /* 13 EACCES    */  "Permission denied",
    /* 14 EFAULT    */  "Bad address",
    /* 15 ENOTBLK   */  "Block device required",
    /* 16 EBUSY     */  "Mount device or directory busy", /* uniforum differs */
    /* 17 EEXIST    */  "File exists",
    ...
    /* 24 EMFILE    */  "Too many open files",
    /* 25 ENOTTY    */  "Not a typewriter", /* uniforum differs */
    ...
    /* 34 ERANGE    */  "Result too large",
    /* 35 EUCLEAN   */  "File system not clean",
