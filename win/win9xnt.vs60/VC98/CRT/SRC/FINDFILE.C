...
int __cdecl _tfindnexti64(long hFile, struct _tfinddatai64_t * pfd)

#else  /* _USE_INT64 */

int __cdecl _tfindnext(long hFile, struct _tfinddata_t * pfd)
