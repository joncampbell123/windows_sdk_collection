...
* Version 1.2: NT & Windows 95 SDK release			    *	
*   Changes updated documentation, added support for SW_HIDE        *
********************************************************************/
...
void help()
{
  ...
  puts("  /min|/max|/hid Start window minimized/maximized/hidden");
  ...
  puts("  /s           	 Windows NT: Run Win16 app in separate VDM ");
