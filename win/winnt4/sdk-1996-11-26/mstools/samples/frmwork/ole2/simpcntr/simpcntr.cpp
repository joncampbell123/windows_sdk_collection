                   ...
                   int       nCmdShow)
{
    ...
    if (GetVersion() & 0x80000000)  // Unicode version requires NT
    {
        ...
        LoadString(hInstance, IDS_REQUIRES_WINNT, szMsg, sizeof(szMsg));
        LoadString(hInstance, IDS_APPNAME, szTitle, sizeof(szTitle));
        MessageBoxA(NULL, szMsg, szTitle, MB_OK | MB_ICONSTOP);
        return 0;
    }
#endif
