...
The GDIPRINT sample demonstrates bitmap creation, editing, storage, 
retrieval, and printing.

This sample is based on the GDIDIB sample. It is a 32-bit only sample.
...
GDIPrint - Window procedure for the main application window.
