...
If the build tools cannot find SDKUTIL.LIB, use the SAMPLES\OLE\COMMON sample
...
-------------
 ...
 - Change browseh.reg to provide the full path of BROWSEH.DLL, BROWSEH.TLB
   and MYDISP.TLB..
...
--------------
 ...
 - Run the Automation controller BROWSE that uses BROWSEH to browse a type
   ...
   to output a C/C++ header file from the information in a type library. The
