...
class CCosmoFrame : public CFrame
    ...
    private:
        ...
        //CHAPTER16MOD
        OLEINPLACEFRAMEINFO     m_frameInfo;    //Container's stuff.
        LPOLEINPLACEFRAME       m_pIOleIPFrame; //Copy of CFigure's
        //End CHAPTER16MOD

    protected:
        //CHAPTER16MOD
        BOOL      FMessageHook(HWND, UINT, WPARAM, LPARAM
                      , LRESULT *);
        //End CHAPTER16MOD
