...
// Date  : March 1993
//
// Copyright: Copyright Microsoft Corporation 1993-1995
//
//============================================================================
...
#ifdef JAPAN
#define SZWINDOWTITLE      "コマンド スケジューラ"
#define SZCREDITS		   "Developed for Microsoft\rby Kory Gill"
#define SZGENERROR         "指定のコンピュータへのアクセスエラー"
#define SZNOENTRIES        "登録コマンドなし"
#else
...
#define IDC_INTERACTIVE			120
#define IDM_SAVE_TO_REGISTRY    121
#define IDM_GET_FROM_REGISTRY   122
