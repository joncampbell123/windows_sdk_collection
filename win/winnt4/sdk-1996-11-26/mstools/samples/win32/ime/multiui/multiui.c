...
LPARAM lParam;
{
	...
	case WM_PAINT:
	    hDC = BeginPaint (hWnd, &ps);
            ...
            hIMC = GetWindowLong(hWndIMC1,MYGWL_IMC);
            ...
            hIMC = GetWindowLong(hWndIMCUI2,MYGWL_IMC);
