...
!MESSAGE 
!MESSAGE "IS2WCGI - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "IS2WCGI - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
ALL : "$(OUTDIR)\IS2WCGI.exe"

CLEAN : 
	-@erase ".\Release\IS2WCGI.exe"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/IS2WCGI.pdb" /machine:I386 /out:"$(OUTDIR)/IS2WCGI.exe" 
LINK32_OBJS= \
	".\Release\IS2WCGI.obj"

"$(OUTDIR)\IS2WCGI.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/IS2WCGI.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/IS2WCGI.exe" 
LINK32_OBJS= \
	".\Debug\IS2WCGI.obj"
...
"$(INTDIR)\IS2WCGI.obj" : $(SOURCE) "$(INTDIR)"
