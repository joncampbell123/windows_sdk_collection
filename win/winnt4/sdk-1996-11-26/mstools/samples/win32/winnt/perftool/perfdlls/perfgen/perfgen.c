...

{
    ...
    if (!dwOpenCount) {
        ...
        SigGenDataDefinition.SineWaveDef.CounterOffset =
            (DWORD)((LPBYTE)(&sc.dwSineWaveValue) - (LPBYTE)&sc);
        ...
        SigGenDataDefinition.TriangleWaveDef.CounterOffset =
            (DWORD)((LPBYTE)(&sc.dwTriangleWaveValue) - (LPBYTE)&sc);
        ...
        SigGenDataDefinition.SquareWaveDef.CounterOffset =
            (DWORD)((LPBYTE)(&sc.dwSquareWaveValue) - (LPBYTE)&sc);
        ...
        SigGenDataDefinition.ConstantValueDef.CounterOffset =
            (DWORD)((LPBYTE)(&sc.dwConstantValue) - (LPBYTE)&sc);
