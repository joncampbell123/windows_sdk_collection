...
#define VER_LEGALTRADEMARKS_STR  "Microsoft(R) is a registered trademark of Microsoft Corporation. Windows NT(TM) is a trademark of Microsoft Corporation\0"
#define VER_LEGALCOPYRIGHT_STR   "Copyright (C) Microsoft Corp. 1991-1995\0"
...
#define  BUILDDATEJ  "1993/6/30"

#ifdef DEBUG
#define  STFABOUTMSGJ  "Microsoft セットアップ for Windows NT\n\n1993/6/30\nバージョン 2.20.0000 - Debug\n\nCopyright (C) 1991-1995 Microsoft Corporation."
#else  /* !DEBUG */
#define  STFABOUTMSGJ  "Microsoft セットアップ for Windows NT\nバージョン 2.2\n\nCopyright (C) 1991-1995 Microsoft Corporation."
#endif /* !DEBUG */
