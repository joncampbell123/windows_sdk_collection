...
#define IDS_MS_MINCHO                           87
#define IDS_MS_MINCHO_VERT                      88
#define IDS_MS_GOTHIC                           89
#define IDS_MS_GOTHIC_VERT                      90
#define IDS_MS_MINGLI                           91
#define IDS_MS_MINGLI_VERT                      92
#endif // DBCS
...
#define MULTIBYTETOUNICODE MyMultiByteToUnicode
#define UNICODETOMULTIBYTE MyUnicodeToMultiByte
...
#define GetACP  MyGetACP

BOOL MyIsDBCSLeadByteEx(
    UINT CodePage,
    BYTE CharCode
    );

#define IsDBCSLeadByteEx    MyIsDBCSLeadByteEx
...
#define MULTIBYTETOWIDECHAR EngMultiByteToWideChar
#define WIDECHARTOMULTIBYTE EngWideCharToMultiByte
...
#define TranslateCharsetInfo MyTranslateCharsetInfo

#define qsort EngSort

#else // !KERNEL_MODE

#define HSEMAPHORE             CRITICAL_SECTION
#define ACQUIRESEMAPHORE(h)    EnterCriticalSection(&(h))
#define RELEASESEMAPHORE(h)    LeaveCriticalSection(&(h))

#define MULTIBYTETOWIDECHAR(p1,p2,p3,p4,p5) \
        (MultiByteToWideChar((p1),0,(p4),(p5),(p2),(p3)/2)*2)
#define WIDECHARTOMULTIBYTE(p1,p2,p3,p4,p5) \
        WideCharToMultiByte((p1),0,(p2),(p3)/2,(p4),(p5),NULL,NULL)
