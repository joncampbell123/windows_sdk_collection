...
#define FONTENC_B5              9
#define FONTENC_UHC             10
#define FONTENC_83PV_RKSJ_H     11   // support PPD 4.3 spec.
#define FONTENC_90MS_RKSJ_H     12
#define FONTENC_90MS_RKSJ_V     13 
#define FONTENC_EXT_RKSJ_H      14
#define FONTENC_EXT_RKSJ_V      15
#define FONTENC_GB_EUC_H        16
#define FONTENC_GB_EUC_V        17
#define FONTENC_B5_H            18
#define FONTENC_B5_V            19
#define FONTENC_KSC_EUC_H       20
#define FONTENC_KSC_EUC_V       21
#define FONTENC_KSCMS_EHC_H     22
#define FONTENC_KSCMS_EHC_V     23
#define MAXFONTENC              24
...
#if defined(DBCS) // FE font
#define CHARSET_90MS            12
#define CHARSET_KSCMS           13
#define CHARSET_GB              14
#define CHARSET_KSC             15
#define CHARSET_B5              16
#define MAXCHARSET              17
#else // DBCS
...
#if defined(DBCS)
typedef INT (*PFNTODEVICE)(BYTE *, BYTE *, ULONG);
typedef BOOL (*PFNISFULLWIDTH)(BYTE *);
#endif // DBCS
...
#if defined(DBCS) // FE font
#define FEVERT_NONE             0
#define FEVERT_VERTICAL         1
#define FEVERT_SIMULATED        2
#endif // DBCS
...
#define pMemOptions pPredefinedUiGroups[UIGRP_VMOPTION]
	...
	PJOBPATCHFILE   pJobPatchFileList;
...
#ifdef DBCS  // Device FOnt Prefer Option
#define     PPD_OGPO_COVER_ALL       0xFFFF
#define     PPD_OGPO_DEFAULT         0x0000
#define     PPD_OGPO_JIS78           0x0001
#endif
