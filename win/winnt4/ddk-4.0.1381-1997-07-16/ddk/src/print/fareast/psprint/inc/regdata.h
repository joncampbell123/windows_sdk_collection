...
typedef struct {
	...
	WORD    wCurOutGlyPreferOpt;               // Current Output Glyph Font Prefer Option
...
#ifdef  DBCS  // Output Glyph Prefer Option
#define OGPO_DEFAULT            0x0000          // Default Output Glyph Prefer Option
#define OGPO_JIS78              0x0001          // Output Glyph Prefer Option is JIS78
#endif
...
#ifdef DBCS  // Output Glyph Prefer Option
WORD  GetOutGlyPreferOption(HANDLE);
#endif
