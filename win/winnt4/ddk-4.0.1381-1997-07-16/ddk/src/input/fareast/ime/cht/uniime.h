...
UINT    WINAPI UniImeToAsciiEx(LPINSTDATAL, LPIMEL, UINT, UINT,
               CONST LPBYTE, LPDWORD, UINT, HIMC);              // toascii.c
...
DWORD   WINAPI UniSearchPhrasePredictionW(UINT, LPCWSTR, DWORD,
               LPCWSTR, DWORD, DWORD, DWORD, DWORD,
               LPCANDIDATELIST);                                // uniphrs.c

DWORD   WINAPI UniSearchPhrasePredictionA(UINT, LPCSTR, DWORD,
