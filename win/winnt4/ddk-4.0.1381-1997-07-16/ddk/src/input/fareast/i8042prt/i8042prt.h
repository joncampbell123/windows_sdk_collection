...
KEYBOARD_OEM_INFORMATION KeyboardFarEastOemInformation[] = {
    {{7, FE_SUBTYPE(0,MSFT)}, {12,3,101}}, // PC/AT 101 Enhanced Japanese Keyboard
    ...
    {{7, FE_SUBTYPE(1,AX  )}, {12,4,105}}, // AX consortium compatible keyboard
...
typedef enum _KEYBOARD_STATE {
    ...
    SendFirstByte,
    SendLastByte
#ifdef WINDOWS_FE // _KEYBOARD_STATE
   ,SendFinalByte
#endif // WINDOWS_FE
} KEYBOARD_STATE;
...
#ifdef WINDOWS_FE // KBD_IDENTIFIER
...
#ifdef WINDOWS_FE // I8042_CONFIGURATION_INFORMATION
