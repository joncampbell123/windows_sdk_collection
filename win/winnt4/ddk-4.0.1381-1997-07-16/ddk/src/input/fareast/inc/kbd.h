...
#ifdef FE_SB // KENLSProcs();
BOOL    KENLSProcs(PKE pke, ULONG dwExtraInformation);
#endif // FE_SB
...
#elif (KBD_TYPE == 30)
#define _NE(v30,v31,V32)           (VK_##v30)
#elif (KBD_TYPE == 31)
#define _NE(v30,v31,v32)           (VK_##v31)
#elif (KBD_TYPE == 32)
#define _NE(v30,v31,v32)           (VK_##v32)
#elif (KBD_TYPE == 40)
...
#elif (KBD_TYPE >= 30) && (KBD_TYPE <= 32)
#define _EQ(              v32) (VK_##v32)
...
#define X5E _EQ(                      _none_    )
#define X5F _EQ(                      _none_    )
...
*   31       NEC PC-9800 Document processor Keyboard.
*   32 *     NEC PC-9800 106 Keyboard.
*
*     +------+ +----------+----------+----------+
*     | Scan | |   kbd    |   kbd    |   kbd    |
*     | code | |  type 30 |  type 31 |  type 32 |
\****+-------+-+----------+----------+----------+***********************/
#define T00 _EQ(                      _none_    )
#define T01 _EQ(                      ESCAPE    )
#define T02 _EQ(                      '1'       )
...
#define T38 _EQ(                      LMENU     )
#define T39 _EQ(                      ' '       )
#define T3A _NE(CAPITAL,   CAPITAL,   DBE_ALPHANUMERIC)
#define T3B _EQ(                      F1        )
#define T3C _EQ(                      F2        )
#define T3D _EQ(                      F3        )
#define T3E _EQ(                      F4        )
...
#define T54 _EQ(                      SNAPSHOT  )
#define T55 _NE(OEM_8,     OEM_8,     OEM_102   )
#define T56 _NE(_none_,    OEM_NEC_DP4,_none_   )
#define T57 _EQ(                      F11       )
#define T58 _EQ(                      F12       )
#define T59 _NE(OEM_NEC_EQUAL\
                          ,OEM_NEC_EQUAL,\
                                      CLEAR     )
#define T5A _EQ(                      NONCONVERT)
#define T5B _NE(_none_,    _none_,    NONAME    )
#define T5C _NE(OEM_NEC_SEPARATE\
                          ,OEM_NEC_SEPARATE,\
                                      NONAME    )
#define T5D _NE(F13,       F13,       EREOF     )
#define T5E _NE(F14,       F14,       _none_    )
#define T5F _NE(F15,       F15,       _none_    )
#define T60 _NE(_none_,    OEM_NEC_DP1,_none_   )
#define T61 _NE(_none_,    OEM_NEC_DP2,_none_   )
#define T62 _NE(_none_,    OEM_NEC_DP3,_none_   )
#define T63 _NE(_none_,    _none_,    _none_    )
...
#define T70 _NE(_none_,    _none_,    DBE_HIRAGANA)
#define T71 _EQ(                      _none_    )
#define T72 _EQ(                      _none_    )
#define T73 _EQ(                      _none_    )
#define T74 _EQ(                      _none_    )
#define T75 _EQ(                      _none_    )
#define T76 _NE(_none_,    _none_,    F24       )
#define T77 _NE(_none_,    _none_,    DBE_SBCSCHAR)
#define T78 _EQ(                      _none_    )
#define T79 _NE(_none_,    _none_,    CONVERT   )
#define T7A _EQ(                      _none_    )
#define T7B _NE(_none_,    _none_,    NONCONVERT)
#define T7C _EQ(                      _none_    )
#define T7D _EQ(                      _none_    )

#define X1C _EQ(                      RETURN    )
#define X1D _NE(KANA,      KANA,      DBE_HIRAGANA)
#define X33 _EQ(                      _none_    )
#define X35 _EQ(                      DIVIDE    )
#define X37 _EQ(                      SNAPSHOT  )
#define X38 _NE(KANJI,     KANJI,     CONVERT   )
...
#define X52 _EQ(                      INSERT    )
#define X53 _EQ(                      DELETE    )
#define X5B _NE(LWIN,      _none_,    LWIN      )
#define X5C _NE(RWIN,      _none_,    RWIN      )
#define X5D _NE(APPS,      _none_,    APPS      )
#define X5E _EQ(                      _none_    )
#define X5F _EQ(                      _none_    )
