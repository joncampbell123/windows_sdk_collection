...
//
// These should probably be somewhere "global" . . .
//
...
//
// These should come from the Configuration Manager
//
...
#define NE3200_MACBIN_PATH              "\\Device\\Harddisk0\\Partition0\\Nt\\Bin\\Mac.Bin"
...
// complete.  Each of these values is in units of 1/10 of a second.
// Therefore, a value of 20 would be approximately 2 seconds.
//

#define NE3200_TIMEOUT_RESET        20
#define NE3200_TIMEOUT_DOWNLOAD     10
...
#define NE3200_MAXIMUM_BLOCKS_PER_PACKET        ((UINT)8)
...
typedef struct _NE3200_COMMAND_BLOCK {
    ...
    union _PARAMETERS {
        ...
        struct _SET_ADDRESS {
            ...
            //
            IN UCHAR NewStationAddress[ETH_LENGTH_OF_ADDRESS];
...
// at least quadword aligned. On the 386 this is just a call to
// non-paged pool contiguous allocation.
//
#define NE3200_ALLOCATE_MEMORY_FOR_HARDWARE(A,S,P) \
{ \
    *(P) = NE3200_ALLOC_PHYS_NONCACHED(S);\
}

//
// This macro is used to "deallocate" the memory from the hardware.
// On the 386 this is just a call to contiguous deallocation routine.
//
#define NE3200_DEALLOCATE_MEMORY_FOR_HARDWARE(P, S) \
{ \
    NE3200_FREE_PHYS_NONCACHED(P, S); \
}
