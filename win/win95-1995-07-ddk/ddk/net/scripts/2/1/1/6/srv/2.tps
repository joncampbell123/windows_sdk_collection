#	-SECTION_START-( 2.00 ) -SECTION_DESC-( "Send Broadcast, Receive Directed & Multicast-server-side" )
##
## TITLE: 2.1.1.6.2 Send Broadcast, Receive Directed & Multicast
