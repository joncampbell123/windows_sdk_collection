#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Multicast, Receive Directed-client-side" )
##
## TITLE: 2.1.1.3.1 Send Multicast, Receive Directed (2M/1C/1O) client-side
##
