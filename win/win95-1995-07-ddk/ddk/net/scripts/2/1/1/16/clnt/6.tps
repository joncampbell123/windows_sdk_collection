#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Broadcast & Resend Functional-client-side" )
##
## TITLE: 2.1.1.16.6 Send Functional, Receive Functional & Broadcast &
...
## have its packetfilter set to receive FUNCTIONAL & BROADCAST packets.
...
SetPacketFilter                                 +
    OpenInstance=1                              +
    PacketFilter=FUNCTIONAL|BROADCAST
#	-SECTION_END-( 6.03 )
