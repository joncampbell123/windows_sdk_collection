#	-SECTION_START-( 7.00 ) -SECTION_DESC-( "Send Multicast, Receive Directed & Broadcast & Multicast & Resend Directed-server-side" )
##
## TITLE: 2.1.1.15.7 Send Multicast, Receive Directed & Broadcast &
