#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Multicast, Receive Directed & Multicast & Resend Directed-client-side" )
##
## TITLE: 2.1.1.15.1 Send Multicast, Receive Directed & Multicast & Resend
