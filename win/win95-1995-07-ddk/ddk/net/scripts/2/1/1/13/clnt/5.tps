#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Multicast & Resend Directed-client-side" )
##
## TITLE: 2.1.1.13.5 Send Directed, Receive Directed & Multicast &
