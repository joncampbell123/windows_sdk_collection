#	-SECTION_START-( 8.00 ) -SECTION_DESC-( "Send Broadcast, Receive Directed & Broadcast & Multicast & Resend Broadcast-client-side" )
##
## TITLE: 2.1.1.14.18 Send Broadcast, Receive Directed & Broadcast & Multicast
