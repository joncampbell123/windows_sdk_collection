#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Resend Multicast-server-side" )
##
## TITLE: 2.1.1.10.3 Send Broadcast, Receive Broadcast & Resend
## TITLE:            Multicast (2M/1C/1O) server-side
##
...
## have its packetfilter set to receive BROADCAST packets.  Each packet
