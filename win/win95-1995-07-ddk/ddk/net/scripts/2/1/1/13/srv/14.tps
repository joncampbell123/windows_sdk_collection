#	-SECTION_START-( 7.00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Mac Frames & Resend Directed-server-side" ) -OPTIONALS-( MACFRAME )
##
## TITLE: 2.1.1.13.14 Send Directed, Receive Directed & Mac Frames &
