#	-SECTION_START-( 2.00 ) -SECTION_DESC-( "Send Functional, Receive Directed & Functional & Resend Broadcast-server-side" )
##
## TITLE: 2.1.1.16.2 Send Functional, Receive Directed & Functional & Resend
