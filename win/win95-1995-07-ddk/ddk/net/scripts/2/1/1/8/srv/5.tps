#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Functional, Receive Broadcast & Functional-server-side" )
##
## TITLE: 2.1.1.8.5 Send Functional, Receive Broadcast & Functional
