#	-SECTION_START-( 3.00 ) -SECTION_DESC-( "Send Functional, Receive Directed & Functional & Resend Functional-server-side" )
##
## TITLE: 2.1.1.16.3 Send Functional, Receive Directed & Functional & Resend
