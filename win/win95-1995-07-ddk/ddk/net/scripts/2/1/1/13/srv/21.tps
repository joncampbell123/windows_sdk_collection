#	-SECTION_START-( 11. 00 ) -SECTION_DESC-( "Send Directed, Receive Directed & Broadcast & Functional & Resend Broadcast-server-side" )
##
## TITLE: 2.1.1.13.21 Send Directed, Receive Directed & Broadcast &
