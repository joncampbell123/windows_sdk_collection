#	-SECTION_START-( 8.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Source Routing & Resesnd Broadcast" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.3.1.17.8 Send Functional, Receive Functional & Source Routing
