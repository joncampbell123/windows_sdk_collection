#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Multicast, Receive Multicast & Broadcast & Resend Multicast" )
##
## TITLE: 1.3.1.16.6 Send Multicast, Receive Multicast & Broadcast
## TITLE:            & Resend Multicast (1M/2C/1O)
##
...
## set to receive MULTICAST & BROADCAST packets.  Each packet will
