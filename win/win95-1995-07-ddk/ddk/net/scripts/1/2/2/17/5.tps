#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Broadcast & Resend Broadcast" )
##
## TITLE: 1.2.2.17.5 Send Functional, Receive Functional & Broadcast
