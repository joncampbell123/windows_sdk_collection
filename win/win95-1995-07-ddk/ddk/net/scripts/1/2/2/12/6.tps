#   -SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Multicast, Receive Promiscuous & Resend Multicast" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.12.6 Send Multicast, Receive Promiscuous & Resend
