#	-SECTION_START-( 5.00 ) -SECTION_DESC-( "Send Directed, Receive Promiscuous & Resend Broadcast" ) -OPTIONALS-( PROMISCUOUS )
##
## TITLE: 1.2.2.10.6 Send Directed, Receive Promiscuous & Resend
