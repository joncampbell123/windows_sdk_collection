#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Source Routing" ) -OPTIONALS-( SOURCEROUTING )
##
## TITLE: 1.2.2.7.8 Send Broadcast, Receive Broadcast & Source Routing (1M/1C/2O)
##
