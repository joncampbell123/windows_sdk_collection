#	-SECTION_START-( 4.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Broadcast & Resend Directed" )
##
## TITLE: 1.2.2.17.4 Send Functional, Receive Functional & Broadcast
...
## set to receive FUNCTIONAL packets.  Each packet will contain a
