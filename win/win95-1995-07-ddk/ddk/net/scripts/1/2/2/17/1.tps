#	-SECTION_START-( 1.00 ) -SECTION_DESC-( "Send Functional, Receive Functional & Directed & Resend Directed" )
##
## TITLE: 1.2.2.17.1 Send Functional, Receive Functional & Directed
