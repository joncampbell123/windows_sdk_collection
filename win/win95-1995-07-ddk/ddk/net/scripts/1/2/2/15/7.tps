#	-SECTION_START-( 6.00 ) -SECTION_DESC-( "Send Broadcast, Receive Broadcast & Multicast & Resend Multicast" )
##
## TITLE: 1.2.2.15.7 Send Broadcast, Receive Broadcast & Multicast
## TITLE:            & Resend Multicast (1M/1C/2O)
##
...
## set to receive BROADCAST & MULTICAST packets.  Each packet will
