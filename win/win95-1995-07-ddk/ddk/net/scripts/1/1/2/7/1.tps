#   -SECTION_START-( 1.0 ) -SECTION_DESC-( "Send Broadcast, Receive Directed Broadcast & Multicast" )
##
## TITLE: 1.1.2.7.1 Send Broadcast, Receive Directed,Broadcast & Multicast (1M/1C/1O)
##
...
## set to receive DIRECTED, BROADCAST and MULTICAST packets.  Packets
