#   -SECTION_START-( 1.0 )  -SECTION_DESC-( "Send Multicast,Receive Multicast,Resend Multicast" )
##
## TITLE: 1.1.2.12.1 Send Multicast, Receive Multicast & Resend
## TITLE:            Multicast (1M/1C/1O)
##
