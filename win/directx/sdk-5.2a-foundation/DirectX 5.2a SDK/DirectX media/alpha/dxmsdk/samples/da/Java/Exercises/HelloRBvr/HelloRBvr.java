...
public class HelloRBvr extends DXMApplet {
  public void init() {
    super.init() ;
    setModel(new HelloRBvrModel());
  }
}

// The createModel method in this class
// is where you construct your animation.
class HelloRBvrModel extends Model {
  ...
  public void createModel(BvrsToRun blist)
  {
    ...
    // construct a reactive color which switches to red upon LMB event
    textClr = (ColorBvr)until(textClr, leftButtonDown, red);
