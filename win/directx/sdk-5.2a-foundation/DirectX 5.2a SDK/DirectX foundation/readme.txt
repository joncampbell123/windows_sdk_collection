...
================================
= Addendum for DirectX 5.2 SDK =
================================
DirectX 5.2 SDK is an updated version of DirectX 5 SDK. Please read the Release
Notes for a full description of DirectX 5.2 updates. Also, please visit our
web site, http://www.microsoft.com/directx to get the latest information about
DirectX and Multimedia for Windows platform.
...
Release Notes for DirectX 5.2
-----------------------------
1) DirectX 5.2 includes fixes and changes since the DirectX 5 SDK release. 
   The list of fixes and changes include:

   - DirectX will now install on international language versions of Windows 95.
       Previously, setup was not able to install drivers onto non-supported 
       language versions of Windows 95. Also, setup did not install correct 
       drivers if the regional setting was not the default setting.
   - Digital joysticks can now be used on NEC PC-98 computers.
       On some NEC PC-98 computers, the digital joystick did not work.
   - Certian sound drivers can now be updated.
       Setup did not update older drivers that are not DirectSound supported.
   - DirectX now can be successfully installed onto Chinese (Traditional) 
     version of Windows 95.
       On some machines, after installing DirectX 5 onto Chinese (Traditional) 
       Windows 95, it caused a GPF during boot.
   - New Dxbug.exe and Dxinfo.exe. are now included.
       These reporting tools now report incorrectly placed DirectX components.

2) New language drivers are added. Finnish, Danish and Hungarian drivers can 
   be redistributed in addition to existing redistributable drivers.
