...
namespace Tut09_Client
{
    ...
    public enum ConnectionType { Disconnected, Connected };
    ...
    public class ClientApp : IDisposable
    {
        ...
        public static readonly int     DefaultPort = 2609;

        // DirectPlay
        private Client              m_Client = null;                   // DirectPlay Client object
        ...
        public void Dispose()
        {
            if (m_Client != null && !m_Client.Disposed)
                m_Client.Dispose();
        }
