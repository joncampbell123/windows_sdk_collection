...
namespace Tut06_HostMigration
{
    ...
    /// Application class.
    /// </summary>
    public class HostMigrationApp : IDisposable
    {
        #region Fields
        //---------------------------------------------------------------------
        ...
        // generate a new guid.
        #endregion
        private static readonly Guid   m_AppGuid = new Guid("2C6FEE8B-3088-4b74-B38F-A16D02DAD246"); 
        public static readonly int     DefaultPort = 2606; // Default port number
        ...
        static void Main() 
        {
            ...
            HostMigrationApp App = new HostMigrationApp();
