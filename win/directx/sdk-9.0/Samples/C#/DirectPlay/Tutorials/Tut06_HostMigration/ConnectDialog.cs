...
namespace Tut06_HostMigration
{
    ...
    {
        private HostMigrationApp App = null;                      // Application instance
        private HostInfo         m_SelectedHost = null;           // Host selected for connection
        ...
        // Properties
        public  HostInfo SelectedHost { get { return m_SelectedHost; } }
        ...
        public ConnectDialog(HostMigrationApp app)
        {
            App = app;
