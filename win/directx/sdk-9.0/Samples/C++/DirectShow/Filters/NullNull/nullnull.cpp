...
// Drag and drop onto GraphEdit any WAV file or any MPEG, AVI or MOV file.
...
// do not work, but others normally do.).
//
//
//     Implementation
//
// Leverages the base clases for most functionality.  That which cannot be
// done with the base classes (e.g. creating this filter) is done here.
...
// transform, so it merely passes the data on unchanged.
//
//
