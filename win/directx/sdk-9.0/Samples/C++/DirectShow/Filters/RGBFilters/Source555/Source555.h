...
#ifndef __RGBFilters__Source555_H
#define __RGBFilters__Source555_H

extern const AMOVIESETUP_FILTER sudSource555Bit;
...
private:
    ...
    //
    DECLARE_IUNKNOWN
    CSource555Bit(LPUNKNOWN lpunk, HRESULT *phr);
    ~CSource555Bit();
...
// CSource555BitStream manages the data flow from the output pin.
//
class CSource555BitStream 
    ...
    , public CSourceSeeking
{
    ...
    friend CSource555Bit;

public:

    CSource555BitStream(HRESULT *phr, CSource555Bit *pParent, LPCWSTR pPinName);
    ~CSource555BitStream();
    STDMETHODIMP NonDelegatingQueryInterface( REFIID riid, void ** ppv );
