         ...
         )
{
    ...
    lstrcpyn(szCommandLine, GetCommandLine(), MAX_PATH-1);
    szCommandLine[MAX_PATH-1] = 0;      // Ensure null-termination
    ...
    // Finally, get the name of the media file to play
    lstrcpyn(szMovieName, pstrCommandLine, MAX_PATH);

#else
    lstrcpyn(szMovieName, lpszMovie, MAX_PATH);
#endif
