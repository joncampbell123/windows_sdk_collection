...
Path
====
  Source:     DXSDK\Samples\C++\DirectMusic\PlayAudio
  Executable: DXSDK\Samples\C++\DirectMusic\Bin

User's Guide
============
  Play the default segment, or load another wave, MIDI, or DirectMusic 
  Producer segment file by clicking Open File. Adjust the volume by
  using the Master Volume slider.  When using segments you can adjust 
  the tempo by using the Tempo slider.
