...
Description
===========
   The CreateDevice tutorial is the first tutorial for using the Direct3D
   interfaces. It shows how to create a Direct3D device object.

   
Path
====
   Source:     DXSDK\Samples\C++\Direct3D\Tutorials\Tut01_CreateDevice
