...
Description
===========
  The Keyboard sample obtains and displays keyboard data.

Path
====
  Source:     DXSDK\Samples\C++\DirectInput\Keyboard
  Executable: DXSDK\Samples\C++\DirectInput\Bin

User's Guide
============
  Select the desired cooperative level and data style and click "Create Device" 
  to create and acquire a DirectInput device for the system keyboard. Once the 
  device is acquired, any keyboard keystrokes will received by the application 
  and displayed on the data line. Click "Release Device" to release the device 
  in order to make changes to the options.
