...
Namespace Tut07_LobbyLaunch
    ...
    Public Class ApplicationForm
        ...
        Public WithEvents ReceivedMessagesListBox As System.Windows.Forms.ListBox
        Public WithEvents ConnectButton As System.Windows.Forms.Button
        Private mainMenu1 As System.Windows.Forms.MainMenu
        Private LobbyMenu As System.Windows.Forms.MenuItem
        ...
        Private App As LobbyLaunchApp


        Public Sub New(ByVal app As LobbyLaunchApp)
            Me.App = app
        ...
        Private Sub InitializeComponent()
            ...
            Me.label1.Text = "This tutorial implements the LobbiedApplication interface,"
            ' 
            ' label2
            ' 
            ...
            Me.label2.Text = "which enables enumeration and launch by a lobby client."
            ' 
            ' pictureBox1
            ' 
            ...
            Me.Text = "Tutorial 7: Lobby Launch"
