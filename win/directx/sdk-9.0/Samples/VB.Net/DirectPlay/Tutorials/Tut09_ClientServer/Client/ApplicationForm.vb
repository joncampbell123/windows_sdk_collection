...
Namespace Tut09_Client
    ...
    Public Class ApplicationForm
        ...
        Private App As ClientApp


        Public Sub New(ByVal app As ClientApp)
            Me.App = app
        ...
        Private Sub InitializeComponent()
            ...
            Me.label1.Text = "This tutorial splits the ""Send"" sample into server and client"
            ' 
            ' label2
            ' 
            ...
            Me.label2.Text = "components. This window handles the SERVER interface."
            ' 
            ' pictureBox1
            ' 
            ...
            ' groupBox1
            ' 
            Me.groupBox1.Controls.AddRange(New System.Windows.Forms.Control() {Me.ConnectButton, Me.SessionStatusLabel})
            ...
            ' ConnectButton
            ' 
            Me.ConnectButton.Location = New System.Drawing.Point(24, 56)
            ...
            Me.Text = "Tutorial 9: Client/Server (Client)"
