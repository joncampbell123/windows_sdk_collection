...
Namespace Tut08_Voice
    ...
    Public Class ApplicationForm
        ...
        Private WithEvents LobbyMenu As System.Windows.Forms.MenuItem
        Private WithEvents LobbyMenuRegisterItem As System.Windows.Forms.MenuItem
        Private WithEvents LobbyMenuUnregisterItem As System.Windows.Forms.MenuItem
        Public PlayIcon As System.Windows.Forms.PictureBox
        Public RecordIcon As System.Windows.Forms.PictureBox
        Public ActiveRecordIcon As System.Windows.Forms.PictureBox
        Public ActivePlayIcon As System.Windows.Forms.PictureBox

        Private App As VoiceApp

        Public Sub New(ByVal app As VoiceApp)
            Me.App = app
        ...
        Private Sub InitializeComponent()
            ...
            Me.ActiveRecordIcon = New System.Windows.Forms.PictureBox()
            Me.ActivePlayIcon = New System.Windows.Forms.PictureBox()
            Me.RecordIcon = New System.Windows.Forms.PictureBox()
            Me.PlayIcon = New System.Windows.Forms.PictureBox()
            ...
            Me.LobbyMenu = New System.Windows.Forms.MenuItem()
            Me.LobbyMenuRegisterItem = New System.Windows.Forms.MenuItem()
            Me.LobbyMenuUnregisterItem = New System.Windows.Forms.MenuItem()
            ...
            Me.label1.Text = "This tutorial uses the DirectPlay Voice API to send and"
            ' 
            ' label2
            ' 
            ...
            Me.label2.Text = "receive voice messages."
            ' 
            ' pictureBox1
            ' 
            ...
            ' groupBox1
            ' 
            Me.groupBox1.Controls.AddRange(New System.Windows.Forms.Control() {Me.ConnectButton, Me.SessionStatusLabel, Me.HostButton, Me.ActiveRecordIcon, Me.ActivePlayIcon, Me.RecordIcon, Me.PlayIcon})
            ...
            ' ActiveRecordIcon
            ' 
            Me.ActiveRecordIcon.Image = CType(resources.GetObject("ActiveRecordIcon.Image"), System.Drawing.Bitmap)
            Me.ActiveRecordIcon.Location = New System.Drawing.Point(232, 48)
            Me.ActiveRecordIcon.Name = "ActiveRecordIcon"
            Me.ActiveRecordIcon.Size = New System.Drawing.Size(32, 32)
            Me.ActiveRecordIcon.SizeMode = System.Windows.Forms.PictureBoxSizeMode.AutoSize
            Me.ActiveRecordIcon.TabIndex = 5
            Me.ActiveRecordIcon.TabStop = False
            Me.ActiveRecordIcon.Visible = False
            ' 
            ' ActivePlayIcon
            ' 
            Me.ActivePlayIcon.Image = CType(resources.GetObject("ActivePlayIcon.Image"), System.Drawing.Bitmap)
            Me.ActivePlayIcon.Location = New System.Drawing.Point(272, 48)
            Me.ActivePlayIcon.Name = "ActivePlayIcon"
            Me.ActivePlayIcon.Size = New System.Drawing.Size(32, 32)
            Me.ActivePlayIcon.SizeMode = System.Windows.Forms.PictureBoxSizeMode.AutoSize
            Me.ActivePlayIcon.TabIndex = 6
            Me.ActivePlayIcon.TabStop = False
            Me.ActivePlayIcon.Visible = False
            ' 
            ' RecordIcon
            ' 
            Me.RecordIcon.Image = CType(resources.GetObject("RecordIcon.Image"), System.Drawing.Bitmap)
            Me.RecordIcon.Location = New System.Drawing.Point(232, 48)
            Me.RecordIcon.Name = "RecordIcon"
            Me.RecordIcon.Size = New System.Drawing.Size(32, 32)
            Me.RecordIcon.SizeMode = System.Windows.Forms.PictureBoxSizeMode.AutoSize
            Me.RecordIcon.TabIndex = 4
            Me.RecordIcon.TabStop = False
            ' 
            ' PlayIcon
            ' 
            Me.PlayIcon.Image = CType(resources.GetObject("PlayIcon.Image"), System.Drawing.Bitmap)
            Me.PlayIcon.Location = New System.Drawing.Point(272, 48)
            Me.PlayIcon.Name = "PlayIcon"
            Me.PlayIcon.Size = New System.Drawing.Size(32, 32)
            Me.PlayIcon.SizeMode = System.Windows.Forms.PictureBoxSizeMode.AutoSize
            Me.PlayIcon.TabIndex = 3
            Me.PlayIcon.TabStop = False
            ' 
            ' groupBox2
            ' 
            ...
            ' mainMenu1
            ' 
            Me.mainMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.LobbyMenu})
            ' 
            ' LobbyMenu
            ' 
            Me.LobbyMenu.Index = 0
            Me.LobbyMenu.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.LobbyMenuRegisterItem, Me.LobbyMenuUnregisterItem})
            Me.LobbyMenu.Text = "&Lobby"
            ' 
            ' LobbyMenuRegisterItem
            ' 
            Me.LobbyMenuRegisterItem.Index = 0
            Me.LobbyMenuRegisterItem.Text = "&Register"
            ' 
            ' LobbyMenuUnregisterItem
            ' 
            Me.LobbyMenuUnregisterItem.Index = 1
            Me.LobbyMenuUnregisterItem.Text = "&Unregister"
            ' 
            ' ApplicationForm
            ' 
        ...
        '/ </summary>
        Private Sub LobbyMenuRegisterItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LobbyMenuRegisterItem.Click
            App.Register()
        End Sub 'LobbyMenuRegisterItem_Click


        '/ <summary>
        '/ Handler for Lobby->Unregister item click
        '/ </summary>
        Private Sub LobbyMenuUnregisterItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LobbyMenuUnregisterItem.Click
            App.Unregister()
        End Sub 'LobbyMenuUnregisterItem_Click
    End Class 'ApplicationForm
End Namespace 'Tut08_Voice