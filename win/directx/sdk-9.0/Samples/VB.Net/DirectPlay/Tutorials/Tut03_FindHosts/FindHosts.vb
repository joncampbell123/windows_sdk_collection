...
Namespace Tut03_FindHosts
    ...
    Public Class FindHostsApp
        ...
        ' generate a new guid.
        Private Shared m_AppGuid As New Guid("358E1C8D-DB4A-4867-B2C3-DEF3F5046B17")
        Public Shared DefaultPort As Integer = 2603 ' Default port number
