'----------------------------------------------------------------------------
' File: HostMigration.cs
'
' Desc: This tutorial adds an options for host migration, which keeps the 
'       peer-to-peer session alive by randomly selecting a new host if the 
'       current host leaves. 
'
...
Namespace Tut06_HostMigration
    ...
    Public Class HostMigrationApp
        ...
        ' generate a new guid.
        Private Shared m_AppGuid As New Guid("2C6FEE8B-3088-4b74-B38F-A16D02DAD246")
        Public Shared DefaultPort As Integer = 2606 ' Default port number
        ...
        Public Shared Sub Main()
            ...
            Dim App As New HostMigrationApp()
