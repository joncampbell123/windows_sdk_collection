...
Path
====
   Source:     DXSDK\Samples\VB.Net\Direct3D\Text3D
...
Programming Notes
=================
   This sample uses the common class, GraphicsFont, to display 2D text in a 3D
   ...
   When the GraphicsFOnt class DrawText() function is called, a vertex buffer is
   ...
   The sample also shows how to use TextFromFont() to create a mesh
   containing a 3D model of a text string.  Note that TextFromFont may not
