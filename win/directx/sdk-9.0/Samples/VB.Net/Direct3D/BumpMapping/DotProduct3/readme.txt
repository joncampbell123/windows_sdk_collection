...
Path
====
   Source:     DXSDK\Samples\VB.NET\Direct3D\BumpMapping\DotProduct3
...
=================
   ...
   texture map. The blend stages, then, look like
       TextureState[0].ColorOperation = TextureOperation.DotProduct3;
       TextureState[0].ColorArgument1 = TextureArgument.TextureColor;
       TextureState[0].COLORARG2 = TextureArgument.TFactor;
