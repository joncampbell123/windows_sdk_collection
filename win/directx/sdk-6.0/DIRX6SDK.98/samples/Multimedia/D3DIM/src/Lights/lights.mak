...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /subsystem:windows /incremental:no /pdb:"$(OUTDIR)/lights.pdb" /machine:I386\
 /out:"$(OUTDIR)/lights.exe" 
LINK32_OBJS= \
	"$(INTDIR)\lights.obj" \
	"$(INTDIR)\winmain.obj" \
	"$(INTDIR)\winmain.res"
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo\
 /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)/lights.pdb" /debug\
 /machine:I386 /out:"$(OUTDIR)/lights.exe" 
LINK32_OBJS= \
	"$(INTDIR)\lights.obj" \
	"$(INTDIR)\winmain.obj" \
	"$(INTDIR)\winmain.res"
