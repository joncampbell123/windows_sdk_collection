...
!IF "$(CFG)" == ""
CFG=fog - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to fog - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "fog - Win32 Release" && "$(CFG)" != "fog - Win32 Debug"
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "fog - Win32 Debug"
CPP=cl.exe
RSC=rc.exe
MTL=mktyplib.exe
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/fog.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/fog.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /subsystem:windows /incremental:no /pdb:"$(OUTDIR)/fog.pdb" /machine:I386\
 /out:"$(OUTDIR)/fog.exe" 
LINK32_OBJS= \
	"$(INTDIR)\fog.obj" \
	"$(INTDIR)\perlin.obj" \
...
"$(OUTDIR)\fog.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\fog.exe"
	-@erase "$(OUTDIR)\fog.ilk"
	-@erase "$(OUTDIR)\fog.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/fog.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo\
 /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)/fog.pdb" /debug\
 /machine:I386 /out:"$(OUTDIR)/fog.exe" 
LINK32_OBJS= \
	"$(INTDIR)\fog.obj" \
	"$(INTDIR)\perlin.obj" \
	"$(INTDIR)\winmain.obj" \
...
"$(INTDIR)\perlin.obj" : $(SOURCE) $(DEP_CPP_PERLI) "$(INTDIR)"
