...
!IF "$(CFG)" == ""
CFG=multinut - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to multinut - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "multinut - Win32 Release" && "$(CFG)" !=\
 "multinut - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "multinut.mak" CFG="multinut - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "multinut - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "multinut - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "multinut - Win32 Debug"
RSC=rc.exe
MTL=mktyplib.exe
CPP=cl.exe

!IF  "$(CFG)" == "multinut - Win32 Release"
...
CLEAN : 
	...
	-@erase "$(INTDIR)\multinut.res"
	-@erase "$(INTDIR)\util.obj"
	-@erase "$(OUTDIR)\multinut.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/multinut.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/multinut.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/multinut.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib dinput.lib winmm.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/multinut.pdb" /machine:I386 /out:"$(OUTDIR)/multinut.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ddutil.obj" \
	"$(INTDIR)\donuts.obj" \
	"$(INTDIR)\input.obj" \
...
"$(OUTDIR)\multinut.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "multinut - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\multinut.exe"
	-@erase "$(OUTDIR)\multinut.ilk"
	-@erase "$(OUTDIR)\multinut.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/multinut.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/multinut.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/multinut.bsc" 
...
LINK32_FLAGS=ddraw.lib dinput.lib winmm.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/multinut.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/multinut.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ddutil.obj" \
	"$(INTDIR)\donuts.obj" \
	"$(INTDIR)\input.obj" \
...
# Name "multinut - Win32 Release"
# Name "multinut - Win32 Debug"
...
"$(INTDIR)\multinut.res" : $(SOURCE) $(DEP_RSC_MULTI) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
