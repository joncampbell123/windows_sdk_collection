...
int PASCAL WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance,
    ...
    if (fInitCSDirectSound)
    {
        fInitCSDirectSound = FALSE;
        DeleteCriticalSection(&csDirectSound);
    }
 ...
 */
    ...
    InitializeCriticalSection(&csDirectSound);
    fInitCSDirectSound = TRUE;
		    ...
		    BuildTitleBarText();
                ...
                case IDM_PLAY:
                    ...
                    if( bFileOpen && lpDSBStreamBuffer )
                    {
                        ...
                        if (fInitCSDirectSound)
                        {
                            EnterCriticalSection(&csDirectSound);
                        }
                        ...
                        if (fInitCSDirectSound)
                        {
                            LeaveCriticalSection(&csDirectSound);
                        }
                    }
                    else
                    {
                ...
                case IDM_STOP:
                    ...
                    if( bPlaying )
						...
						{
							ResetWavePlayer();	// This will set gfCloseOnDone to FALSE.
