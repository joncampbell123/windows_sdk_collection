	             ...
	             LPDIRECT3DRMFRAME3 scene, LPDIRECT3DRMFRAME3 )
{
    ...
    if (FAILED( pD3DRM->CreateWrap( D3DRMWRAP_SPHERE, frame,
    ...
    if (FAILED( pD3DRM->CreateMeshBuilder( &builder)))
	    goto generic_error;
    if (FAILED( builder->Load( "tpot2.x", NULL,
    				D3DRMLOAD_FROMFILE, NULL, NULL)))
	    goto generic_error;
    ...
    if (FAILED( child->AddVisual( (LPDIRECT3DRMVISUAL) mesh)))
	    goto generic_error;
