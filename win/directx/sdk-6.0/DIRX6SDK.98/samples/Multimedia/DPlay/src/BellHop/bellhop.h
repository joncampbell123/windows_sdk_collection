...
typedef struct {
	...
	LPDIRECTPLAYLOBBY3A	lpDirectPlayLobby3A;	// IDirectPlayLobby3A interface pointer
...
extern HRESULT	CreateDirectPlayLobbyInterface(LPDIRECTPLAYLOBBY3A *lplpDirectPlayLobby3A );
