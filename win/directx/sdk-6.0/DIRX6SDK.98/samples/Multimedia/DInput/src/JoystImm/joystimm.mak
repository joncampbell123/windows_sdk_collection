...
LINK32_FLAGS=dinput.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/JoystImm.pdb" /machine:I386 /out:"$(OUTDIR)/JoystImm.exe" 
LINK32_OBJS= \
	"$(INTDIR)\JoystImm.obj" \
	"$(INTDIR)\JoystImm.res" \
	"$(INTDIR)\WinMain.obj"
...
# PROP Output_Dir "JoystImm"
# PROP Intermediate_Dir "JoystImm"
# PROP Target_Dir ""
OUTDIR=.\JoystImm
INTDIR=.\JoystImm
...
LINK32_FLAGS=dinput.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/JoystImm.pdb" /debug /machine:I386\
