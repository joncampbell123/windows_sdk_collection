...
LINK32_FLAGS=dinput.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/KeybdBuf.pdb" /machine:I386 /out:"$(OUTDIR)/KeybdBuf.exe" 
LINK32_OBJS= \
	"$(INTDIR)\KeybdBuf.obj" \
	"$(INTDIR)\KeybdBuf.res" \
	"$(INTDIR)\WinMain.obj"
...
# PROP Output_Dir "KeybdBuf"
# PROP Intermediate_Dir "KeybdBuf"
# PROP Target_Dir ""
OUTDIR=.\KeybdBuf
INTDIR=.\KeybdBuf
...
LINK32_FLAGS=dinput.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/KeybdBuf.pdb" /debug /machine:I386\
