...
#ifdef DEBUG
    if( GetProfileInt( "Roids", "force_16_bit", 0) )
    {
...
BOOL CleanupAndExit( int err)
{
    ...
    MessageBox( hWndMain, "Game could not start", "ERROR", MB_OK );
    return FALSE;
}
...
void DisplayLevel( void )
{
    ...
    buf[4] = 10 + '0';
    buf[5] = '\0';
    bltScore( buf, 256, 232 );
    buf[0] = level / 100 + '0';
    buf[1] = level / 10 + '0';
    buf[2] = level % 10 + '0';
    buf[3] = '\0';
    bltScore( buf, 352, 232 );
    FlipScreen();
}
