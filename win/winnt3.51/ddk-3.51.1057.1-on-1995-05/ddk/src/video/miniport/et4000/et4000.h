...
#define MMU_BUFFER_MEMORY_ADDR          0xB8000
#define MMU_BUFFER_MEMORY_LEN           (0xBE000 - 0xB8000)
#define MMU_MEMORY_MAPPED_REGS_ADDR     0xBFF00
#define MMU_MEMORY_MAPPED_REGS_LEN      (0xC0000 - 0xBFF00)
#define MMU_EXTERNAL_MAPPED_REGS_ADDR   0xBE000
#define MMU_EXTERNAL_MAPPED_REGS_LEN    (0xBF000 - 0xBE000)

#define APERTURE_0_OFFSET   0x0000
#define APERTURE_1_OFFSET   0x2000
#define APERTURE_2_OFFSET   0x4000
