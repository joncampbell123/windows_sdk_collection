...
#define SNI_COMMON_MODE_BODY   IB, 0x2A                            \
                               ,OBM ,0x10 ,42                      \
                               ,0x00 ,0x00 ,0x01 ,0x01             \
                               ,0x02 ,0x02 ,0x03 ,0x03             \
                               ,0x04 ,0x04 ,0x05 ,0x05             \
...
USHORT SNI_640x480_256a60[] =
{
    ...
    ,0x070B // SRB = 07 :  VCLK0 numerator = 7
    ,0x081B // SR1B = 08 : VCLK0 denominator = 4
    ,OB ,0x1C
...
USHORT SNI_640x480_256a72[] =
{
    ...
    OWM ,SEQ_ADDRESS_PORT ,3
    ,0x1206 // SR6 = 12 : enable extension regs
    ,0x0B0B // SRB = 0B :  VCLK0 numerator = 11
    ,0x0A1B // SR1B = 0A : VCLK0 denominator = 5
    ,OB ,0x1C
    ,0x00   // 3CC = 0 : it's a read only register ?!!
    ,OB ,0x1A
    ,0x01   // HDR = 01
...
USHORT SNI_800x600_256a60[] =
{
    ...
    OWM ,SEQ_ADDRESS_PORT ,3
    ,0x1206 // SR6 = 12 : enable extension regs
    ,0x0E0B // SRB = 0E :  VCLK0 numerator
    ,0x0A1B // SR1B = 0A : VCLK0 denominator = 34
    ,OB ,0x1C
    ,0x00   // 3CC = 0 : it's a read only register ?!!
    ,OB ,0x1A
    ,0x01   // HDR = 01
...
USHORT SNI_800x600_256a72[] =
{
    ...
    OWM ,SEQ_ADDRESS_PORT ,3
    ,0x1206 // SR6 = 12 : enable extension regs
    ,0x0E0B // SRB = 0E :  VCLK0 numerator = 14
    ,0x081B // SR1B = 08 : VCLK0 denominator = 4
    ,OB ,0x1C
    ,0x00   // 3CC = 0 : it's a read only register ?!!
    ,OB ,0x1A
...
USHORT SNI_1024x768_256a61[] =
{
    ...
    OWM ,SEQ_ADDRESS_PORT ,3
    ,0x1206 // SR6 = 12 : enable extension regs
    ,0x290B // SRB = 29 :  VCLK0 numerator   = 41
    ,0x121B // SR1B = 12 : VCLK0 denominator = 9
    ,OB ,0x1C
    ,0x00   // 3CC = 0 : it's a read only register ?!!
    ,OB ,0x1A
    ,0x01   // HDR = 01
...
USHORT SNI_1024x768_256a70[] =
{
    ...
    OWM ,SEQ_ADDRESS_PORT ,3
    ,0x1206 // SR6 = 12 : enable extension regs
    ,0x150B // SRB = 15 :  VCLK0 numerator   = 21
    ,0x081B // SR1B = 08 : VCLK0 denominator = 4
    ,OB ,0x1C
    ,0x00   // 3CC = 0 : it's a read only register ?!!
    ,OB ,0x1A
...
USHORT SNI_1024x768_256a73[] =
{
    ...
    OWM ,SEQ_ADDRESS_PORT ,3
    ,0x1206 // SR6 = 12 : enable extension regs
    ,0x1B0B // SRB = 1B :  VCLK0 numerator   = 27
    ,0x0A1B // SR1B = 0A : VCLK0 denominator = 5
    ,OB ,0x1C
    ,0x00   // 3CC = 0 : it's a read only register ?!!
    ,OB ,0x1A
...
USHORT SNI_1024x768_256a75[] =
{
    ...
    OWM ,SEQ_ADDRESS_PORT ,3
    ,0x1206 // SR6 = 12 : enable extension regs
    ,0x1C0B // SRB = 1C :  VCLK0 numerator   = 28
    ,0x0A1B // SR1B = 0A : VCLK0 denominator = 5
    ,OB ,0x1C
    ,0x00   // 3CC = 0 : it's a read only register ?!!
    ,OB ,0x1A
