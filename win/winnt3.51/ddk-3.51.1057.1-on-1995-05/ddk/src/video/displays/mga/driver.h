...
VOID vGetBits8bpp(PDEV*, SURFOBJ*, RECTL*, POINTL*);
VOID vGetBits16bpp(PDEV*, SURFOBJ*, RECTL*, POINTL*);
VOID vGetBits24bpp(PDEV*, SURFOBJ*, RECTL*, POINTL*);
...
typedef enum {
    ...
    STAT_CIRCLE_CACHE       = 0x0004,   // Circle cache successfully allocated
} STATUSFLAGS;
...
VOID vPatRealize8bpp(PDEV*, RBRUSH*);
...
FNFILL              vFillPat1bpp;
FNFILL              vFillPat8bpp;
FNFILL              vFillPat16bpp;
FNFILL              vFillPat24bpp;
FNFILL              vFillSolid;
FNXFER              vXfer1bpp;
FNXFER              vXfer4bpp;
FNXFER              vXfer8bpp;
...
typedef struct  _PDEV
{
    ...
    ULONG       ulYDstOrg;              // Offset to be factored in whenever
                                        //   computing an MGA linear address
    ...
    ULONG       flHwCaps;               // 3D DDI rendering capabilities
