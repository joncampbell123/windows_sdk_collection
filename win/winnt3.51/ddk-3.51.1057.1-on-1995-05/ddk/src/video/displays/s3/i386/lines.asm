...
;                       edi = eqGamma_lo
        ...
        testb   ebx, FL_LAST_PEL_INCLUSIVE
        jz      short line_not_last_pel_inclusive

; It sure is easy to compute the first pel when lines have only integer
; coordinates and are last-pel inclusive:

        mov     x0, 0
        mov     y0, 0
        add     esi, dM
        shr     esi, FLOG2
        jnz     done_first_pel_last_pel
...
; the slope will obviously have no effect on rasterization.
        ...
        public  line_not_last_pel_inclusive
line_not_last_pel_inclusive::
        testb   ebx, FL_FLIP_H
...
; edi = eqGamma_lo
        ...
        cmp     edi, ecx
        jae     short RtoL_y0_is_2

        sub     ecx, edx                ; ecx = dM - dN
        cmp     edi, ecx
        jb      short RtoL_compute_x1
