...
friendly_script_name "Two Card Send/Receive Broadcast Tests"

print "TITLE:  Test ability to receive broadcast packets sent by another card in same machine\n"
