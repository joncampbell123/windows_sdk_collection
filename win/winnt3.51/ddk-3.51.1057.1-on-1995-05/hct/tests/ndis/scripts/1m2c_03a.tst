...
friendly_script_name "Two Card Send/Receive Multicast Tests"

print "TITLE:  Test ability to receive multicast packets sent by another card on same machine\n"
