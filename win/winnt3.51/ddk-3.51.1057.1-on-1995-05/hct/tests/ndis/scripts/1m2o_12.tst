...
friendly_script_name "Two Open Send/Receive/Resend Broadcast Tests"

print "TITLE:  Test send, receive, and resend with broadcast packets on two open instances\n"
