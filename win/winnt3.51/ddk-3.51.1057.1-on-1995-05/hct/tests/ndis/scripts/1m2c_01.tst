...
friendly_script_name "Two Card Send/Receive Directed Tests"

print "TITLE:  Test ability to receive directed packets from another card on same machine\n"
