...
friendly_script_name "Two Open Send/Receive/Resend Self-Directed Tests"

print "TITLE:  Test send, receive, and resend with 2 opens, directed addresses\n"
