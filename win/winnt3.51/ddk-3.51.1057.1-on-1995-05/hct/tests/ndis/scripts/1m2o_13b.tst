...
friendly_script_name "Two Open Send/Receive/Resend Functional Tests"

print "TITLE:  Test send, receive, and resend with functional packets on two open instances\n"
