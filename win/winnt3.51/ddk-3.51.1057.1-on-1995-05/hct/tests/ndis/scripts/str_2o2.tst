...
friendly_script_name "Two Open Stress Tests with One Client/Server One Server"

print "TITLE:  2 open stress tests:  one open is client/server, other is server\n"
...
$OptionMask[6]  = $OptionMask[6] | STRESS_WINDOWING_OFF | STRESS_DATACHECKING_ON | STRESS_PACKETSFROMPOOL_OFF
