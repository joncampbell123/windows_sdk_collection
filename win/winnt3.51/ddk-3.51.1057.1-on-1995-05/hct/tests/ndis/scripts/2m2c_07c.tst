...
friendly_script_name "Two Machine Send/Receive/Resend Group Tests"

print "TITLE:  Test send, receive, and resend group-addressed packets with two different cards\n"
