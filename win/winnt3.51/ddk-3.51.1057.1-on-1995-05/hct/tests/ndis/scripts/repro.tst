...
# File:  repro.tst
#
# This script is the same as ndis.tst, except that all
# the calls to the test scripts are commented out.  To
# repro a particular test, comment that test back in by
# removing the "#" at the beginning of the appropriate
# line, then run repro.bat with the appropriate arguments
#-------------------------------------------
