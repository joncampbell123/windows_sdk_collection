...
friendly_script_name "Two Card Stress Tests with Test Card as Server"

print "TITLE:  2 card stress tests:  test card is server, trusted card is client\n"
