...
# File 1m1c_15.tst
#
# This script tests the ability to send, receive, and resend "random"
# packets with various receive filters set..
###############################################################


friendly_script_name "Single Open Send/Receive/Resend Random Tests"

print "TITLE:  Test send, receive, and resend with random addresses\n"
...
#------------------------------------------------
# variation:   send "random" packets of various sizes with
