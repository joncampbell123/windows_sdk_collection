...
# FILE:  1m2o_10.tst
#
# These tests verify the ability to send "random"-directed packets from
# one open instance and receive them on the other, with various
# packet filters set
#######################################################

friendly_script_name "Two Open Send/Receive Random Tests"

print "TITLE:  Test ability to receive randomly addressed packets sent from other open instance\n"
