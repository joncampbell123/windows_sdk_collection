...
friendly_script_name "Two Card Stress Tests with Test Card as Client"

print "TITLE:  2 card stress tests: test card is client, trusted card is server\n"
