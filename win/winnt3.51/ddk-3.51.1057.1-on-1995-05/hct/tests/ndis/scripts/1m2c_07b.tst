...
friendly_script_name "Two Card Send/Receive/Resend Functional Tests"

print "TITLE:  Test send, receive, and resend with functional packets, 2 cards in same machine\n"
