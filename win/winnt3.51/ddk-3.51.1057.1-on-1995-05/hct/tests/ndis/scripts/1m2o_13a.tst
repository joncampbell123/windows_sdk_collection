...
friendly_script_name "Two Open Send/Receive/Resend Multicast Tests"

print "TITLE:  Test send, receive, and resend with multicast packets on two open instances\n"
