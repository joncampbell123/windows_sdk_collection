...
friendly_script_name "Two Card Send/Receive/Resend Group Tests"

print "TITLE:  Test send, receive, and resend with group packets, 2 card in same machine\n"
