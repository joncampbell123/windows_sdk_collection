...
friendly_script_name "Two Machine Stress Tests with Test Card as Client"

print "TITLE:  2 machine stress:  test card is client, other card is server\n"
