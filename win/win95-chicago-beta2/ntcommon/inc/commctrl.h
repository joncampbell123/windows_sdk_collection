...
//#define RDN_FIRST             (0U-500U)       // from shell.h
...
//#define SEN_FIRST             (0U-580U)       // from shell.h
//#define SEN_LAST              (0U-589U)
...
HIMAGELIST WINAPI ImageList_GetDragImage(POINT FAR* ppt,
