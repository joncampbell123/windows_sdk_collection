...
All multimedia samples are 32 bit.  Some application will also
compile as 16 bit to help you port your own 16 bit applications
to 32 bit.
...
BATCH		Sample Visual C++ Batch video compression
		application.
...
MCIAPP		MCI test application.  Builds 16 and 32 bit.
...
MIDIMON 	Sample that displays textual listing of
		midi input messages. Compiles both 16 and
		32 bit.
...
SVXFILE 	AVIFile file handler for Commodore Amiga audio
		files.
