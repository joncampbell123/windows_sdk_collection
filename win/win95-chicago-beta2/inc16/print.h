...
#define DMPAPER_LETTER_ROTATE       75  /* Letter Rotate 11 x 8 1/2 11 in     */
#define DMPAPER_A3_ROTATE           76  /* A3 Rotate 420 x 297 mm             */
#define DMPAPER_A4_ROTATE           77  /* A4 Rotate 297 x 210 mm             */
#define DMPAPER_A5_ROTATE           78  /* A5 Rotate 210 x 148 mm             */
#define DMPAPER_B4_JIS_ROTATE       79  /* B4 (JIS) Rotate 364 x 257 mm       */
#define DMPAPER_B5_JIS_ROTATE       80  /* B5 (JIS) Rotate 257 x 182 mm       */
#define DMPAPER_JAPANESE_POSTCARD_ROTATE 81 /* Japanese Postcard Rotate 148 x 100 mm */
#define DMPAPER_DBL_JAPANESE_POSTCARD_ROTATE 82 /* Double Japanese Postcard Rotate 148 x 200 mm */
#define DMPAPER_A6_ROTATE           83  /* A6 Rotate 148 x 105 mm             */
#define DMPAPER_JENV_KAKU2_ROTATE   84  /* Japanese Envelope Kaku #2 Rotate   */
#define DMPAPER_JENV_KAKU3_ROTATE   85  /* Japanese Envelope Kaku #3 Rotate   */
#define DMPAPER_JENV_CHOU3_ROTATE   86  /* Japanese Envelope Chou #3 Rotate   */
#define DMPAPER_JENV_CHOU4_ROTATE   87  /* Japanese Envelope Chou #4 Rotate   */

#define DMPAPER_LAST                DMPAPER_JENV_CHOU4_ROTATE
