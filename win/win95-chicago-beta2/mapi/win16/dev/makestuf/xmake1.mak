...
!IF $(PRODEXE)
CMODEL          = $(CMODEL) -GA -GEs -Gt16
!ENDIF

# Assume a static lib may be included in a DLL
!IF $(PRODDLL) || $(PRODLIB)
CMODEL          = $(CMODEL) -ALw -Gsw -D_WINDLL
!ENDIF

AFLAGS          = -Mx -t
CFLAGS          = $(CFLAGS) -nologo -c $(CMODEL) -W$(WARNLEVEL) -Zp2 -Gs -Gx- -J
...
DEFS            = $(DEFS) -DWIN32 -D$(CCPU)=1 /D_NTWIN
...
AFLAGS          = -Mx -t
CFLAGS      = $(CFLAGS) -c -G3s -W$(WARNLEVEL) -J
LFLAGS          = $(LFLAGS) -align:4096 -incremental:no -pdb:none -Machine:i386
