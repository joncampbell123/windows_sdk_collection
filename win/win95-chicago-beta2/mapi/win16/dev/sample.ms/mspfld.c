...
#define FLD_ValidateParameters(pobj, eMethod)       \
        OBJ_ValidateParameters(pobj, eMethod, sizeof(IFLD), &vtblIFLD)
    ...
    ULONG *pcval, LPSPropValue *ppval)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIProp_GetProps);
...
STDMETHODIMP IFLD_GetPropList(PIFLD pifld, ULONG ulFlags, LPSPropTagArray *pptaga)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIProp_GetPropList);
    ...
    ULONG ulInterfaceOptions, ULONG ulFlags, LPUNKNOWN *lppUnk)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIProp_OpenProperty);
...
{
    LPMESSAGE lpmsgNew;         /* new instance of property message */
    HRESULT hr;

    FLD_ValidateParameters(pifld, IMAPIProp_SetProps);
    ...
    LPSPropProblemArray *ppErr)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIProp_DeleteProps);
    ...
    LPSPropProblemArray *pprba)
{
    ...
    FLD_ValidateParameters(pifldSrc, IMAPIProp_CopyTo);
    ...
    LPSPropProblemArray *pprba)
{
    ...
    FLD_ValidateParameters(pifldSrc, IMAPIProp_CopyProps);
    ...
    LPMAPITABLE *lppTable)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIContainer_GetContentsTable);
    ...
    /* get the sort order from the PR_CONTENTS_SORT_ORDER property */
    ...
    LPMAPITABLE *lppTable)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIContainer_GetHierarchyTable);
    ...
    LPMESSAGE *lppMessage)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_CreateMessage);
    ...
    LPMAPIPROGRESS lpProgress, ULONG ulFlags)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_CopyMessages);
    ...
    ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_DeleteMessages);
    ...
    LPSTR szComment, LPCIID piid, ULONG ulFlags, LPMAPIFOLDER *lppfolder)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_CreateFolder);
    ...
    ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_CopyFolder);
    ...
    ULONG ulFlags)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_DeleteFolder);
    ...
    ULONG ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_SetReadFlags);
    ...
    LPENTRYID lpEntryID, ULONG ulFlags, ULONG *lpulMessageStatus)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_GetMessageStatus);
    ...
    ULONG *lpulOldStatus)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_SetMessageStatus);
    ...
    ULONG ulFlags)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_SaveContentsSort);
    ...
    pval.ulPropTag = PR_CONTENTS_SORT_ORDER;
    ...
    LPMAPIPROGRESS lpProgress, ULONG ulFlags)
{
    ...
    FLD_ValidateParameters(pifld, IMAPIFolder_EmptyFolder);
