...
#define EECBGV_BUILDVERSION_MAJOR       (0x00040000)
...
#define EECONTEXT_PROPERTYSHEETS        (0x0000000D)
#define EECONTEXT_ADVANCEDCRITERIA      (0x0000000E)
...
DECLARE_INTERFACE_(IExchExtMessageEvents, IUnknown)
{
    ...
    STDMETHOD(OnReadComplete)(THIS_ LPEXCHEXTCALLBACK lpmecb, 
                              ULONG ulFlags) PURE;
    STDMETHOD(OnWrite)(THIS_ LPEXCHEXTCALLBACK lpmecb) PURE;
    STDMETHOD(OnWriteComplete)(THIS_ LPEXCHEXTCALLBACK lpmecb, 
                               ULONG ulFlags) PURE;
    STDMETHOD(OnCheckNames)(THIS_ LPEXCHEXTCALLBACK lpmecb) PURE;
    STDMETHOD(OnCheckNamesComplete)(THIS_ LPEXCHEXTCALLBACK lpmecb, 
                                    ULONG ulFlags) PURE;
    STDMETHOD(OnSubmit)(THIS_ LPEXCHEXTCALLBACK lpmecb) PURE;
    STDMETHOD_(VOID, OnSubmitComplete)(THIS_ LPEXCHEXTCALLBACK lpmecb, 
                                       ULONG ulFlags) PURE;
};
