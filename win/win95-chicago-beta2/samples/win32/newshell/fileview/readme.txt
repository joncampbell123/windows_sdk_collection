...
If you build the sample viewer and register it via the FILEVIEW.REG file,
you will be able to use the sample viewer. You can build the sample by
using Visual C++ 2.0 and the makefile, FILEVIEW.MAK. Be aware that
the sample built produces a DLL. Once this DLL is registered, clicking
with the right mouse button on one of the CPP files will display a context menu.
Within this context menu, you will see the "QuickView" option. If you
click on this menu item, the sample file viewer will be invoked.
