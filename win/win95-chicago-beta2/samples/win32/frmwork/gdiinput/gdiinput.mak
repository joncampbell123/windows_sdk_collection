...
!MESSAGE 
!MESSAGE NMAKE /f "GDIINPUT.MAK" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/GDIINPUT.exe $(OUTDIR)/GDIINPUT.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"GDIINPUT.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"GDIINPUT.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"GDIINPUT.bsc" 
BSC32_SBRS= \
	$(INTDIR)/MISC.SBR \
	$(INTDIR)/WINMAIN.SBR \
	$(INTDIR)/STATBAR.SBR \
...
$(OUTDIR)/GDIINPUT.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 version.lib /NOLOGO /INCREMENTAL:no /PDB:$(OUTDIR)/"GDIINPUT.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"GDIINPUT.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/MISC.OBJ \
	$(INTDIR)/GDIINPUT.res \
...
$(OUTDIR)/GDIINPUT.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"GDIINPUT.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"GDIINPUT.pdb" /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"GDIINPUT.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"GDIINPUT.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib\
 version.lib /NOLOGO /INCREMENTAL:yes /PDB:$(OUTDIR)/"GDIINPUT.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"GDIINPUT.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/MISC.OBJ \
	$(INTDIR)/GDIINPUT.res \
...
$(INTDIR)/GDIINPUT.res :  $(SOURCE)  $(DEP_GDIIN) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/GDIINPUT.OBJ :  $(SOURCE)  $(DEP_GDIINP) $(INTDIR)
