...
!MESSAGE 
!MESSAGE NMAKE /f "MULTIPAD.MAK" CFG="Win32 Debug"
!MESSAGE 
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"MULTIPAD.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 version.lib /NOLOGO /INCREMENTAL:no /PDB:$(OUTDIR)/"MULTIPAD.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"MULTIPAD.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/DISPATCH.OBJ \
	$(INTDIR)/TOOLBAR.OBJ \
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"MULTIPAD.pch" /Fo$(INTDIR)/\
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib\
 version.lib /NOLOGO /INCREMENTAL:yes /PDB:$(OUTDIR)/"MULTIPAD.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"MULTIPAD.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/DISPATCH.OBJ \
	$(INTDIR)/TOOLBAR.OBJ \
...
$(INTDIR)/PRINT.OBJ :  $(SOURCE)  $(DEP_PRINT_) $(INTDIR)
...
$(INTDIR)/MULTIPAD.res :  $(SOURCE)  $(DEP_MULTI) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
$(INTDIR)/MULTIPAD.OBJ :  $(SOURCE)  $(DEP_MULTIP) $(INTDIR)
