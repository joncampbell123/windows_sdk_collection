...
STDMETHODIMP CSimpleApp::QueryInterface(REFIID riid, LPVOID* ppv)
{
    ...
    *ppv = NULL;        // must set out pointer parameters to NULL
    ...
    {
        OutputDebugString(TEXT("IUnknown"));
        *ppv = (LPUNKNOWN)this;
    }
    ...
    {
        OutputDebugString(TEXT("IOleWindow"));
    ...
    {
        OutputDebugString(TEXT("IOleInPlaceUIWindow"));
    ...
    {
        OutputDebugString(TEXT("IOleInPlaceFrame"));
        *ppv = (LPOLEINPLACEFRAME)this;
    }
    else
        OutputDebugString(TEXT("unsupported interface"));
