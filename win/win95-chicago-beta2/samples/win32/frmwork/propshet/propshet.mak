...
!MESSAGE 
!MESSAGE NMAKE /f "PROPSHET.MAK" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/PROPSHET.exe $(OUTDIR)/PROPSHET.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"PROPSHET.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x1 /d "NDEBUG" /d "_AFXDLL"
# ADD RSC /l 0x1 /d "NDEBUG"
RSC_PROJ=/l 0x1 /fo$(INTDIR)/"PROPSHET.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
# SUBTRACT BSC32 /Iu
BSC32_FLAGS=/nologo /o$(OUTDIR)/"PROPSHET.bsc" 
BSC32_SBRS= \
	$(INTDIR)/WINMAIN.SBR \
	$(INTDIR)/ABOUT.SBR \
	$(INTDIR)/MISC.SBR \
...
$(OUTDIR)/PROPSHET.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib version.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /NOLOGO /MACHINE:I386 /SUBSYSTEM:windows,4.0
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib version.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /NOLOGO\
 /INCREMENTAL:no /PDB:$(OUTDIR)/"PROPSHET.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"PROPSHET.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/WINMAIN.OBJ \
	$(INTDIR)/ABOUT.OBJ \
...
$(OUTDIR)/PROPSHET.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D\
 "WIN32" /FR$(INTDIR)/ /Fp$(OUTDIR)/"PROPSHET.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"PROPSHET.pdb" /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x1 /d "_DEBUG" /d "_AFXDLL"
# ADD RSC /l 0x1 /d "_DEBUG"
RSC_PROJ=/l 0x1 /fo$(INTDIR)/"PROPSHET.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# SUBTRACT BASE BSC32 /Iu
# ADD BSC32 /nologo
...
# ADD LINK32 user32.lib gdi32.lib winspool.lib version.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /NOLOGO /DEBUG /MACHINE:I386 /SUBSYSTEM:windows,4.0
LINK32_FLAGS=user32.lib gdi32.lib winspool.lib version.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /NOLOGO\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"PROPSHET.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"PROPSHET.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/WINMAIN.OBJ \
...
$(INTDIR)/PROPSHET.res :  $(SOURCE)  $(DEP_PROPSH) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
