...
!MESSAGE 
!MESSAGE NMAKE /f "initree.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/initree.exe $(OUTDIR)/initree.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"initree.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"INITREE.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"initree.bsc" 
BSC32_SBRS= \
	$(INTDIR)/DISPATCH.SBR \
	$(INTDIR)/ABOUT.SBR \
	$(INTDIR)/INIT.SBR \
...
$(OUTDIR)/initree.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 version.lib /NOLOGO /INCREMENTAL:no /PDB:$(OUTDIR)/"initree.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"initree.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/DISPATCH.OBJ \
	$(INTDIR)/ABOUT.OBJ \
...
$(OUTDIR)/initree.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"initree.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"initree.pdb" /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"INITREE.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"initree.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib\
 version.lib /NOLOGO /INCREMENTAL:yes /PDB:$(OUTDIR)/"initree.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"initree.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/DISPATCH.OBJ \
	$(INTDIR)/ABOUT.OBJ \
...
$(INTDIR)/INITREE.OBJ :  $(SOURCE)  $(DEP_INITR) $(INTDIR)
...
$(INTDIR)/INI.OBJ :  $(SOURCE)  $(DEP_INI_C) $(INTDIR)
...
$(INTDIR)/INITREE.res :  $(SOURCE)  $(DEP_INITRE) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
