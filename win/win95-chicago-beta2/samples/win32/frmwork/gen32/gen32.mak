...
!MESSAGE 
!MESSAGE NMAKE /f "GEN32.MAK" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/GEN32.exe $(OUTDIR)/GEN32.bsc
...
CPP_PROJ=/nologo /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"GEN32.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"GEN32.bsc" 
BSC32_SBRS= \
	$(INTDIR)/DISPATCH.SBR \
	$(INTDIR)/ABOUT.SBR \
	$(INTDIR)/GENERIC.SBR \
...
$(OUTDIR)/GEN32.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /INCREMENTAL:no /PDB:$(OUTDIR)/"GEN32.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"GEN32.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/DISPATCH.OBJ \
	$(INTDIR)/ABOUT.OBJ \
...
$(OUTDIR)/GEN32.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"GEN32.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"GEN32.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib version.lib /NOLOGO\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"GEN32.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"GEN32.exe" /SUBSYSTEM:windows,4.0  
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/DISPATCH.OBJ \
