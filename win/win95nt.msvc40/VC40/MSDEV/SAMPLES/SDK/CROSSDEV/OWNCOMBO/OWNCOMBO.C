    ...
    )
{
    ...
    // Change About to About Generic on Apple Menu
	{
		...
		ModifyMenu(hmenuSys, 0, MF_BYPOSITION, IDM_ABOUT, "About OwnCombo...");
    }
#endif
 ...
 *                                                                          *
 ****************************************************************************/
BOOL OwnComboInit (HANDLE hInstance)
{
    HANDLE     hMemory;
    PWNDCLASS  pWndClass;
    BOOL       bSuccess;
    ...
    pWndClass->hIcon         = LoadIcon (hInstance, MAKEINTRESOURCE(IDR_OWNCOMBO));
    pWndClass->hCursor       = LoadCursor (NULL, IDC_ARROW);
    pWndClass->hbrBackground = GetStockObject (WHITE_BRUSH);
    pWndClass->lpszMenuName  = MAKEINTRESOURCE(IDR_OWNCOMBO);
...
#ifdef _MAC
		case WM_INITDIALOG:
			EnableWindow(GetDlgItem(hDlg, ID_CBDIRBUTTON) , FALSE);
			break;
#endif
        case WM_COMMAND:
            switch (LOWORD(wParam)){
 ...
 *                                                                          *
 ****************************************************************************/
BOOL CALLBACK OwnerComboBoxExample (
    HWND       hDlg,
    UINT       message,
    WPARAM     wParam,
    LPARAM     lParam)
