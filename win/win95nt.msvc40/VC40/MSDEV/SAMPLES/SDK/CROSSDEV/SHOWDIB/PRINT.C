...
BOOL APIENTRY PrintDlgProc (HWND, WORD, WPARAM, LPARAM);
...
/****************************************************************************
 *                                                                          *
 *  FUNCTION   :PrintDlgProc (HWND, WORD , WPARAM , LPARAM )                *
 *                                                                          *
 *  PURPOSE    :Dialog function for the "Cancel Printing" dialog. It sets   *
 *              the abort flag if the user presses <Cancel>.                *
 *                                                                          *
 ****************************************************************************/
BOOL APIENTRY PrintDlgProc (HWND hDlg, WORD iMessage, WPARAM wParam, LPARAM lParam)
{
    switch (iMessage) {
    case WM_INITDIALOG:
#if !defined(_MAC)
