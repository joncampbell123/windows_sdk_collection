...
resource 'SDIB' (0)
{
	"ShowDIB Sample Application. Copyright 1994 - 1995 Microsoft Corp."
};

resource 'FREF' (IDI_SHOWICON)
{
	'APPL', 0, "";
};

resource 'FREF' (IDI_DIB_ICON)
{
	'DIB ', 1, "";
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft ShowDIB "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft ShowDIB "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft ShowDIB"
...
resource 'STR ' (500)
{
	"This is the Win32 ShowDIB sample application "
...
/*
REVIEW:  size configurations.  should have a different size for
			version that uses WLM DLL
*/
#ifdef _MPPC_
	2500 * 1024,
	2500 * 1024
