...
resource 'SMNU' (0)
{
	"Menu Sample Application. Copyright Microsoft Corp. 1994-1995"
};

resource 'FREF' (IDR_MENU)
{
	'APPL', 0, "";
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft Menu "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft Menu "
                "Sample Application."
            },
            ...
            {
                "This is not parth of the Microsoft Menu"
...
resource 'STR ' (500)
{
	"This is the Windows32 Menu sample application "
