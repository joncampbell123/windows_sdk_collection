...
/****************************************************************************
 *                                                                          *
 *  FUNCTION   : AddFile (lpPath, lpName)                                   *
 *                                                                          *
...
INT LoadFile(HWND hwnd, CHAR * pName)
{
    LONG   wLength;
    HANDLE hT;
    LPSTR  lpB;
...
VOID MyReadFile(HWND hwnd)
{
    CHAR    szPath[MAXFILENAME];
...
VOID SetSaveFrom (HWND hwnd, PSTR psz)
{
    CHAR szFmt[32];
    CHAR szText[160];
