...
resource 'HOOK' (0)
{
	"HookTest Sample Application. Copyright Microsoft Corp. 1994-1995"
};

resource 'FREF' (IDI_HOOKTEST)
{
	'APPL', 0, "";
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft HookTest "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft HookTest "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft HookTest"
...
resource 'STR ' (500)
{
	"This is the Windows32 HookTest sample application "
