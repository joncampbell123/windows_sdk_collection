...
//
// TEMPORARY FIX to resolve build problems of 6/9: validate entire heap, not just individual block.
//
// Global heap validation is TOO SLOW! Removed as of 6/12 - JWM
//      return HeapValidate( _crtheap, 0, 0 );
// Instead ...
        return TRUE;
