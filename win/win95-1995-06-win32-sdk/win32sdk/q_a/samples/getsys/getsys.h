...
LookupEntry  SysColors[NSYSCOLORS] =
    {{ COLOR_SCROLLBAR          , "COLOR_SCROLLBAR           %06lx"},
     { COLOR_BACKGROUND         , "COLOR_BACKGROUND          %06lx"},
     { COLOR_ACTIVECAPTION      , "COLOR_ACTIVECAPTION       %06lx"},
     { COLOR_INACTIVECAPTION    , "COLOR_INACTIVECAPTION     %06lx"},
     { COLOR_MENU               , "COLOR_MENU                %06lx"},
     { COLOR_WINDOW             , "COLOR_WINDOW              %06lx"},
     { COLOR_WINDOWFRAME        , "COLOR_WINDOWFRAME         %06lx"},
     { COLOR_MENUTEXT           , "COLOR_MENUTEXT            %06lx"},
     { COLOR_WINDOWTEXT         , "COLOR_WINDOWTEXT          %06lx"},
     { COLOR_CAPTIONTEXT        , "COLOR_CAPTIONTEXT         %06lx"},
     { COLOR_ACTIVEBORDER       , "COLOR_ACTIVEBORDER        %06lx"},
     { COLOR_INACTIVEBORDER     , "COLOR_INACTIVEBORDER      %06lx"},
     { COLOR_APPWORKSPACE       , "COLOR_APPWORKSPACE        %06lx"},
     { COLOR_HIGHLIGHT          , "COLOR_HIGHLIGHT           %06lx"},
     { COLOR_HIGHLIGHTTEXT      , "COLOR_HIGHLIGHTTEXT       %06lx"},
     { COLOR_BTNFACE            , "COLOR_BTNFACE             %06lx"},
     { COLOR_BTNSHADOW          , "COLOR_BTNSHADOW           %06lx"},
     { COLOR_GRAYTEXT           , "COLOR_GRAYTEXT            %06lx"},
     { COLOR_BTNTEXT            , "COLOR_BTNTEXT             %06lx"},
     { COLOR_INACTIVECAPTIONTEXT, "COLOR_INACTIVECAPTIONTEXT %06lx"},
     { COLOR_BTNHIGHLIGHT       , "COLOR_BTNHIGHLIGHT        %06lx"}};
