...
// Undefine XVPORT in order to remove dependency.
#define XVPORT
...
public:
    ...
    virtual void OnCallFunction()   = 0;
    virtual void OnSpecialProps()   = 0;
    virtual void OnPropInterface()  = 0;
