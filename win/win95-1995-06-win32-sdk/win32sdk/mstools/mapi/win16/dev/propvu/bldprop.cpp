...
void CBldPropDlg::SelectNewPropType(ULONG ulSelectedType)
{
    ...
    switch(ulSelectedType)
    {
        ...
        case PT_SYSTIME:
            wsprintf(szDataItemDisplay,"Prop Data: PT_SYSTEMTIME, Enter Y/M/D Hr:Min:Sec ex. 1995/02/08 17:55:27");                                                                                                    
            break;
        ...
        case PT_MV_SYSTIME:
            wsprintf(szDataItemDisplay,"Prop Data: PT_MV_SYSTIME, Enter cVals: Val1; Val2; Val3 Ex. 1: 1995/2/2 1:12:30 ;");
            break;
