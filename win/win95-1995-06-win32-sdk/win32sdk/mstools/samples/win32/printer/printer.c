  ...
  switch (msg)
  {
    case WM_COMMAND:
      ...
      switch (LOWORD (wParam))
      {
        ...
        case IDM_BRUSHSTYLE_SOLIDCLR:
        case IDM_BRUSHSTYLE_DITHEREDCLR:
        case IDM_BRUSHSTYLE_SOLIDTEXTCLR:
        case IDM_BRUSHSTYLE_DITHEREDTEXTCLR:
        case IDM_BRUSHSTYLE_SOLIDBKCLR:
        case IDM_BRUSHSTYLE_DITHEREDBKCLR:
