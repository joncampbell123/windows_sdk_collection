...
typedef IPolylineAdviseSink4 *PPOLYLINEADVISESINK;
...
DECLARE_INTERFACE_(IPolyline4, IUnknown)
    ...
    STDMETHOD(ReadFromFile) (THIS_ LPTSTR) PURE;
    STDMETHOD(WriteToFile)  (THIS_ LPTSTR) PURE;
