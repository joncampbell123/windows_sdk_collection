...
new Windows 95 and Windows NT controls and API's.  It is 
designed to help both the novice and advanced Windows 
programmers.
...
and MENU95) that do not derive from Generic.
...
MENU95*  - Show several ways of using and manipulating
...
THUNKS95*- Shows how to use the Thunk Compiler.  Basic thunking
           scripts are provided.
WRITEPAD - Multipad like sample that uses the RTF edit control.

* - These samples use several API's specific to Windows 95 and
