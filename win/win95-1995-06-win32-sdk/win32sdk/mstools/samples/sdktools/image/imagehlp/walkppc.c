    ...
    )
{
    ...
    if (StackFrame->AddrFrame.Offset) {
        if (ReadMemory( hProcess,
            ...
            Context->Gpr10 = ContextSwapFrame.ExceptionFrame.Gpr20;
            Context->Gpr11 = ContextSwapFrame.ExceptionFrame.Gpr21;
            Context->Gpr12 = ContextSwapFrame.ExceptionFrame.Gpr22;
            Context->Gpr13 = ContextSwapFrame.ExceptionFrame.Gpr23;
            Context->Gpr14 = ContextSwapFrame.ExceptionFrame.Gpr24;
