...
typedef DWORD (__stdcall *PSYM_MODULE_CALLBACK)(HANDLE,PSTR,PSTR,ULONG,ULONG);
typedef BOOL  (__stdcall *PSYM_GETMODULES_CALLBACK)(HANDLE,PSYM_MODULE_CALLBACK);
typedef BOOL  (__stdcall *PSYM_ENUMMODULES_CALLBACK)(LPSTR,ULONG);
typedef BOOL  (__stdcall *PSYM_ENUMSYMBOLS_CALLBACK)(LPSTR,ULONG,ULONG);
...
typedef struct _IMAGEHLP_SYMBOL {
    struct _IMAGEHLP_SYMBOL     *next;
    struct _IMAGEHLP_SYMBOL     *prev;
    DWORD                       size;
    DWORD                       flags;
    DWORD                       addr;
    CHAR                        szName[1];
