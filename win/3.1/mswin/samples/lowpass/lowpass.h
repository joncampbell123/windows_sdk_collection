...
int PASCAL WinMain(HINSTANCE hInst, HINSTANCE hPrev, LPSTR lpszCmdLine,
    int iCmdShow);
BOOL FAR PASCAL AboutDlgProc(HWND hwnd, unsigned wMsg,
    WORD wParam, LONG lParam);
BOOL FAR PASCAL LowPassDlgProc(HWND hwnd, unsigned wMsg,
    WORD wParam, LONG lParam);
