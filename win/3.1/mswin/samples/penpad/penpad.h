...
/* resource ID's */
#define IDPENPAD  ID(1)
#define IDPENPAD2 ID(3)
#define IDNOTE    ID(2)
...
extern FARPROC lpfnFakeProc;	/* subclassed window procedure		  */
...
extern short FAR CDECL PPError(HWND,WORD,WORD,...);
extern VOID FAR PASCAL Find(void);
extern VOID FAR PASCAL FindNext(void);
extern VOID FAR PASCAL FindPrev(void);
extern VOID FAR PASCAL PPSpotHelp(HWND,POINT);
extern LONG FAR PASCAL PPFrameWndProc(HWND,UINT,WPARAM,LPARAM);
extern LONG FAR PASCAL PPMDIChildWndProc(HWND,UINT,WPARAM,LPARAM);
...
extern LONG FAR PASCAL FakeProc(HWND,WORD,WORD,LONG);
