...
// Version 3.10.062 Modified to be greater than the version (3.10.061)
...
//              to "StringFileInfo" and International block in finstall.rcv.
//              Moved finstall.rcv from ink subdirectory to rc subdirectory.
// Version 3.10.130 Modified to display a nice number 1.30 and so internal
//              number tracks external version number

/* Font Installer version that appears in the About box */
#define VERS    "Version 1.30"
                               
/* Version in RCS under which files will be checked in  */
#define RCS_VERSION  1.256
