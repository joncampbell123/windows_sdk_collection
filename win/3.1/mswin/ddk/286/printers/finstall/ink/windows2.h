...
/*  Face Numbers
*/
#define FF_DECORATIVE ((5<<4)|1)
#define FF_DONTCARE ((0<<4)|1)
#define FF_MODERN (3<<4)
#define FF_ROMAN ((1<<4)|1)
#define FF_SCRIPT ((4<<4)|1)
#define FF_SWISS ((2<<4)|1)
...
//#define WNFRSTCHAR   0        /* first char for WN set   */
//#define LASTCHAR     255      /* last char for all sets  */
#define PTPIN        72.31      /* pts per inch         */
#define PTPINN       7231       /* pts per inch numerator   */
#define PTPIND       100        /* pts per inch denominator */
