; 'kbdpo.asm' Windows 3.00 keyboard table file based on:
...
PatchATran3 label word
	...
	db	-1,	-1	; VK_OEM_1    
	db	'<',	'>'	; VK_OEM_2    
	db	0e7h,	0c7h	; VK_OEM_3    
	db	027h,	'?'	; VK_OEM_4    
	; Unshifted is dead key
	; Shifted is dead key
	db	-1,	-1	; VK_OEM_5    
	db	0abh,	0bbh	; VK_OEM_6    
	db	0bah,	0aah	; VK_OEM_7    
	db	-1,	-1	; VK_OEM_8    
	db	-1,	-1	; VK_OEM_102
	db	'.',	'.'	; VK_DECIMAL
...
ifdef ATSAME
	...
	ktrans	VK_OEM_PLUS ,	01bh,	VKFLAG
...
ifdef ATSAME
	...
	deadtrans	VK_OEM_5    ,	1,	circumflex,	VKFLAG
	deadtrans	VK_OEM_5    ,	0,	tilde,	VKFLAG
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_3    ,	0e7h,	0c7h,	VKFLAG
	ktrans2	VK_OEM_4    ,	027h,	'?',	VKFLAG
	ktrans2	VK_OEM_5    ,	'\',	'|',	VKFLAG
	ktrans2	VK_OEM_6    ,	0abh,	0bbh,	VKFLAG
	ktrans2	VK_OEM_7    ,	0bah,	0aah,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_1    ,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_1    ,	1,	grave,	VKFLAG
	deadtrans	VK_OEM_2    ,	1,	circumflex,	VKFLAG
	deadtrans	VK_OEM_PLUS ,	6,	umlaut,	VKFLAG
	deadtrans	VK_OEM_PLUS ,	7,	umlaut,	VKFLAG
	deadtrans	VK_OEM_2    ,	0,	tilde,	VKFLAG
