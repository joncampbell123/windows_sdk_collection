; 'kbdsg.asm' Windows 3.00 keyboard table file based on:
...
PatchATran3 label word
	...
	db	'-',	'_'	; VK_OEM_MINUS
	db	-1,	-1	; VK_OEM_PLUS 
	db	0fch,	0e8h	; VK_OEM_1    
	db	'$',	0a3h	; VK_OEM_2    
	; Unshifted is dead key
	db	-1,	'!'	; VK_OEM_3    
	db	027h,	'?'	; VK_OEM_4    
	db	0e4h,	0e0h	; VK_OEM_5    
	; Unshifted is dead key
	; Shifted is dead key
	db	-1,	-1	; VK_OEM_6    
	db	0f6h,	0e9h	; VK_OEM_7    
	db	'<',	'>'	; VK_OEM_8    
	db	-1,	-1	; VK_OEM_102
	db	'.',	'.'	; VK_DECIMAL
...
PatchATran5 label word
	...
	db	'-',	'_'	; VK_OEM_MINUS
	db	'+',	'*'	; VK_OEM_PLUS 
	db	0fch,	0dch	; VK_OEM_1    
	db	'#',	'^'	; VK_OEM_2    
	db	0f6h,	0d6h	; VK_OEM_3    
	db	0dfh,	'?'	; VK_OEM_4    
	db	'^',	0b0h	; VK_OEM_5    
	; Unshifted is dead key
	; Shifted is dead key
	db	-1,	-1	; VK_OEM_6    
	db	0e4h,	0c4h	; VK_OEM_7    
	db	-1,	-1	; VK_OEM_8    
	db	'<',	'>'	; VK_OEM_102
	db	'.',	'.'	; VK_DECIMAL
...
PatchATran6 label word
	...
	db	-1,	'!'	; VK_OEM_3    
	db	0dfh,	'?'	; VK_OEM_4    
	db	0e4h,	0c4h	; VK_OEM_5    
	; Unshifted is dead key
	; Shifted is dead key
	db	-1,	-1	; VK_OEM_6    
	db	0f6h,	0d6h	; VK_OEM_7    
	db	'<',	'>'	; VK_OEM_8    
	db	'#',	'@'	; VK_OEM_102
	db	'.',	'.'	; VK_DECIMAL
...
ifdef ATSAME
	...
	ktrans	VK_OEM_3    ,	01dh,	VKFLAG
	ktrans	VK_OEM_8    ,	01ch,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	ktrans	VK_OEM_PLUS ,	01dh,	VKFLAG
...
ifdef ATSAME
	...
	deadtrans	VK_OEM_4    ,	6,	acute,	VKFLAG
	deadtrans	VK_OEM_4    ,	7,	acute,	VKFLAG
	deadtrans	VK_OEM_6    ,	1,	grave,	VKFLAG
	deadtrans	VK_OEM_6    ,	0,	circumflex,	VKFLAG
	deadtrans	VK_OEM_3    ,	0,	umlaut,	VKFLAG
	deadtrans	VK_OEM_6    ,	6,	tilde,	VKFLAG
	deadtrans	VK_OEM_6    ,	7,	tilde,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_3    ,	1,	acute,	VKFLAG
	deadtrans	VK_OEM_6    ,	1,	grave,	VKFLAG
	deadtrans	VK_OEM_6    ,	0,	circumflex,	VKFLAG
	deadtrans	VK_OEM_3    ,	0,	umlaut,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_6    ,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_6    ,	1,	grave,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_6    ,	0,	circumflex,	VKFLAG
	deadtrans	VK_OEM_3    ,	0,	umlaut,	VKFLAG
	deadtrans	VK_OEM_6    ,	7,	acute,	VKFLAG
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_1    ,	0fch,	0e8h,	VKFLAG
	ktrans2	VK_OEM_2    ,	0a7h,	0b0h,	VKFLAG
	; Unshifted is dead key
	ktrans2	VK_OEM_3    ,	-1,	'!',	VKFLAG
	ktrans2	VK_OEM_4    ,	027h,	'?',	VKFLAG
	ktrans2	VK_OEM_5    ,	0e4h,	0e0h,	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
	ktrans2	VK_OEM_6    ,	-1,	-1,	VKFLAG
	ktrans2	VK_OEM_7    ,	0f6h,	0e9h,	VKFLAG
	ktrans2	VK_OEM_8    ,	'$',	0a3h,	VKFLAG
