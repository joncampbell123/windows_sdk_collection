; 'kbdfs.asm' Windows 3.00 keyboard table file based on:
...
; Translation tables for Swedish and Finnish keyboards (KBDSW.DLL,
; KBDFI.DLL).

; History
;	12 jan 90	peterbe		Added grave dead key VK_OEM_6, ICO 2.
...
if1
%out
%out .. KBDFS.ASM .. Finnish and Swedish
endif
...
; Patch Shift-Control-Alt table for type 2
	ktrans	VK_OEM_4    ,	'~',	VKFLAG
   ;;;;	ktrans	VK_OEM_6    ,	'`',	VKFLAG	;; DEAD KEY ;;
	ktrans	VK_OEM_1    ,	'{',	VKFLAG
	ktrans	VK_OEM_5    ,	'}',	VKFLAG
	ktrans	VK_OEM_2    ,	'|',	VKFLAG
...
ifdef ATSAME
	...
	deadtrans	VK_OEM_1    ,	0,	umlaut,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_6    ,	6,	acute,	VKFLAG
	deadtrans	VK_OEM_6    ,	7,	grave,	VKFLAG
	deadtrans	VK_OEM_1    ,	1,	circumflex,	VKFLAG
	deadtrans	VK_OEM_1    ,	0,	umlaut,	VKFLAG
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_2    ,	027h,	'*',	VKFLAG
	ktrans2	VK_OEM_3    ,	0f6h,	0d6h,	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
	ktrans2	VK_OEM_4    ,	-1,	-1,	VKFLAG
	ktrans2	VK_OEM_5    ,	0a7h,	0bdh,	VKFLAG
	ktrans2	VK_OEM_6    ,	0e5h,	0c5h,	VKFLAG
	ktrans2	VK_OEM_7    ,	0e4h,	0c4h,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_1    ,	1,	circumflex,	VKFLAG
	deadtrans	VK_OEM_1    ,	0,	umlaut,	VKFLAG
	deadtrans	VK_OEM_1    ,	6,	tilde,	VKFLAG
	deadtrans	VK_OEM_1    ,	7,	tilde,	VKFLAG
