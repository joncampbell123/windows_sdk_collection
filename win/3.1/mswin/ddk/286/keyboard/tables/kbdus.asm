; 'kbdus.asm' Windows 3.00 keyboard table file based on:
...
; USA keyboards.  This DLL is normally used only for types 2, 5, and 6
; keyboards, but may be used for IBM-compatible types 1,3, and 4.
