; 'kbdsp.asm' Windows 3.00 keyboard table file based on:
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_2    ,	0e7h,	0c7h,	VKFLAG
	ktrans2	VK_OEM_3    ,	0f1h,	0d1h,	VKFLAG
	ktrans2	VK_OEM_4    ,	027h,	'?',	VKFLAG
	ktrans2	VK_OEM_5    ,	0bah,	0aah,	VKFLAG
	ktrans2	VK_OEM_6    ,	0a1h,	0bfh,	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_1    ,	1,	circumflex,	VKFLAG
	deadtrans	VK_OEM_7    ,	1,	umlaut,	VKFLAG
