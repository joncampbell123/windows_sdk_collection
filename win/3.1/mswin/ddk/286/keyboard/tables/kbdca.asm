; 'kbdca.asm' Windows 3.00 keyboard table file based on:
...
; Canadian French IBM XT/AT/Enhanced keyboards
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_102,	0abh,	0bbh,	VKFLAG
