; 'kbdsf.asm' Windows 3.00 keyboard table file based on:
...
PatchATran3 label word
	...
	db	'-',	'_'	; VK_OEM_MINUS
	db	-1,	-1	; VK_OEM_PLUS 
	db	0e8h,	0fch	; VK_OEM_1    
	db	'$',	0a3h	; VK_OEM_2    
	; Unshifted is dead key
	db	-1,	'!'	; VK_OEM_3    
	db	027h,	'?'	; VK_OEM_4    
	db	0e0h,	0e4h	; VK_OEM_5    
	; Unshifted is dead key
	; Shifted is dead key
	db	-1,	-1	; VK_OEM_6    
	db	0e9h,	0f6h	; VK_OEM_7    
	db	'<',	'>'	; VK_OEM_8    
	db	-1,	-1	; VK_OEM_102
	db	'.',	'.'	; VK_DECIMAL
