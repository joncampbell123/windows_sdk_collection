; 'kbdgr.asm' Windows 3.00 keyboard table file based on:
...
ifdef ATSAME
	...
	ktrans	VK_OEM_5    ,	01eh,	VKFLAG
	ktrans	VK_OEM_8    ,	09eh,	VKFLAG
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_1    ,	0fch,	0dch,	VKFLAG
	ktrans2	VK_OEM_2    ,	'#',	027h,	VKFLAG
	ktrans2	VK_OEM_3    ,	0f6h,	0d6h,	VKFLAG
	ktrans2	VK_OEM_4    ,	0dfh,	'?',	VKFLAG
	; Unshifted is dead key
	ktrans2	VK_OEM_5    ,	-1,	0b0h,	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_6    ,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_6    ,	1,	grave,	VKFLAG
	deadtrans	VK_OEM_5    ,	0,	circumflex,	VKFLAG
