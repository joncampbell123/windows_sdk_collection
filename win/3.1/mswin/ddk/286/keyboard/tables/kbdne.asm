; 'kbdne.asm' Windows 3.00 keyboard table file based on:
...
; Netherlands enhanced keyboard.
; For types other than 4, this is same as USA

; History
;	08 jan 90	peterbe		Nokia ifdef
;	13 oct 89	peterbe		VK_DECIMAL translates to comma now.
...
IRP VKFLAG, <0, 1>
	...
	ktrans	VK_6      ,	09eh,	VKFLAG
	ktrans	VK_OEM_4    ,	01bh,	VKFLAG
	ktrans	VK_OEM_6    ,	01ch,	VKFLAG
	ktrans	VK_OEM_MINUS,	01fh,	VKFLAG
	ktrans	VK_OEM_102,	01dh,	VKFLAG
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_PLUS ,	'+',	0b1h,	VKFLAG
	ktrans2	VK_OEM_1    ,	'*',	'|',	VKFLAG
	; Shifted is dead key
	ktrans2	VK_OEM_2    ,	0b0h,	-1,	VKFLAG
    ...
    ; Dutch, German) translates to comma.
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_2    ,	1,	tilde,	VKFLAG
	deadtrans	VK_OEM_2    ,	6,	cedilla,	VKFLAG
	deadtrans	VK_OEM_2    ,	7,	cedilla,	VKFLAG
