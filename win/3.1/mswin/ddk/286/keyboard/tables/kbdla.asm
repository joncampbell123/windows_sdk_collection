; 'kbdla.asm' Windows 3.00 keyboard table file based on:
;  'sp1.wk2', 'sp2.wk2', 'sp1.wk2', 'la4.wk2', 'sp5.wk2', 'sp6.wk2'

; ********************************************************
; Copyright (C) 1989-1990 by Microsoft Corporation.
; ********************************************************

; Latin-American Spanish enhanced keyboards.
...
if1
%out
%out .. KBDLA.ASM .. Latin-American enhanced
endif
...
IRP VKFLAG, <0, 1>
	...
	ktrans	VK_6      ,	09eh,	VKFLAG
	ktrans	VK_OEM_1    ,	01bh,	VKFLAG
	ktrans	VK_OEM_2    ,	01ch,	VKFLAG
	ktrans	VK_OEM_4    ,	01fh,	VKFLAG
	ktrans	VK_OEM_MINUS,	01fh,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_6    ,	0,	grave,	VKFLAG
	deadtrans	VK_OEM_6    ,	1,	circumflex,	VKFLAG
	deadtrans	VK_OEM_6    ,	6,	umlaut,	VKFLAG
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_4    ,	027h,	'?',	VKFLAG
	ktrans2	VK_OEM_5    ,	'|',	0b0h,	VKFLAG
	ktrans2	VK_OEM_6    ,	0bfh,	0a1h,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_1    ,	0,	acute,	VKFLAG
	...
	deadtrans	VK_OEM_1    ,	1,	umlaut,	VKFLAG
...
;;	ktrans	VK_EXECUTE,	0ah,	VKFLAG
	...
	ktrans	VK_6      ,	09eh,	VKFLAG
	ktrans	VK_OEM_2    ,	01dh,	VKFLAG
	ktrans	VK_OEM_4    ,	01ch,	VKFLAG
	ktrans	VK_OEM_7    ,	01bh,	VKFLAG
	ktrans	VK_OEM_MINUS,	01fh,	VKFLAG
