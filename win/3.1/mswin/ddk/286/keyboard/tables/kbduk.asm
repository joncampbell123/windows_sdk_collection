; 'kbduk.asm' Windows 3.00 keyboard table file based on:
...
; United Kingdom (and Ireland, etc.) keyboards

; History
;	08 jan 90	peterbe		Nokia ifdef
;	06 sep 89	peterbe		Commented out VK_EXECUTE translation.
;	21 aug 89	peterbe		Add some acute accents (AltGr)
