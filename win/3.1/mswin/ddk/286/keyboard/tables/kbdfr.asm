; 'kbdfr.asm' Windows 3.00 keyboard table file based on:
...
;;	ktrans	VK_EXECUTE,	0ah,	VKFLAG
	...
	ktrans	VK_0      ,	00h,	VKFLAG
	ktrans	VK_5      ,	09bh,	VKFLAG
	ktrans	VK_6      ,	09fh,	VKFLAG
	ktrans	VK_8      ,	09ch,	VKFLAG
	ktrans	VK_9      ,	09eh,	VKFLAG
	ktrans	VK_OEM_1    ,	01dh,	VKFLAG
	ktrans	VK_OEM_5    ,	01ch,	VKFLAG
	ktrans	VK_OEM_6    ,	01bh,	VKFLAG
	ktrans	VK_OEM_102,	01ch,	VKFLAG
