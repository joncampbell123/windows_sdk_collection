; 'kbdes.asm' Windows 3.00 keyboard table file based on:
;  'sp1.wk2', 'es2.wk2', 'es3.wk2', 'es4.wk2', 'sp5.wk2', 'sp6.wk2'

; ********************************************************
; Copyright (C) 1989-1990 by Microsoft Corporation.
; ********************************************************

; Olivetti Spain I keyboards
...
umlaut		equ	0a8h	    ; intl fix, bug # 10801
acute		equ	0b4h
grave		equ	060h
circumflex	equ	'^'
tilde		equ	'~'
...
if1
%out
%out .. KBDES.ASM: Olivetti Spain I
endif
...
; Patch Control-Alt table for type 3
	ktrans	VK_1      ,	0bah,	VKFLAG
	ktrans	VK_4      ,	0bch,	VKFLAG
	ktrans	VK_5      ,	0bdh,	VKFLAG
	ktrans	VK_7      ,	'_',	VKFLAG
	ktrans	VK_8      ,	'#',	VKFLAG
	ktrans	VK_9      ,	0a7h,	VKFLAG
	ktrans	VK_0      ,	'\',	VKFLAG
	ktrans	VK_OEM_MINUS,	'*',	VKFLAG
	ktrans	VK_A      ,	'$',	VKFLAG
	ktrans	VK_S      ,	'&',	VKFLAG
	ktrans	VK_D      ,	'@',	VKFLAG
	ktrans	VK_F      ,	'[',	VKFLAG
	ktrans	VK_G      ,	']',	VKFLAG
	ktrans	VK_H      ,	'|',	VKFLAG
	ktrans	VK_J      ,	0a3h,	VKFLAG
	ktrans	VK_K      ,	0b1h,	VKFLAG
	ktrans	VK_OEM_3    ,	'~',	VKFLAG
	ktrans	VK_OEM_7    ,	0b0h,	VKFLAG
	ktrans	VK_Z      ,	'{',	VKFLAG
	ktrans	VK_X      ,	'}',	VKFLAG
	ktrans	VK_OEM_PERIOD,	'^',	VKFLAG
	ktrans	VK_OEM_8    ,	027h,	VKFLAG
...
ifdef ATSAME
	...
	deadtrans	VK_OEM_4    ,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_6    ,	0,	grave,	VKFLAG
	deadtrans	VK_OEM_6    ,	1,	circumflex,	VKFLAG
	deadtrans	VK_OEM_4    ,	1,	umlaut,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_5    ,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_5    ,	1,	acute,	VKFLAG
	deadtrans	VK_OEM_1    ,	0,	grave,	VKFLAG
	deadtrans	VK_OEM_1    ,	1,	grave,	VKFLAG
	deadtrans	VK_OEM_4    ,	0,	umlaut,	VKFLAG
	deadtrans	VK_OEM_4    ,	1,	umlaut,	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_3    ,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_4    ,	1,	grave,	VKFLAG
	deadtrans	VK_OEM_4    ,	7,	circumflex,	VKFLAG
	deadtrans	VK_OEM_6    ,	0,	umlaut,	VKFLAG
...
;	Variable entries in AscTab[]:
	ktrans2	VK_0      ,	'0',	'p',	VKFLAG
	ktrans2	VK_1      ,	'1',	0aah,	VKFLAG
	ktrans2	VK_2      ,	'2',	'"',	VKFLAG
	ktrans2	VK_3      ,	'3',	'/',	VKFLAG
	ktrans2	VK_4      ,	'4',	'(',	VKFLAG
	ktrans2	VK_5      ,	'5',	')',	VKFLAG
	ktrans2	VK_6      ,	'6',	0a1h,	VKFLAG
	ktrans2	VK_7      ,	'7',	'!',	VKFLAG
	ktrans2	VK_8      ,	'8',	0bfh,	VKFLAG
	ktrans2	VK_9      ,	'9',	'?',	VKFLAG
	ktrans2	VK_OEM_COMMA,	',',	';',	VKFLAG
	ktrans2	VK_OEM_PERIOD,	'.',	':',	VKFLAG
	ktrans2	VK_OEM_MINUS,	'-',	'+',	VKFLAG
	ktrans2	VK_OEM_PLUS ,	-1,	-1,	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
	ktrans2	VK_OEM_1    ,	-1,	-1,	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
	ktrans2	VK_OEM_2    ,	-1,	-1,	VKFLAG
	ktrans2	VK_OEM_3    ,	0f1h,	0d1h,	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
	ktrans2	VK_OEM_4    ,	-1,	-1,	VKFLAG
	ktrans2	VK_OEM_5    ,	027h,	0b7h,	VKFLAG
	ktrans2	VK_OEM_6    ,	0f7h,	0d7h,	VKFLAG
	ktrans2	VK_OEM_7    ,	0e7h,	0c7h,	VKFLAG
	ktrans2	VK_OEM_8    ,	'=',	'%',	VKFLAG
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_2    ,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_2    ,	1,	acute,	VKFLAG
	deadtrans	VK_OEM_1    ,	0,	grave,	VKFLAG
	deadtrans	VK_OEM_1    ,	1,	grave,	VKFLAG
	deadtrans	VK_OEM_4    ,	0,	umlaut,	VKFLAG
	deadtrans	VK_OEM_4    ,	1,	umlaut,	VKFLAG
