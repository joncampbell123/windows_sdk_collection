; 'kbdit.asm' Windows 3.00 keyboard table file based on:
...
PatchATran3 label word
	...
	db	'-',	'_'	; VK_OEM_MINUS
	db	'+',	'*'	; VK_OEM_PLUS 
	db	0e8h,	0e9h	; VK_OEM_1    
	db	'<',	'>'	; VK_OEM_2    
	db	0f2h,	'@'	; VK_OEM_3    
	db	027h,	'?'	; VK_OEM_4    
	db	0f9h,	0a7h	; VK_OEM_5    
	db	0ech,	'^'	; VK_OEM_6    
	db	0e0h,	'#'	; VK_OEM_7    
	db	-1,	-1	; VK_OEM_8    
	db	-1,	-1	; VK_OEM_102
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_1    ,	0e8h,	0e9h,	VKFLAG
	ktrans2	VK_OEM_2    ,	0f9h,	0a7h,	VKFLAG
	ktrans2	VK_OEM_3    ,	0f2h,	0e7h,	VKFLAG
	ktrans2	VK_OEM_4    ,	027h,	'?',	VKFLAG
	ktrans2	VK_OEM_5    ,	'\',	'|',	VKFLAG
	ktrans2	VK_OEM_6    ,	0ech,	'^',	VKFLAG
	ktrans2	VK_OEM_7    ,	0e0h,	0b0h,	VKFLAG
