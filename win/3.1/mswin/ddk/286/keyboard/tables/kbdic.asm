; 'kbdic.asm' Windows 3.00 keyboard table file based on:
;  'ic1.wk2', 'ic1.wk2', 'ic1.wk2', 'ic4.wk2', 'ic1.wk2', 'ic1.wk2'
...
;	15 dec 89	peterbe		Change tilde deadkey to ring.
...
DCIRCUMFLEX	equ	1
DUMLAUT		equ	1
DRING		equ	1	; special for Icelandic
	; No tilde deadkeys
	; No cedilla deadkeys
...
PatchATran3 label word
	...
	; Shifted is dead key
	db	-1,	-1	; VK_OEM_3
	db	0f0h,	0d0h	; VK_OEM_4
	db	0f6h,	0d6h	; VK_OEM_5
	db	0e6h,	0c6h	; VK_OEM_6
	db	0feh,	0deh	; VK_OEM_7
	db	-1,	-1	; VK_OEM_8
	db	-1,	-1	; VK_OEM_102
	db	'.',	'.'	; VK_DECIMAL
...
ifdef ATSAME
	...
	deadtrans	VK_OEM_3,	1,	umlaut,	VKFLAG
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_MINUS,	0feh,	0deh,	VKFLAG
	ktrans2	VK_OEM_PLUS ,	0f6h,	0d6h,	VKFLAG
	ktrans2	VK_OEM_1,	027h,	'?',	VKFLAG
	ktrans2	VK_OEM_2,	'+',	'*',	VKFLAG
	ktrans2	VK_OEM_3,	0e6h,	0c6h,	VKFLAG
	ktrans2	VK_OEM_4,	'-',	'_',	VKFLAG
	; Unshifted is dead key
	; Shifted is dead key
	ktrans2	VK_OEM_5,	-1,	-1,	VKFLAG
	ktrans2	VK_OEM_6,	0f0h,	0d0h,	VKFLAG
	; Unshifted is dead key
	ktrans2	VK_OEM_7,	-1,	027h,	VKFLAG
...
IRP VKFLAG, <0, 1>
    ...
    ifdef DRING	; special for Icelandic
	deadtrans	'a', ring,	229,	VKFLAG
	deadtrans	'A', ring,	197,	VKFLAG
	deadtrans	' ', ring,	ring,	VKFLAG
    endif
...
IRP VKFLAG, <0, 1>
	...
	deadtrans	VK_OEM_7,	0,	acute,	VKFLAG
	deadtrans	VK_OEM_7,	6,	circumflex,	VKFLAG
	deadtrans	VK_OEM_7,	7,	circumflex,	VKFLAG
	deadtrans	VK_OEM_5,	0,	ring,	VKFLAG	; ring deadkey
	deadtrans	VK_OEM_5,	1,	umlaut,	VKFLAG
	deadtrans	VK_OEM_2,	6,	grave,	VKFLAG
	deadtrans	VK_OEM_2,	7,	grave,	VKFLAG
