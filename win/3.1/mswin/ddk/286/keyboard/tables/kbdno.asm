; 'kbdno.asm' Windows 3.00 keyboard table file based on:
...
PatchATran3 label word
	...
	db	-1,	-1	; VK_OEM_1    
	db	'<',	'>'	; VK_OEM_2    
	db	0f8h,	0d8h	; VK_OEM_3    
	; Unshifted is dead key
	; Shifted is dead key
	db	-1,	-1	; VK_OEM_4    
	db	027h,	'*'	; VK_OEM_5    
	db	0e5h,	0c5h	; VK_OEM_6    
	db	0e6h,	0c6h	; VK_OEM_7    
	db	-1,	-1	; VK_OEM_8    
	db	-1,	-1	; VK_OEM_102
	db	'.',	'.'	; VK_DECIMAL
...
;	Variable entries in AscTab[]:
	...
	ktrans2	VK_OEM_3    ,	0f8h,	0d8h,	VKFLAG
	; Shifted is dead key
	ktrans2	VK_OEM_4    ,	'\',	-1,	VKFLAG
	ktrans2	VK_OEM_5    ,	'|',	0a7h,	VKFLAG
	ktrans2	VK_OEM_6    ,	0e5h,	0c5h,	VKFLAG
	ktrans2	VK_OEM_7    ,	0e6h,	0c6h,	VKFLAG
