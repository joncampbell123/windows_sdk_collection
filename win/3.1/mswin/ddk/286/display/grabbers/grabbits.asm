...
;
;       1.12    080989   ac     IFDEFed out portions which have changed or are
...
ENDIF	;GRAB_VER_2
        ifdef OLIVETTI
                extrn   DebGetBits:near
                extrn   DebRepMove:near
                extrn   fDeb:byte
        endif
...
gbInnerLoop0:
        ifdef OLIVETTI
                cmp     cs:[fDeb],0
                je      loadOK
                test    cs:[IC.icScrType],ST_SPECGRAB
                jz      loadOK
                call    DebGetBits
                jmp short checkbits
        endif
