...
dev_obwnc label word
	dw	rCodeOFFSET dev_obwnc_one_char
	dw	rCodeOFFSET dev_obwnc_two_char
	dw	rCodeOFFSET dev_obwnc_three_char
	dw	rCodeOFFSET dev_obwnc_four_char
;	dw	rCodeOFFSET dev_obwnc_n_char
;	dw	rCodeOFFSET dev_obwnc_n_char
;	dw	rCodeOFFSET dev_obwnc_n_char
;	dw	rCodeOFFSET dev_obwnc_n_char
	dw	rCodeOFFSET gen_nc_n_char
...
dev_tbnc label	word
	dw	rCodeOFFSET dev_tbnc_one_char
	dw	rCodeOFFSET dev_tbnc_two_char
	dw	rCodeOFFSET dev_tbnc_three_char
	dw	rCodeOFFSET dev_tbnc_four_char
;	dw	rCodeOFFSET dev_tbnc_n_char
;	dw	rCodeOFFSET dev_tbnc_n_char
;	dw	rCodeOFFSET dev_tbnc_n_char
;	dw	rCodeOFFSET dev_tbnc_n_char
	dw	rCodeOFFSET gen_nc_n_char
...
clipped_drawing_functions label word
	...
	dw	rCodeOFFSET  bm_trans_black_clip
	dw	rCodeOFFSET  bm_trans_black_clip
	dw	rCodeOFFSET  bm_trans_white_clip
	dw	rCodeOFFSET  bm_trans_white_clip
	dw	rCodeOFFSET  bm_opaque_black_on_black_clip
	dw	rCodeOFFSET  bm_opaque_black_on_white_clip
	dw	rCodeOFFSET  bm_opaque_white_on_black_clip
	dw	rCodeOFFSET  bm_opaque_white_on_white_clip
	dw	rCodeOFFSET dev_trans_black_clip
	dw	rCodeOFFSET dev_trans_black_clip
	dw	rCodeOFFSET dev_trans_white_clip
	dw	rCodeOFFSET dev_trans_white_clip
	dw	rCodeOFFSET dev_opaque_black_on_black_clip
	dw	rCodeOFFSET dev_opaque_black_on_white_clip
	dw	rCodeOFFSET dev_opaque_white_on_black_clip
	dw	rCodeOFFSET dev_opaque_white_on_white_clip
...
INDEX_DEV_TBNC	= offset $ - offset non_clipped_drawing_functions
	dw	rCodeOFFSET dev_trans_black
INDEX_DEV_TBNC_ALT = offset $ - offset non_clipped_drawing_functions
	dw	rCodeOFFSET dev_trans_black
	dw	rCodeOFFSET dev_trans_white
	dw	rCodeOFFSET dev_trans_white
	dw	rCodeOFFSET dev_opaque_black_on_black
INDEX_DEV_OBWNC = offset $ - offset non_clipped_drawing_functions
	dw	rCodeOFFSET dev_opaque_black_on_white
	dw	rCodeOFFSET dev_opaque_white_on_black
	dw	rCodeOFFSET dev_opaque_white_on_white
page
...
;	address also.
	...
	mov	clipped_table,rCodeOFFSET gen_cl
	mov	ax,next_scan
	mov	ss_next_scan,ax
...
if SPECIAL_CASE_DEV_OBWNC eq 1
	mov	ax,rCodeOFFSET dev_obwnc ;If this is the correct special case
...
if SPECIAL_CASE_DEV_TBNC eq 1
	mov	ax,rCodeOFFSET dev_tbnc  ;If this is the correct special case
	cmp	bl,INDEX_DEV_TBNC	;  then set dispatcher for it
	je	preset_pro_text_finish
	cmp	bl,INDEX_DEV_TBNC_ALT	;  then set dispatcher for it
	je	preset_pro_text_finish
endif
	mov	ax,rCodeOFFSET gen_nc	 ;Generic handler will be used
