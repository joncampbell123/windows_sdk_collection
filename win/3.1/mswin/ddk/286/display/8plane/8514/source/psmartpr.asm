...
name&_n_char_p proc near		;;    define actual procedure
...
name&_n_char_inner_loop:
	...
	shl	ax,cl
	sub	si,CHARENTRYSIZE	;;--> next char
	dec	ch
...
public	name&_four_char_p		;;make public
genflag=0				;;assume out_of_line, already generated
ifidn <setup>,<inline>			;;if in_line
name&_four_char_p proc near		;;  define procedure
  genflag = 01b 			;;  show code must be generated
else					;;else
...
name&_four_char_p proc near		;;    define actual procedure
...
public	name&_three_char_p		;;make public
genflag=0				;;assume out_of_line, already generated
ifidn <setup>,<inline>			;;if in_line
name&_three_char_p proc near		;;  define procedure
  genflag = 01b 			;;  show code must be generated
else					;;else
...
name&_three_char_p proc near		;;    define actual procedure
...
public	name&_two_char_p		;;make public
genflag=0				;;assume out_of_line, already generated
ifidn <setup>,<inline>			;;if in_line
name&_two_char_p proc near		;;  define procedure
  genflag = 01b 			;;  show code must be generated
else					;;else
...
name&_two_char_p proc near		;;    define actual procedure
...
public	name&_one_char_p		;;make public
genflag=0				;;assume out_of_line, already generated
ifidn <setup>,<inline>			;;if in_line
name&_one_char_p proc near		;;  define procedure
  genflag = 01b 			;;  show code must be generated
else					;;else
...
p_one_char_setup proc near		;;    define start of setup proc
	...
	mov	esi,[bp].cchar1 	 ;;  DS:ESI = char1
	mov	cl,[bp].pphase1 	;;
	xchg	dx,bp			;;  BP --> frame
...
name&_one_char_p proc near		;;    define actual procedure
...
gen_nc	label	word
	dw	pCodeOFFSET gen_nc_one_char_p
	dw	pCodeOFFSET gen_nc_two_char_p
	dw	pCodeOFFSET gen_nc_three_char_p
	dw	pCodeOFFSET gen_nc_four_char_p
	dw	pCodeOFFSET gen_nc_n_char_p
	dw	pCodeOFFSET gen_nc_n_char_p
	dw	pCodeOFFSET gen_nc_n_char_p
	dw	pCodeOFFSET gen_nc_n_char_p

gen_cl	label	word
	dw	pCodeOFFSET gen_cl_one_char_p
	dw	pCodeOFFSET gen_cl_two_char_p
	dw	pCodeOFFSET gen_cl_three_char_p
	dw	pCodeOFFSET gen_cl_four_char_p
	dw	pCodeOFFSET gen_cl_n_char_p
	dw	pCodeOFFSET gen_cl_n_char_p
	dw	pCodeOFFSET gen_cl_n_char_p
	dw	pCodeOFFSET gen_cl_n_char_p
...
dev_obwnc label word
	dw	pCodeOFFSET dev_obwnc_one_char_p
	dw	pCodeOFFSET dev_obwnc_two_char_p
	dw	pCodeOFFSET dev_obwnc_three_char_p
	dw	pCodeOFFSET dev_obwnc_four_char_p
;	dw	pCodeOFFSET dev_obwnc_n_char_p
;	dw	pCodeOFFSET dev_obwnc_n_char_p
;	dw	pCodeOFFSET dev_obwnc_n_char_p
;	dw	pCodeOFFSET dev_obwnc_n_char_p
	dw	pCodeOFFSET gen_nc_n_char_p
...
dev_tbnc label	word
	dw	pCodeOFFSET dev_tbnc_one_char_p
	dw	pCodeOFFSET dev_tbnc_two_char_p
	dw	pCodeOFFSET dev_tbnc_three_char_p
	dw	pCodeOFFSET dev_tbnc_four_char_p
;	dw	pCodeOFFSET dev_tbnc_n_char_p
;	dw	pCodeOFFSET dev_tbnc_n_char_p
;	dw	pCodeOFFSET dev_tbnc_n_char_p
;	dw	pCodeOFFSET dev_tbnc_n_char_p
	dw	pCodeOFFSET gen_nc_n_char_p
...
clipped_drawing_functions label word
	...
	dw	pCodeOFFSET  bm_trans_black_clip
	dw	pCodeOFFSET  bm_trans_black_clip
	dw	pCodeOFFSET  bm_trans_white_clip
	dw	pCodeOFFSET  bm_trans_white_clip
	dw	pCodeOFFSET  bm_opaque_black_on_black_clip
	dw	pCodeOFFSET  bm_opaque_black_on_white_clip
	dw	pCodeOFFSET  bm_opaque_white_on_black_clip
	dw	pCodeOFFSET  bm_opaque_white_on_white_clip
	dw	pCodeOFFSET dev_trans_black_clip
	dw	pCodeOFFSET dev_trans_black_clip
	dw	pCodeOFFSET dev_trans_white_clip
	dw	pCodeOFFSET dev_trans_white_clip
	dw	pCodeOFFSET dev_opaque_black_on_black_clip
	dw	pCodeOFFSET dev_opaque_black_on_white_clip
	dw	pCodeOFFSET dev_opaque_white_on_black_clip
	dw	pCodeOFFSET dev_opaque_white_on_white_clip


non_clipped_drawing_functions label word

	dw	pCodeOFFSET  bm_trans_black
	dw	pCodeOFFSET  bm_trans_black
	dw	pCodeOFFSET  bm_trans_white
	dw	pCodeOFFSET  bm_trans_white
	dw	pCodeOFFSET  bm_opaque_black_on_black
	dw	pCodeOFFSET  bm_opaque_black_on_white
	dw	pCodeOFFSET  bm_opaque_white_on_black
	dw	pCodeOFFSET  bm_opaque_white_on_white
INDEX_DEV_TBNC	= offset $ - offset non_clipped_drawing_functions
	dw	pCodeOFFSET dev_trans_black
INDEX_DEV_TBNC_ALT = offset $ - offset non_clipped_drawing_functions
	dw	pCodeOFFSET dev_trans_black
	dw	pCodeOFFSET dev_trans_white
	dw	pCodeOFFSET dev_trans_white
	dw	pCodeOFFSET dev_opaque_black_on_black
INDEX_DEV_OBWNC = offset $ - offset non_clipped_drawing_functions
	dw	pCodeOFFSET dev_opaque_black_on_white
	dw	pCodeOFFSET dev_opaque_white_on_black
	dw	pCodeOFFSET dev_opaque_white_on_white
page
...
;	address also.
	...
	mov	clipped_table,pCodeOFFSET gen_cl
	mov	ax,next_scan
	mov	ss_next_scan,ax
...
if SPECIAL_CASE_DEV_OBWNC eq 1
	mov	ax,pCodeOFFSET dev_obwnc ;If this is the correct special case
...
if SPECIAL_CASE_DEV_TBNC eq 1
	mov	ax,pCodeOFFSET dev_tbnc  ;If this is the correct special case
	cmp	bl,INDEX_DEV_TBNC	;  then set dispatcher for it
	je	preset_pro_text_finish
	cmp	bl,INDEX_DEV_TBNC_ALT	;  then set dispatcher for it
	je	preset_pro_text_finish
endif
	mov	ax,pCodeOFFSET gen_nc	 ;Generic handler will be used
