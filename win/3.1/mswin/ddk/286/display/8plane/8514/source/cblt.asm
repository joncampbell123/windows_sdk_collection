...
cblt_3020:
	...
	test	gl_the_flags,F0_SRC_PRESENT ;Is there a source?
        jnz     cblt_3180               ;  Yes, generate fetch code
        jmp     short cblt_4000         ;  No, don't generate fetch code
