...
phase_0_do_first:
	...
	mov	ret_addr,rCodeOFFSET phase_0_do_inner
	char_check
...
phase_0_do_inner:
	...
	mov	ret_addr,rCodeOFFSET phase_0_do_last
...
phase_0_do_last:
	...
	mov	ss_clip_mask,al
	mov	ret_addr,rCodeOFFSET fixed_text_clean_up
	char_check
...
phase_non_0:
	...
	mov	ss_clip_mask,al 	;Generic handlers require this
	mov	ret_addr,rCodeOFFSET phase_non_0_do_inner
	or	excel,RES_EGA_INNER
...
phase_non_0_do_inner:
	...
	mov	ret_addr,rCodeOFFSET phase_non_0_do_last
	mov	ss_clip_mask,0FFh
...
ega_oc_outer_loop_fix:
	...
	mov	ret_addr,rCodeOFFSET ega_oc_outer_loop_ret_1

	cbw
	xchg	bx,ax
	mov	ss_draw_clipped,rCodeOFFSET ega_opaque_clip_1_fix
...
ega_oc_outer_loop_do_1:
	add	bx,rCodeOFFSET ega_oc_dispatch_table
...
;	color.  If there aren't any, then skip the second pass.
	...
	mov	ret_addr,rCodeOFFSET ega_oc_outer_loop_ret_2
	sub	ss_draw_clipped,2
	errnz	<rCodeOFFSET ega_opaque_clip_1_fix - rCodeOFFSET ega_opaque_clip_2_fix - 2>
	test	bl,OC_MASK_TWO_CHAR
	errnz	<OC_MASK_TWO_CHAR and 0FF00h>
...
clipped_drawing_functions label word
	...
	dw	rCodeOFFSET  bm_trans_color_fix
	dw	rCodeOFFSET  bm_trans_color_fix
	dw	rCodeOFFSET  bm_trans_color_fix
	dw	rCodeOFFSET  bm_trans_color_fix
	dw	rCodeOFFSET  bm_opaque_color_fix
	dw	rCodeOFFSET  bm_opaque_color_fix
	dw	rCodeOFFSET  bm_opaque_color_fix
	dw	rCodeOFFSET  bm_opaque_color_fix
	dw	rCodeOFFSET ega_trans_clip_fix
	dw	rCodeOFFSET ega_trans_clip_fix
	dw	rCodeOFFSET ega_trans_clip_fix
	dw	rCodeOFFSET ega_trans_clip_fix
...
non_clipped_drawing_functions label word
	...
	dw	rCodeOFFSET  bm_opaque_color_fix
	dw	rCodeOFFSET  bm_opaque_color_fix
	dw	rCodeOFFSET ega_trans_non_clip_fix
	dw	rCodeOFFSET ega_trans_non_clip_fix
	dw	rCodeOFFSET ega_trans_non_clip_fix
	dw	rCodeOFFSET ega_trans_non_clip_fix
	dw	rCodeOFFSET ega_opaque_non_clip_fix
	dw	rCodeOFFSET ega_opaque_non_clip_fix
	dw	rCodeOFFSET ega_opaque_non_clip_fix
	dw	rCodeOFFSET ega_opaque_non_clip_fix
...
mono_non_clipped_drawing_functions label word
	...
	dw	rCodeOFFSET  trans_black
	dw	rCodeOFFSET  trans_black
	dw	rCodeOFFSET  trans_white
	dw	rCodeOFFSET  trans_white
	dw	rCodeOFFSET  opaque_black_on_black
	dw	rCodeOFFSET  opaque_black_on_white
	dw	rCodeOFFSET  opaque_white_on_black
	dw	rCodeOFFSET  opaque_white_on_white
page
...
ega_oc_dispatch_table	label	word
	dw	rCodeOFFSET gen_one_in_first
	dw	rCodeOFFSET gen_two_in_first
	dw	rCodeOFFSET gen_one_in_last
	dw	rCodeOFFSET gen_two_in_last
...
;	passes at drawing may be required.
	...
	mov	ax,rCodeOFFSET ega_oc_outer_loop_fix ;special case
	mov	cx,rCodeOFFSET ega_oc_outer_loop_fix_two
...
preset_fix_text_def_clip_fun:
	mov	vect_one_in_first,rCodeOFFSET gen_one_in_first
	mov	vect_two_in_first,rCodeOFFSET gen_two_in_first
	mov	vect_one_in_last,rCodeOFFSET  gen_one_in_last
	mov	vect_two_in_last,rCodeOFFSET  gen_two_in_last
...
if SPECIAL_CASE_DEV_ONC eq 1
	...
	mov	ax,rCodeOFFSET dev_onc_one_in_cell
	mov	cx,rCodeOFFSET dev_onc_two_in_cell
...
if SPECIAL_CASE_DEV_TNC eq 1
	...
	mov	ax,rCodeOFFSET dev_tnc_one_in_cell
	mov	cx,rCodeOFFSET dev_tnc_two_in_cell
	jmp	preset_fix_text_finish
...
if SPECIAL_CASE_BM_OBWNC eq 1
	mov	ax,rCodeOFFSET bm_obwnc_one_in_cell
	mov	cx,rCodeOFFSET bm_obwnc_two_in_cell
	cmp	bl,INDEX_OBW
...
if SPECIAL_CASE_BM_TBNC eq 1
	mov	ax,rCodeOFFSET bm_tbnc_one_in_cell
	mov	cx,rCodeOFFSET bm_tbnc_two_in_cell
	cmp	bl,INDEX_TB
	je	preset_fix_text_finish
	cmp	bl,INDEX_TB_ALT
	je	preset_fix_text_finish
...
preset_fix_text_set_nc_draw_fun:
	mov	ss_draw,ax
	mov	ax,rCodeOFFSET gen_one_in_cell
	mov	cx,rCodeOFFSET gen_two_in_cell
