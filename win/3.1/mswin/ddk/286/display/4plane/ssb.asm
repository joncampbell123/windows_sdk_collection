...
;
; 09-Jan-1991 -by-  Ray Patrick [raypat]
;   Rewrote to avoid call to BitBlt.  Removed file vgassb.asm.
;   This file (SSB.ASM) is used for both the VGA and EGA drivers.
;
; 07-Apr-1991 -by-  Ray Patrick [raypat]
;   Rewrote to fix incompatability with AFX user.exe
;
