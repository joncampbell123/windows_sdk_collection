...
; flag that will force it and arm transmit interrupts.
	...
	jz	@F			;  No
	test	HSFlag[si],EnqReceived+HHSDropped ;Enq recvd or lines dropped?
	jz	RecStr80		;  No Enq recvd & no lines dropped
	jmp	short RecStr60
...
Flush10:
   ...
   assumes es,nothing
        ...
        xor     al,al
        cli                             ;Time to worry about critical sections
        rep     stosb
        sti
...
ExtCom20:
        ...
        cli                             ;Consider as critical sections
...
ExtCom_FN7   proc   near
        ...
        sti                             ;Not called at interrupt time
