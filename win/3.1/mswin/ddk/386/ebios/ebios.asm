...
BeginProc EBIOS_Get_Unused_Mem, SERVICE
...
no_StdEbios_fnd:
	...
	cmp	ax,9FFFh	    ; Is it exactly one paragraph?
	jne	short DOEbios	    ; No, assume EBIOS
    ;
    ; The end of DOS land is one paragraph short of A000h. This might be
    ;	due to a guy like DOS 5 who has a wraith arena here for linking
    ;	in the high memory UMBs. Check if the paragraph contains an arena
    ;	signature and an owner of 8 (magic "system owner").
    ;
	push	es
	mov	es,ax
