...
; Because we cannot do "IFDEF TLVGA OR V7VGA OR PVGA
IFDEF	TLVGA
ASM_VM_Crit_Init=-1
ENDIF
...
VSF_00:
	...
	test	[edi.VDD_Flags],fVDD_256	;Q: new focus a 256K VM?
	jnz	SHORT VSF_01			;   Y:
	mov	eax,[VDD_CB_Off]
	test	[eax+esi.VDD_Flags],fVDD_256	;Q: old focus a 256K VM?
	jz	SHORT VSF_01			;   N:
...
; Special code to detect display adapters and set appropriate flags
	...
	jnz	SHORT Not_SYS_VMInit		;   during SYS VM init.
        ...
        or      [Vid_Flags],fVid_PageSwapInst   ; PageSwap device installed
VSIV_NoPageSwap:
...
ENDIF
	...
	or	[Vid_Flags], fVid_SysVMI	; flag successful initialization
...
VRB_next_VM:
	...
	test	[eax+ebx.VDD_Flags],fVDD_WaitAtt;Q: VM suspended by VDD?
	jz	VRB_next_VM			;   N: skip it
...
ENDIF
	...
	and	[eax+ebx.VDD_Flags],NOT fVDD_WaitAtt
	jmp	VRB_next_VM
