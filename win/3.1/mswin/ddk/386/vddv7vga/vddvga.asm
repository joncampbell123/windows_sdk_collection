...
ENDIF
	...
	test	[Vid_Flags], fVid_DOff		;Q: display off?
...
BeginProc VDD_VGA_SaveAttr
	...
	test	[edi.VDD_Flags],fVDD_AxRd	; Q: Index saved and mod'd?
...
VSV_A_Loop:
	...
	test	[Vid_Flags],fVid_DOff		; Q: Is video off?
...
Assert_VDD_ptrs ebx,edi, Pseudo_OK
	...
	test	[Vid_Flags],fVid_V7VGA + fVid_CLVGA
	jz	V7RCRTC_Exit
