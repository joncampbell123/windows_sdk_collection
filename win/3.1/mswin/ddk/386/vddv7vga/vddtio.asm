...
Assert_VDD_ptrs ebx,edi
	mov	edx,3C0h
	test	[edi.VDD_Flags],fVDD_NoTrap	; Q: Special VM type?
...
mVidNoTrapPIF EQU fVidNoTrpTxt+fVidNoTrpLRGrfx+fVidNoTrpHRGrfx
	test	[edi.VDD_PIF],mVidNoTrapPIF	; Q: No trapping enabled?
...
VIOST_01:
	...
	test	[edi.VDD_PIF],fVidNoTrpLRGrfx	; Q: No trapping enabled?
	jnz	SHORT VIOST_Disable_Local	;   Y: No trapping
	jmp	SHORT VIOST_Enable_Local	;   N: Do trapping
VIOST_02:
	test	[edi.VDD_PIF],fVidNoTrpHRGrfx	; Q: No trapping enabled?
	jnz	SHORT VIOST_Disable_Local	;   Y: No trapping
...
;
BeginProc VIOT_1CE
	test	[Vid_Flags],fVid_ATiVGA 	    ; Q: ATI EGA 800?
	jnz	VIOT_ATI_1CE_OUT
;
;	and	[edi.VDD_Flags],not fVDD_ATIEna
	out	dx,al
	ret
;
VIOT_ATI_1CE_OUT:
...
;
BeginProc VIOT_1CF
	test	[Vid_Flags],fVid_ATiVGA 	    ; Q: ATI EGA?
...
; Physical output
	test	[edi.VDD_Flags],fVDD_ATIEna
...
VIOT_ASv0:
	test	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PALokd ; Q: Attribute ctlr locked?
...
;;;Debug_Out "PEGA Misc OUT #DX,#AL"
	...
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PMisc ; indicate PMisc active
...
VIOT_Entry	3C5,Seq,FAR,Seq,FAR
	...
	je	VIOT_OSeq_EnableExt		    ;  Y: save state of reg
...
VIOT_Out_V7ExtReg:
	test	[Vid_Flags],fVid_V7VGA+fVid_CLVGA   ; Q: Video 7 or Cirrus Logic?
...
IFDEF	DEBUG
	jne	VIOT_Out_SeqNoOutDBG		    ;  N: ignore the value
ELSE
...
IFDEF DEBUG
VIOT_Out_SeqNoOutDBG:
Debug_Out " EXTENDED DISABLED!!"
	jmp	VIOT_Out_SeqNoOut
ENDIF
...
;
BeginProc VIOT_3CB
	test	[Vid_Flags],fVid_ATI800 	    ; Q: ATI EGA 800?
...
;
BeginProc VIOT_3CD
	test	[Vid_Flags],fVid_ATI800 	    ; Q: ATI EGA?
...
IFDEF	PVGA
	...
	or	[edi.VDD_Flags],fVDD_PVGA_Ena
	jmp	SHORT V3CF_O3
V3CF_O1:
	and	[edi.VDD_Flags],NOT fVDD_PVGA_Ena
V3CF_O3:
	pop	eax
ELSE
IFDEF DEBUG
...
VIOT_CSv0:
IFDEF	PEGA
	test	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCScrmd+fVPa_PCLokd
						    ; Q: Lokd,Scrmd?
...
VIOT_CSv_Par1:
	...
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PNew ;	indicate value output
VIOT_CSv1P:
	call	VDD_CRTC_PChg
	jmp	VIOT_CSvEx
VIOT_CSv_Par1H:
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCLok ; Indicate HTLF output to
	push	eax
	and	al,mPEna
	cmp	al,vPDis			    ; Q: HTLF active?
	pop	eax
	jnz	SHORT VIOT_CSv_HTLFDis		    ;	N: just return
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCLokd ;   Y: indicate HTLF active
	or	[Vid_Flags],fVid_PCLokd
	jmp	VIOT_CSv1P
VIOT_CSv_HTLFDis:
	and	[edi.VDD_Stt.V_Flag_PEGA],NOT fVPa_PCLokd ; HTLF not active
	and	[Vid_Flags],NOT fVid_PCLokd
	jmp	VIOT_CSv1P
VIOT_CSv_Scrm:
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PScrm ; indicate PScrm active
	push	eax
	and	al,mPEna
	cmp	al,vPDis			    ; Q: Scrambler enabled?
	pop	eax
	jz	SHORT VIOT_CSv_ScrmDis		    ;	N: Disable scrambler
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCScrmd ; Scrambler enabled
	or	[Vid_Flags],fVid_PScrmd
	jmp	VIOT_CSv1P
VIOT_CSv_ScrmDis:
	and	[edi.VDD_Stt.V_Flag_PEGA],NOT fVPa_PCScrmd ; Scrmb not enabled
	and	[Vid_Flags],not fVid_PScrmd
	jmp	VIOT_CSv1P
...
VIOT_CSv_PExt:
	...
	test	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCScrmd ; Q: Scrambled?
...
;;;Debug_Out "Changing CRTC to UnL"
	...
	jmp	VIOT_CSvSaved
VIOT_CSv_PScrmd:
	test	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCLokd ; Q: Locked?
...
;	test	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCLokd
;	jz	SHORT VDD_SvPC0
;	or	cl,cl
;	jz	SHORT VDD_SvPCEx
;VDD_SvPC0:
...
VDD_SvOvflw:
	test	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PCLokd ; Q: Overflow locked?
	jz	SHORT VDD_SvOv2 		    ;	N: just save value
	test	DWORD PTR [edi.VDD_Stt.VC_PNew],2   ; Q: Overflow locked?
...
VIOT_VI_PStt:
	inc	[edi.VDD_Stt.V_PSttCnt]
	test	DWORD PTR [edi.VDD_Stt.VC_PShdw], fShdwEna
	mov	al,vPSNorm
...
;;;Debug_Out "PEGA OUT #DX,#AL"
	...
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PReg
	VIOT_Out_Exit	PReg
VIOT_End 3DB
...
VIOT_PO_PShMapIt:
	...
	or	[edi.VDD_Stt.V_Flag_PEGA],fVPa_PShdw
