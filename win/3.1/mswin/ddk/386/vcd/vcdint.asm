...
;   ----------- --- -----------------------------------------------------------
;   20-Oct-1989 RAP
;   16-Nov-1990 RAP Remove RING0 copy of COMM.DRV int handler.	COMM.DRV now
;		    uses services in VPICD to get its int handler called in
;		    RING0.
;   14-Jan-1991 RAP Keep copy of RING0 int handler in ICODE and relocate it
;		    into allocated heap memory, if Windows is working with
;		    a 3.0 com driver, as specified by an INI switch.
;		    The symbol Debugable30COMINT can be defined to build
;		    VCD with the int handler in CODE, so that relocation is
;		    not required and thus symbols will be available for
;		    debugging.
;
;==============================================================================
.386
