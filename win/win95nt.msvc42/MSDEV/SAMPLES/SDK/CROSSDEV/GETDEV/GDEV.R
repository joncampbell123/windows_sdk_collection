...
resource 'GDEV' (0)
{
	"GetDev Sample Application. Copyright Microsoft Corp. 1994-1995"
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft GetDev "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft GetDev "
                "Sample Application."
            },
            ...
            {
                "This is not parth of the Microsoft GetDev"
...
resource 'STR ' (500)
{
	"This is the Windows32 GetDev sample application "
