...
resource 'CRSR' (0)
{
	"CRSREMO Sample Application. Copyright Microsoft Corp. 1994-1995"
};

resource 'FREF' (IDR_MAIN)
{
	'APPL', 0, "";
};

resource 'FREF' (IDR_CHILD)
{
	'CRS ', 1, "";
};
...
resource 'STR ' (500)
{
	"This is the Win32 ODBC CRSREMO sample application "
