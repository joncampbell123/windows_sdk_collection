...
resource 'GSYS' (0)
{
	"GetSys Sample Application. Copyright Microsoft Corp. 1994-1995"
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft GetSys "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft GetSys "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft GetSys"
...
resource 'STR ' (500)
{
	"This is the Windows32 GetSys sample application "
