...
#else
#define USERDATA	DWL_USER
#endif


// Types -------------------------------------------------------------------
typedef struct tagMTBL {                  // Make table structure
	HSTMT	hstmt;                         //   HSTMT in use
...
#else
#define DlgProcFilter(hDlg, msg, wParam, lParam) FALSE
#endif
...
--------------------------------------------------------------------------*/
BOOL CALLBACK AbsDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	LPCHILD	lpChild;
	char	sz[11];
	char	*EndPtr;
...
--------------------------------------------------------------------------*/
BOOL CALLBACK DataDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg) {
		case WM_INITDIALOG: {
			LPBIGCOL	lpbc;
...
--------------------------------------------------------------------------*/
BOOL CALLBACK RelDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	LPCHILD	lpChild;
	char	sz[7];
...
--------------------------------------------------------------------------*/
BOOL CALLBACK StmtDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	LPCHILD	lpChild;
...
--------------------------------------------------------------------------*/
BOOL CALLBACK UpdateDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	LPCHILD	lpChild;
...
----------------------------------------------------------------------------*/
BOOL CALLBACK SQLTablesDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	LPCHILD	lpChild;
