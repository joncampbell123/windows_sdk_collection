...
resource 'OWNC' (0)
{
	"OwnCombo Sample Application. Copyright Microsoft Corp. 1994-1995"
};

resource 'FREF' (IDR_OWNCOMBO)
{
	'APPL', 0, "";
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft OwnCombo "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft OwnCombo "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft OwnCombo"
...
resource 'STR ' (500)
{
	"This is the Windows32 OwnCombo sample application "
