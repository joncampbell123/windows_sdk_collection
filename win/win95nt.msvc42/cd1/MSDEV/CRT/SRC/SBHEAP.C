        ...
        )
{
        ...
        if ( (old_para_sz = *pmap) > new_para_sz ) {
            ...
            *pmap = new_para_sz;
            ...
            preg->region_map[ppage - preg->p_pages] += (old_para_sz - new_para_sz);
